...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/マシンパーツ/MachineParts_Emblem_Emission_Matcap" {
Properties {
...
void main()
{
    ...
    u_xlat4.x = dot(vs_TEXCOORD3.xyz, u_xlat16_2.xyz);
    u_xlat4.y = dot(vs_TEXCOORD4.xyz, u_xlat16_2.xyz);
    u_xlat4.z = dot(vs_TEXCOORD5.xyz, u_xlat16_2.xyz);
    ...
    u_xlat16_2.xyz = max(u_xlat10_3.xyz, _MinMSA.xyz);
    ...
    u_xlat16_2.xyw = u_xlat10_0.xyz * u_xlat16_2.xxx;
    ...
    SV_Target0.xyz = u_xlat16_1.xyz * u_xlat10_4.xyz + u_xlat3.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat4.x = min(u_xlat4.x, 100.0);
    u_xlat4.xyw = u_xlat4.xxx * u_xlat16_1.xyz + u_xlat16_5.xyz;
    u_xlat10_5 = texture2D(unity_ShadowMask, vs_TEXCOORD8.xy);
    u_xlat16_2.x = dot(u_xlat10_5, unity_OcclusionMaskSelector);
...
void main()
{
    ...
    u_xlat10_0 = textureCube(unity_SpecCube0, u_xlat3.xyz, u_xlat16_1.x);
...
void main()
{
    ...
    u_xlat10_5 = texture2D(_Decal, vs_TEXCOORD1.zw);
    u_xlat16_5 = u_xlat10_5 * _Color + _AddColor;
...
void main()
{
    ...
    u_xlat5.x = dot(vs_TEXCOORD3.xyz, u_xlat16_3.xyz);
    u_xlat5.y = dot(vs_TEXCOORD4.xyz, u_xlat16_3.xyz);
    u_xlat5.z = dot(vs_TEXCOORD5.xyz, u_xlat16_3.xyz);
...
void main()
{
    ...
    u_xlat6.xyw = u_xlat6.xxx * u_xlat16_4.xyz + u_xlat16_7.xyz;
    u_xlat10_5 = texture2D(unity_ShadowMask, vs_TEXCOORD8.xy);
    u_xlat16_3.x = dot(u_xlat10_5, unity_OcclusionMaskSelector);
    u_xlat16_3.x = clamp(u_xlat16_3.x, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_8.xyz = (-u_xlat16_7.xyz) + u_xlat16_3.xyz;
    u_xlat16_7.xyz = u_xlat16_3.www * u_xlat16_8.xyz + u_xlat16_7.xyz;
    u_xlat16_7.xyz = u_xlat10_1.xyz * _SphereMapScale.xyz + u_xlat16_7.xyz;
    u_xlat16_8.xyz = u_xlat16_7.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_8.xyz = u_xlat16_2.xxx * u_xlat16_8.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_2.x = (-u_xlat16_2.x) * 0.779083729 + 0.779083729;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat4.zxy * u_xlat5.yzx + (-u_xlat16_2.xyz);
    u_xlat4.xyz = u_xlat16_2.xzy * vs_TEXCOORD4.yyy;
    u_xlat5.y = u_xlat4.x;
    ...
    u_xlat5.x = dot(u_xlat5.xyz, u_xlat16_2.xyz);
    u_xlat6.y = u_xlat4.z;
    u_xlat6.xz = vs_TEXCOORD4.xz;
    u_xlat5.y = dot(u_xlat6.xyz, u_xlat16_2.xyz);
    u_xlat4.xz = vs_TEXCOORD5.xz;
    u_xlat5.z = dot(u_xlat4.xyz, u_xlat16_2.xyz);
    u_xlat16_2.x = dot(u_xlat3.xyz, u_xlat5.xyz);
    u_xlat3.x = hlslcc_mtx4x4unity_MatrixV[0].y;
    u_xlat3.y = hlslcc_mtx4x4unity_MatrixV[1].y;
    u_xlat3.z = hlslcc_mtx4x4unity_MatrixV[2].y;
    u_xlat16_2.y = dot(u_xlat3.xyz, u_xlat5.xyz);
    u_xlat16_2.xy = u_xlat16_2.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
    u_xlat10_3.xyz = texture2D(_SphereMap, u_xlat16_2.xy).xyz;
    u_xlat16_1.xyz = u_xlat10_3.xyz * _SphereMapScale.xyz + u_xlat16_1.xyz;
    u_xlat10_3.xyz = texture2D(_MSA, vs_TEXCOORD1.xy).xyz;
    u_xlat16_2.xyz = max(u_xlat10_3.xyz, _MinMSA.xyz);
    u_xlat16_31 = (-u_xlat16_2.x) * 0.779083729 + 0.779083729;
    u_xlat16_7.xyz = vec3(u_xlat16_31) * u_xlat16_1.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_1.xyz = u_xlat16_2.xxx * u_xlat16_1.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_31 = (-u_xlat16_31) + u_xlat16_2.y;
    u_xlat16_31 = u_xlat16_31 + 1.0;
    ...
    u_xlat3.x = inversesqrt(u_xlat3.x);
    u_xlat0.xyz = u_xlat3.xxx * u_xlat5.xyz;
    u_xlat0.w = 1.0;
    ...
    u_xlat16_3.xyz = u_xlat16_3.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
    u_xlat16_3.xyz = max(u_xlat16_3.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_9.xyz = u_xlat16_2.zzz * u_xlat16_3.xyz;
    ...
    u_xlat13.x = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat13.x = inversesqrt(u_xlat13.x);
    u_xlat5.xyz = u_xlat4.xyz * u_xlat13.xxx + _WorldSpaceLightPos0.xyz;
    u_xlat13.xyz = u_xlat13.xxx * u_xlat4.xyz;
    u_xlat4.x = dot(u_xlat5.xyz, u_xlat5.xyz);
    u_xlat4.x = max(u_xlat4.x, 0.00100000005);
    u_xlat4.x = inversesqrt(u_xlat4.x);
    ...
    u_xlat24 = (-u_xlat16_2.y) + 1.0;
    u_xlat34 = u_xlat24 * u_xlat24;
    u_xlat5.x = u_xlat34 * u_xlat34 + -1.0;
    u_xlat14 = u_xlat14 * u_xlat5.x + 1.00001001;
    ...
    u_xlat4.x = max(u_xlat4.x, 0.0);
    u_xlat4.x = min(u_xlat4.x, 100.0);
    u_xlat4.xyw = u_xlat4.xxx * u_xlat16_1.xyz + u_xlat16_7.xyz;
    u_xlat4.xyw = u_xlat4.xyw * _LightColor0.xyz;
    u_xlat5.x = dot(u_xlat0.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat5.x = clamp(u_xlat5.x, 0.0, 1.0);
    u_xlat4.xyw = u_xlat4.xyw * u_xlat5.xxx + u_xlat16_9.xyz;
    u_xlat16_2.x = dot((-u_xlat13.xyz), u_xlat0.xyz);
    u_xlat16_2.x = u_xlat16_2.x + u_xlat16_2.x;
    u_xlat16_2.xyw = u_xlat0.xyz * (-u_xlat16_2.xxx) + (-u_xlat13.xyz);
    u_xlat13.x = dot(u_xlat0.xyz, u_xlat13.xyz);
    ...
    u_xlat16_7.x = u_xlat16_7.x * u_xlat16_7.x;
    u_xlat16_1.xyz = u_xlat16_7.xxx * u_xlat16_8.xyz + u_xlat16_1.xyz;
    u_xlat13.x = dot(u_xlat16_2.wxy, (-u_xlat16_2.xyw));
    u_xlatb13 = u_xlat13.x<9.99999975e-06;
    u_xlat13.x = (u_xlatb13) ? u_xlat16_2.w : (-u_xlat16_2.w);
    u_xlat5.z = u_xlat16_2.x * u_xlat13.x;
    u_xlat6.x = u_xlat16_2.w * u_xlat13.x;
    u_xlat5.xy = (-u_xlat16_2.xy) * u_xlat16_2.yw;
    ...
    u_xlat16_1.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat10_4.xyz = texture2D(_EmissionMap, vs_TEXCOORD2.xy).xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat10_4.xyz + u_xlat3.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_1.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat10_3.xyz = texture2D(_MSA, vs_TEXCOORD1.xy).xyz;
    u_xlat16_7.xyz = max(u_xlat10_3.xyz, _MinMSA.xyz);
    u_xlat16_2.xyz = u_xlat16_7.xxx * u_xlat16_2.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat4.xyw = u_xlat4.xyw * _LightColor0.xyz;
    u_xlat16_6.xyz = texture2D(unity_Lightmap, vs_TEXCOORD6.xy).xyz;
    u_xlat16_7.xyw = u_xlat16_6.xyz * unity_Lightmap_HDR.xxx;
    u_xlat16_7.xyw = u_xlat16_7.zzz * u_xlat16_7.xyw;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_7.xyw;
    u_xlat32 = dot(u_xlat3.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat32 = clamp(u_xlat32, 0.0, 1.0);
    u_xlat4.xyw = u_xlat4.xyw * vec3(u_xlat32) + u_xlat16_1.xyz;
    u_xlat16_1.x = dot((-u_xlat5.xyz), u_xlat3.xyz);
    u_xlat16_1.x = u_xlat16_1.x + u_xlat16_1.x;
    u_xlat16_1.xyz = u_xlat3.xyz * (-u_xlat16_1.xxx) + (-u_xlat5.xyz);
    ...
    u_xlatb3 = u_xlat3.x<9.99999975e-06;
    u_xlat3.x = (u_xlatb3) ? u_xlat16_1.z : (-u_xlat16_1.z);
    u_xlat5.z = u_xlat16_1.x * u_xlat3.x;
    u_xlat3.x = u_xlat16_1.z * u_xlat3.x;
...
void main()
{
    ...
    u_xlat6.y = vs_TEXCOORD5.x;
    u_xlat6.z = vs_TEXCOORD3.x;
    u_xlat6.x = vs_TEXCOORD4.x;
    u_xlat16_3.xyz = u_xlat5.xyz * u_xlat6.xyz;
    u_xlat16_3.xyz = u_xlat5.zxy * u_xlat6.yzx + (-u_xlat16_3.xyz);
    u_xlat5.xyz = u_xlat16_3.xzy * vs_TEXCOORD4.yyy;
    u_xlat6.y = u_xlat5.x;
    ...
    u_xlat6.x = dot(u_xlat6.xyz, u_xlat16_3.xyz);
    u_xlat7.y = u_xlat5.z;
    u_xlat7.xz = vs_TEXCOORD4.xz;
    u_xlat6.y = dot(u_xlat7.xyz, u_xlat16_3.xyz);
    u_xlat5.xz = vs_TEXCOORD5.xz;
    u_xlat6.z = dot(u_xlat5.xyz, u_xlat16_3.xyz);
    ...
    u_xlat16_3.xyz = u_xlat16_2.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat10_4.xyz = texture2D(_MSA, vs_TEXCOORD1.xy).xyz;
    u_xlat16_8.xyz = max(u_xlat10_4.xyz, _MinMSA.xyz);
    u_xlat16_3.xyz = u_xlat16_8.xxx * u_xlat16_3.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_31 = (-u_xlat16_8.x) * 0.779083729 + 0.779083729;
    u_xlat16_2.xyz = vec3(u_xlat16_31) * u_xlat16_2.xyz;
    ...
    u_xlat5.x = inversesqrt(u_xlat5.x);
    u_xlat15.xyz = u_xlat6.xyz * u_xlat5.xxx + _WorldSpaceLightPos0.xyz;
    ...
    u_xlat15.x = u_xlat15.x * u_xlat36 + 1.00001001;
    u_xlat36 = u_xlat25 * u_xlat25 + 1.5;
    ...
    u_xlat5.xyw = u_xlat5.xyw * vec3(u_xlat36) + u_xlat16_1.xyz;
    u_xlat16_1.x = dot((-u_xlat6.xyz), u_xlat4.xyz);
    u_xlat16_1.x = u_xlat16_1.x + u_xlat16_1.x;
    u_xlat16_1.xyz = u_xlat4.xyz * (-u_xlat16_1.xxx) + (-u_xlat6.xyz);
    ...
    u_xlatb4 = u_xlat4.x<9.99999975e-06;
    u_xlat4.x = (u_xlatb4) ? u_xlat16_1.z : (-u_xlat16_1.z);
    u_xlat6.z = u_xlat16_1.x * u_xlat4.x;
    u_xlat4.x = u_xlat16_1.z * u_xlat4.x;
    ...
    u_xlat16_1.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat10_5.xyz = texture2D(_EmissionMap, vs_TEXCOORD2.xy).xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat10_5.xyz + u_xlat4.xyz;
    u_xlat16_4.xyz = u_xlat16_1.xyz + (-unity_FogColor.xyz);
    u_xlat34 = vs_TEXCOORD5.y;
    u_xlat34 = clamp(u_xlat34, 0.0, 1.0);
    u_xlat4.xyz = vec3(u_xlat34) * u_xlat16_4.xyz + unity_FogColor.xyz;
