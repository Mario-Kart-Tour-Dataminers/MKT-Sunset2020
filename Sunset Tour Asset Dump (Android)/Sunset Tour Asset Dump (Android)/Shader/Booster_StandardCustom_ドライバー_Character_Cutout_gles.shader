...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/ドライバー/Character_Cutout" {
Properties {
...
void main()
{
    ...
    u_xlat3.x = dot(vs_TEXCOORD2.xyz, u_xlat16_1.xyz);
    u_xlat3.y = dot(vs_TEXCOORD3.xyz, u_xlat16_1.xyz);
    u_xlat3.z = dot(vs_TEXCOORD4.xyz, u_xlat16_1.xyz);
...
void main()
{
    ...
    u_xlat16_1.xzw = (-u_xlat16_2.xyz) * vec3(u_xlat16_34) + u_xlat16_1.xxx;
    u_xlat16_1.xyz = abs(vec3(u_xlat16_11)) * u_xlat16_1.xzw + u_xlat16_8.xyz;
    SV_Target0.xyz = u_xlat0.xyz * u_xlat16_1.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_1.x = roundEven(u_xlat16_37);
    u_xlat16_13 = u_xlat16_37 * 2.0 + -1.0;
    u_xlat16_1.xzw = (-u_xlat16_5.xyz) * u_xlat16_4.xxx + u_xlat16_1.xxx;
    u_xlat16_1.xyz = abs(vec3(u_xlat16_13)) * u_xlat16_1.xzw + u_xlat16_10.xyz;
    SV_Target0.xyz = u_xlat0.xyz * u_xlat16_1.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat0.xyz = u_xlat16_1.xzy * vs_TEXCOORD3.yyy;
    u_xlat2.y = u_xlat0.x;
...
void main()
{
    ...
    u_xlat2.xyz = u_xlat16_1.xzy * vs_TEXCOORD3.yyy;
    u_xlat3.y = u_xlat2.x;
...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
    u_xlat16_0.xyz = max(u_xlat16_0.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_14.xyz = texture2D(unity_Lightmap, vs_TEXCOORD5.xy).xyz;
...
void main()
{
    ...
    u_xlat2.xyz = u_xlat16_4.xzy * vs_TEXCOORD3.yyy;
    u_xlat3.y = u_xlat2.x;
    u_xlat3.xz = vs_TEXCOORD2.xz;
