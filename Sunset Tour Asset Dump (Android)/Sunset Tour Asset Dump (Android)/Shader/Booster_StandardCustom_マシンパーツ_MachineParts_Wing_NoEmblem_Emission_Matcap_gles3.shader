...
void main()
{
    ...
    u_xlat16_4 = _Color * u_xlat16_4 + _AddColor;
...
void main()
{
    ...
    u_xlat16_2 = _Color * u_xlat16_2 + _AddColor;
    u_xlat16_7.xyz = u_xlat16_11.xyz * _SphereMapScale.xyz + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat16_2 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_2 = _Color * u_xlat16_2 + _AddColor;
    u_xlat16_3.xyz = u_xlat16_0.xyz * _SphereMapScale.xyz + u_xlat16_2.xyz;
    SV_Target0.w = u_xlat16_2.w * _AlphaFactor;
    ...
    u_xlat16_0 = texture(unity_SpecCube0, u_xlat0.xyz, u_xlat16_4.x);
...
void main()
{
    ...
    u_xlat16_2.xyz = texture(_MSA, vs_TEXCOORD1.xy).xyz;
    u_xlat16_3.xyz = max(u_xlat16_2.xyz, _MinMSA.xyz);
    ...
    u_xlat16_12.xyz = texture(_SphereMap, u_xlat16_4.xy).xyz;
    u_xlat16_4 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_4 = _Color * u_xlat16_4 + _AddColor;
    u_xlat16_7.xyz = u_xlat16_12.xyz * _SphereMapScale.xyz + u_xlat16_4.xyz;
    SV_Target0.w = u_xlat16_4.w * _AlphaFactor;
    u_xlat16_8.xyz = u_xlat16_7.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_8.xyz = u_xlat16_3.xxx * u_xlat16_8.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_3.x = (-u_xlat16_3.x) * 0.779083729 + 0.779083729;
...
void main()
{
    ...
    u_xlat16_4 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_4 = _Color * u_xlat16_4 + _AddColor;
    u_xlat16_7.xyz = u_xlat16_0.xyz * _SphereMapScale.xyz + u_xlat16_4.xyz;
    SV_Target0.w = u_xlat16_4.w * _AlphaFactor;
...
void main()
{
    ...
    u_xlat16_4.xyz = max(u_xlat16_3.xyz, _MinMSA.xyz);
    u_xlat3.x = (-u_xlat16_4.y) + 1.0;
    u_xlat13.x = u_xlat3.x * u_xlat3.x + 1.5;
    u_xlat32 = u_xlat32 * u_xlat13.x;
    u_xlat16_13.xyz = texture(_BumpMap, vs_TEXCOORD0.zw).xyz;
    u_xlat16_5.xyz = u_xlat16_13.xyz * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    ...
    u_xlat16_12.xyz = texture(_SphereMap, u_xlat16_5.xy).xyz;
    u_xlat16_5 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_5 = _Color * u_xlat16_5 + _AddColor;
    u_xlat16_8.xyz = u_xlat16_12.xyz * _SphereMapScale.xyz + u_xlat16_5.xyz;
