...
//
///////////////////////////////////////////
Shader "Booster/Effect/Fx_Blend_FixedAreaLoopBillboard" {
Properties {
...
void main()
{
    ...
    u_xlat1.xy = u_xlat18.xy * in_TEXCOORD0.xy;
    u_xlat18.xy = vec2(1.0, 1.0) / u_xlat18.xy;
    u_xlat1.xy = trunc(u_xlat1.xy);
    u_xlat0.xy = u_xlat18.xy * u_xlat1.xy + u_xlat0.xy;
    ...
    u_xlat3.xy = vec2(u_xlat27) + (-vec2(_CamNearFadeAlphaZeroDist, _CamFarFadeAlphaOneDist));
    u_xlat27 = u_xlat28 / _CamScaleLimitDist;
    u_xlat27 = u_xlat27 + 0.00100000005;
    u_xlat28 = dot(u_xlat2.xyz, u_xlat2.xyz);
    u_xlat28 = inversesqrt(u_xlat28);
    u_xlat2.xyz = vec3(u_xlat28) * u_xlat2.xyz;
    u_xlat4.x = dot(hlslcc_mtx4x4unity_ObjectToWorld[0].xyz, u_xlat2.xyz);
    u_xlat4.y = dot(hlslcc_mtx4x4unity_ObjectToWorld[1].xyz, u_xlat2.xyz);
    u_xlat4.z = dot(hlslcc_mtx4x4unity_ObjectToWorld[2].xyz, u_xlat2.xyz);
    ...
    u_xlat6.xy = in_POSITION0.xy * vec2(_PtclScaleX, _PtclScaleY);
    u_xlat6.z = in_POSITION0.z;
    u_xlat6.xyz = vec3(u_xlat28) * u_xlat6.xyz;
    u_xlat2.xyz = u_xlat2.xyz * u_xlat6.yyy;
    u_xlat2.xyz = u_xlat6.xxx * u_xlat5.xyz + u_xlat2.xyz;
    ...
    u_xlat7.z = u_xlat8.y;
    u_xlat7.x = u_xlat5.w;
    u_xlat4.y = dot(u_xlat2.xyz, u_xlat7.xyz);
    u_xlat8.w = u_xlat6.y;
    u_xlat5.z = u_xlat6.z;
    u_xlat4.z = dot(u_xlat2.xyz, u_xlat5.xyz);
    u_xlat4.x = dot(u_xlat2.yzx, u_xlat8.xzw);
    ...
    u_xlat9.xy = u_xlat3.xy / u_xlat9.xy;
