...
void main()
{
    ...
    u_xlat16_2 = texture(unity_SpecCube0, u_xlat2.xyz, u_xlat16_6.x);
...
void main()
{
    ...
    u_xlat16_3.xyz = texture(_EmissionMap, vs_TEXCOORD2.xy).xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
...
void main()
{
    ...
    u_xlat16_4 = texture(unity_SpecCube0, u_xlat4.xyz, u_xlat16_37);
    ...
    u_xlat16_6.xyz = u_xlat16_6.xyz * u_xlat16_9.xyz;
    u_xlat16_12.xyz = texture(unity_Lightmap, vs_TEXCOORD6.xy).xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = texture(_MSA, vs_TEXCOORD1.zw).xyz;
    u_xlat16_1.xy = max(u_xlat16_3.xy, _MinMSA.xy);
    ...
    u_xlat16_14.xyz = texture(_BumpMap, vs_TEXCOORD1.xy).xyz;
    ...
    u_xlat16_4.xy = u_xlat16_4.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
    u_xlat16_13.xyz = texture(_SphereMap, u_xlat16_4.xy).xyz;
    u_xlat16_5.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_4.xyz = _Color.xyz * u_xlat16_5.xyz + _AddColor.xyz;
    u_xlat16_4.xyz = u_xlat16_13.xyz * _SphereMapScale.xyz + u_xlat16_4.xyz;
    ...
    u_xlat33 = inversesqrt(u_xlat33);
    u_xlat0.xyz = vec3(u_xlat33) * u_xlat0.xyz;
    u_xlat16_0 = texture(unity_SpecCube0, u_xlat0.xyz, u_xlat16_12);
    ...
    u_xlat16_8.xyz = u_xlat16_0.xyz * vec3(u_xlat16_12);
...
void main()
{
    ...
    u_xlat16_6.xyz = u_xlat16_9.xyz * u_xlat16_10.xyz + u_xlat16_6.xyz;
    u_xlat16_8.xyz = u_xlat0.xxx * u_xlat16_8.xyz + u_xlat16_10.xyz;
    u_xlat16_2 = texture(unity_ShadowMask, vs_TEXCOORD8.xy);
    u_xlat16_12 = dot(u_xlat16_2, unity_OcclusionMaskSelector);
#ifdef UNITY_ADRENO_ES3
    u_xlat16_12 = min(max(u_xlat16_12, 0.0), 1.0);
#else
    u_xlat16_12 = clamp(u_xlat16_12, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_15.xyz = texture(_BumpMap, vs_TEXCOORD1.xy).xyz;
    u_xlat16_5.xyz = u_xlat16_15.xyz * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    ...
    u_xlat16_14.xyz = texture(_SphereMap, u_xlat16_5.xy).xyz;
    u_xlat16_6.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_5.xyz = _Color.xyz * u_xlat16_6.xyz + _AddColor.xyz;
    u_xlat16_5.xyz = u_xlat16_14.xyz * _SphereMapScale.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    vs_TEXCOORD7 = max(u_xlat15, u_xlat16_3);
    vs_TEXCOORD2.xy = in_TEXCOORD0.xy * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
    vs_TEXCOORD3.w = u_xlat0.x;
    u_xlat1.y = dot(in_NORMAL0.xyz, hlslcc_mtx4x4unity_WorldToObject[0].xyz);
    u_xlat1.z = dot(in_NORMAL0.xyz, hlslcc_mtx4x4unity_WorldToObject[1].xyz);
...
void main()
{
    ...
    vs_TEXCOORD1.zw = in_TEXCOORD0.xy * _MSA_ST.xy + _MSA_ST.zw;
    u_xlat16_3 = (-unity_FogColor.w) + 1.0;
    vs_TEXCOORD7 = max(u_xlat18, u_xlat16_3);
    vs_TEXCOORD2.xy = in_TEXCOORD0.xy * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
    vs_TEXCOORD3.w = u_xlat0.x;
    u_xlat1.xyz = in_TANGENT0.yyy * hlslcc_mtx4x4unity_ObjectToWorld[1].yzx;
    u_xlat1.xyz = hlslcc_mtx4x4unity_ObjectToWorld[0].yzx * in_TANGENT0.xxx + u_xlat1.xyz;
    ...
    u_xlat16_5.y = dot(unity_SHBg, u_xlat16_0);
    u_xlat16_5.z = dot(unity_SHBb, u_xlat16_0);
    vs_TEXCOORD6.xyz = unity_SHC.xyz * vec3(u_xlat16_3) + u_xlat16_5.xyz;
    vs_TEXCOORD8 = vec4(0.0, 0.0, 0.0, 0.0);
    return;
}
...
void main()
{
    ...
    u_xlat16_1.xyw = (-u_xlat16_4.xyz) * u_xlat16_1.xxx + vec3(u_xlat16_12);
    u_xlat16_1.xyz = abs(vec3(u_xlat16_23)) * u_xlat16_1.xyw + u_xlat16_9.xyz;
    u_xlat16_1.xyz = u_xlat0.xyz * u_xlat16_1.xyz + u_xlat16_7.xyz;
    u_xlat16_0.xyz = u_xlat16_1.xyz + (-unity_FogColor.xyz);
    u_xlat33 = vs_TEXCOORD7;
#ifdef UNITY_ADRENO_ES3
    u_xlat33 = min(max(u_xlat33, 0.0), 1.0);
...
void main()
{
    ...
    u_xlat16_11.xyz = _Color.xyz * u_xlat16_2.xyz + _AddColor.xyz;
    u_xlat16_11.xyz = u_xlat16_7.xyz * _SphereMapScale.xyz + u_xlat16_11.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = texture(_SphereMap, u_xlat16_8.xz).xyz;
    u_xlat16_4.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
