...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/AO" {
Properties {
...
void main()
{
    ...
    u_xlat10_24 = texture2D(_MSA, vs_TEXCOORD0.xy).z;
    u_xlat16_28 = u_xlat10_24 + -1.0;
...
void main()
{
    ...
    u_xlat16_2.x = (u_xlatb27) ? 0.0 : u_xlat30;
    u_xlat10_2 = textureCube(unity_SpecCube0, u_xlat3.xyz, u_xlat16_2.x);
    u_xlat16_5.x = u_xlat10_2.w + -1.0;
    u_xlat16_5.x = unity_SpecCube0_HDR.w * u_xlat16_5.x + 1.0;
    u_xlat16_5.x = u_xlat16_5.x * unity_SpecCube0_HDR.x;
    ...
    u_xlat16_32 = (-u_xlat16_1.x) + _Smoothness;
    ...
    u_xlat16_1.xyz = u_xlat16_10.xyz * u_xlat16_8.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat16_15.xyz = u_xlat16_9.xyz * u_xlat16_6.xxx;
    u_xlat16_6.x = (-u_xlat16_6.x) + _Smoothness;
    u_xlat16_6.x = u_xlat16_6.x + 1.0;
    u_xlat16_6.x = clamp(u_xlat16_6.x, 0.0, 1.0);
    u_xlat16_7.xyz = _Color.xyz * vs_COLOR0.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_7.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat0.xyz = u_xlat0.xxx * u_xlat16_7.xyz + u_xlat16_15.xyz;
...
void main()
{
    ...
    u_xlat16_2.x = (u_xlatb24) ? 0.0 : u_xlat27;
    u_xlat10_2 = textureCube(unity_SpecCube0, u_xlat3.xyz, u_xlat16_2.x);
    u_xlat16_5.x = u_xlat10_2.w + -1.0;
    u_xlat16_5.x = unity_SpecCube0_HDR.w * u_xlat16_5.x + 1.0;
    u_xlat16_5.x = u_xlat16_5.x * unity_SpecCube0_HDR.x;
    ...
    u_xlat16_8 = u_xlat16_1.x * u_xlat16_8;
    u_xlat16_8 = u_xlat16_1.x * u_xlat16_8;
    u_xlat16_1.x = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_29 = (-u_xlat16_1.x) + _Smoothness;
    u_xlat16_29 = u_xlat16_29 + 1.0;
    u_xlat16_29 = clamp(u_xlat16_29, 0.0, 1.0);
    u_xlat16_6.xyz = _Color.xyz * vs_COLOR0.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat16_1.xyz = u_xlat16_9.xyz * u_xlat16_7.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat16_9.xxx * u_xlat16_7.xyz + u_xlat16_15.xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat16_7.xyz;
    ...
    u_xlat16_9.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat16_8.xyz = vec3(u_xlat16_32) * u_xlat16_9.xyz;
    u_xlat16_4.xyz = u_xlat16_7.xyz * u_xlat16_8.xyz + u_xlat16_4.xyz;
    u_xlat16_6.xyz = u_xlat0.xxx * u_xlat16_15.xyz + u_xlat16_8.xyz;
    SV_Target0.xyz = u_xlat16_6.xyz * u_xlat16_5.xyz + u_xlat16_4.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_6.x = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_17.xyz = u_xlat16_11.xyz * u_xlat16_6.xxx;
    u_xlat16_6.x = (-u_xlat16_6.x) + _Smoothness;
    u_xlat16_6.x = u_xlat16_6.x + 1.0;
    u_xlat16_6.x = clamp(u_xlat16_6.x, 0.0, 1.0);
    u_xlat16_7.xyz = _Color.xyz * vs_COLOR0.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_7.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat0.xyz = u_xlat0.xxx * u_xlat16_7.xyz + u_xlat16_17.xyz;
    u_xlat0.xyz = u_xlat0.xyz * _LightColor0.xyz;
    u_xlat16_40 = vs_TEXCOORD1.y * vs_TEXCOORD1.y;
    u_xlat16_40 = vs_TEXCOORD1.x * vs_TEXCOORD1.x + (-u_xlat16_40);
    ...
    u_xlat16_38 = u_xlat16_38 * u_xlat16_38;
    u_xlat0.xyz = u_xlat0.xyz * vec3(u_xlat33) + u_xlat16_17.xyz;
    u_xlat16_6.xyz = u_xlat16_6.xxx + (-u_xlat16_7.xyz);
    u_xlat16_6.xyz = vec3(u_xlat16_38) * u_xlat16_6.xyz + u_xlat16_7.xyz;
    u_xlat0.xyz = u_xlat16_5.xyz * u_xlat16_6.xyz + u_xlat0.xyz;
    SV_Target0.xyz = u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat16_13.xyz * u_xlat16_7.xyz + u_xlat16_4.xyz;
    u_xlat16_5.xyz = u_xlat0.xxx * u_xlat16_6.xyz + u_xlat16_7.xyz;
...
void main()
{
    ...
    u_xlat0.xyz = u_xlat0.xxx * u_xlat16_7.xyz + u_xlat16_17.xyz;
    u_xlat10_2 = texture2D(unity_ShadowMask, vs_TEXCOORD5.xy);
    u_xlat16_40 = dot(u_xlat10_2, unity_OcclusionMaskSelector);
