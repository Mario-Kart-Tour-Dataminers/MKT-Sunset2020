...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/透過/Fade" {
Properties {
...
void main()
{
    ...
    u_xlat0.xyw = u_xlat1.xyz * vec3(u_xlat16_6) + u_xlat0.xyw;
    u_xlat0.xyw = u_xlat0.xyw * _LightColor0.xyz;
    u_xlat1.xyz = u_xlat0.xyw * vec3(u_xlat16) + u_xlat16_5.xyz;
    SV_Target0 = u_xlat1;
    return;
}
...
void main()
{
    ...
    u_xlat2.xyz = u_xlat16_5.xyz * u_xlat16_6.xyz + u_xlat0.xyz;
    SV_Target0 = u_xlat2;
    return;
}
...
void main()
{
    ...
    u_xlat16_35 = dot(u_xlat10_4, unity_OcclusionMaskSelector);
    u_xlat16_35 = clamp(u_xlat16_35, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat16_7.xyz;
    u_xlat16_9.xyz = texture2D(unity_Lightmap, vs_TEXCOORD2.xy).xyz;
...
void main()
{
    ...
    u_xlat16_2.x = dot((-u_xlat14.xyz), vs_TEXCOORD0.xyz);
    u_xlat16_2.x = u_xlat16_2.x + u_xlat16_2.x;
    u_xlat16_2.xyz = vs_TEXCOORD0.xyz * (-u_xlat16_2.xxx) + (-u_xlat14.xyz);
    u_xlat1 = dot(u_xlat16_2.zxy, (-u_xlat16_2.xyz));
    u_xlatb1 = u_xlat1<9.99999975e-06;
    u_xlat1 = (u_xlatb1) ? u_xlat16_2.z : (-u_xlat16_2.z);
    u_xlat3.z = u_xlat1 * u_xlat16_2.x;
    ...
    u_xlat16_7.xyz = u_xlat2.xyz * vec3(u_xlat16_44);
    u_xlat16_44 = (-u_xlat16_44) + _Smoothness;
    u_xlat16_44 = u_xlat16_44 + 1.0;
    u_xlat16_44 = clamp(u_xlat16_44, 0.0, 1.0);
    u_xlat16_8.xyz = (-u_xlat16_6.xyz) + vec3(u_xlat16_44);
    u_xlat0.xyz = u_xlat0.xxx * u_xlat16_6.xyz + u_xlat16_7.xyz;
    u_xlat0.xyz = u_xlat0.xyz * _LightColor0.xyz;
    u_xlat16_44 = vs_TEXCOORD0.y * vs_TEXCOORD0.y;
    u_xlat16_44 = vs_TEXCOORD0.x * vs_TEXCOORD0.x + (-u_xlat16_44);
    ...
    u_xlat16_12.xyz = texture2D(unity_Lightmap, vs_TEXCOORD2.xy).xyz;
    u_xlat16_9.xyz = unity_Lightmap_HDR.xxx * u_xlat16_12.xyz + u_xlat16_11.xyz;
    u_xlat16_9.xyz = u_xlat16_9.xyz * vec3(_Occlusion);
    u_xlat16_7.xyz = u_xlat16_7.xyz * u_xlat16_9.xyz;
    u_xlat39 = dot(u_xlat3.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat39 = clamp(u_xlat39, 0.0, 1.0);
    u_xlat1 = dot(u_xlat3.xyz, u_xlat14.xyz);
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    u_xlat16_44 = (-u_xlat1) + 1.0;
    u_xlat16_44 = u_xlat16_44 * u_xlat16_44;
    u_xlat16_44 = u_xlat16_44 * u_xlat16_44;
    u_xlat16_6.xyz = vec3(u_xlat16_44) * u_xlat16_8.xyz + u_xlat16_6.xyz;
...
void main()
{
    ...
    u_xlat0.xyz = u_xlat0.xxx * u_xlat16_6.xyz + u_xlat16_7.xyz;
    u_xlat10_4 = texture2D(unity_ShadowMask, vs_TEXCOORD4.xy);
    u_xlat16_44 = dot(u_xlat10_4, unity_OcclusionMaskSelector);
    u_xlat16_44 = clamp(u_xlat16_44, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_6.xyz = u_xlat0.xyz * vec3(u_xlat16_28) + u_xlat16_6.xyz;
    u_xlat16_4.xyz = u_xlat16_6.xyz * u_xlat16_5.xyz + u_xlat16_4.xyz;
    u_xlat16_2.xyz = u_xlat16_4.xyz + (-unity_FogColor.xyz);
    u_xlat26 = vs_TEXCOORD1.w;
    u_xlat26 = clamp(u_xlat26, 0.0, 1.0);
    u_xlat0.xyz = vec3(u_xlat26) * u_xlat16_2.xyz + unity_FogColor.xyz;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat16_8.xyz;
    u_xlat2 = vs_COLOR0 * _Color;
    u_xlat16_8.xyz = vec3(u_xlat16_28) * u_xlat2.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_8.xyz + u_xlat16_5.xyz;
    u_xlat16_5.xyz = u_xlat0.xxx * u_xlat16_7.xyz + u_xlat16_8.xyz;
    ...
    u_xlat27 = clamp(u_xlat27, 0.0, 1.0);
    u_xlat2.xyz = vec3(u_xlat27) * u_xlat16_0.xyz + unity_FogColor.xyz;
    SV_Target0 = u_xlat2;
    return;
}
...
void main()
{
    ...
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat16_7.xyz;
    u_xlat2 = vs_COLOR0 * _Color;
    u_xlat16_7.xyz = vec3(u_xlat16_25) * u_xlat2.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_7.xyz + u_xlat16_5.xyz;
    u_xlat16_5.xyz = u_xlat0.xxx * u_xlat16_6.xyz + u_xlat16_7.xyz;
    u_xlat10_3 = texture2D(unity_ShadowMask, vs_TEXCOORD4.xy);
    u_xlat16_25 = dot(u_xlat10_3, unity_OcclusionMaskSelector);
    u_xlat16_25 = clamp(u_xlat16_25, 0.0, 1.0);
    u_xlat16_6.xyz = vec3(u_xlat16_25) * _LightColor0.xyz;
    u_xlat16_6.xyz = vec3(u_xlat24) * u_xlat16_6.xyz;
    u_xlat16_1.xyz = u_xlat16_5.xyz * u_xlat16_6.xyz + u_xlat16_1.xyz;
    ...
    u_xlat24 = vs_TEXCOORD1.w;
    u_xlat24 = clamp(u_xlat24, 0.0, 1.0);
    u_xlat2.xyz = vec3(u_xlat24) * u_xlat16_0.xyz + unity_FogColor.xyz;
    SV_Target0 = u_xlat2;
    return;
}
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat16_7.xyz * vec3(_Occlusion);
    u_xlat1 = vs_COLOR0 * _Color;
    u_xlat16_8.xyz = vec3(u_xlat16_31) * u_xlat1.xyz;
    u_xlat16_4.xyz = u_xlat16_7.xyz * u_xlat16_8.xyz + u_xlat16_4.xyz;
    u_xlat16_6.xyz = u_xlat0.xxx * u_xlat16_6.xyz + u_xlat16_8.xyz;
    u_xlat16_4.xyz = u_xlat16_6.xyz * u_xlat16_5.xyz + u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_8.xyz;
    u_xlat1 = vs_COLOR0 * _Color;
    u_xlat16_8.xyz = vec3(u_xlat16_27) * u_xlat1.xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat16_8.xyz + u_xlat16_2.xyz;
    u_xlat16_2.xyz = u_xlat3.xxx * u_xlat16_7.xyz + u_xlat16_8.xyz;
    ...
    u_xlat30 = vs_TEXCOORD1.w;
    u_xlat30 = clamp(u_xlat30, 0.0, 1.0);
    u_xlat1.xyz = vec3(u_xlat30) * u_xlat16_3.xyz + unity_FogColor.xyz;
    SV_Target0 = u_xlat1;
    return;
}
...
void main()
{
    ...
    u_xlat39 = clamp(u_xlat39, 0.0, 1.0);
    u_xlat2.xyz = vec3(u_xlat39) * u_xlat0.xyz + unity_FogColor.xyz;
    SV_Target0 = u_xlat2;
    return;
}
...
void main()
{
    ...
    u_xlat16_6.xyz = u_xlat16_6.xyz * vec3(_Occlusion);
    u_xlat1 = vs_COLOR0 * _Color;
    u_xlat16_7.xyz = vec3(u_xlat16_28) * u_xlat1.xyz;
    u_xlat16_4.xyz = u_xlat16_6.xyz * u_xlat16_7.xyz + u_xlat16_4.xyz;
    u_xlat16_5.xyz = u_xlat0.xxx * u_xlat16_13.xyz + u_xlat16_7.xyz;
    u_xlat10_2 = texture2D(unity_ShadowMask, vs_TEXCOORD4.xy);
...
void main()
{
    ...
    u_xlat27 = vs_TEXCOORD1.w;
    u_xlat27 = clamp(u_xlat27, 0.0, 1.0);
    u_xlat1.xyz = vec3(u_xlat27) * u_xlat16_3.xyz + unity_FogColor.xyz;
    SV_Target0 = u_xlat1;
    return;
}
