...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/マシンパーツ/MachineParts_Wing_NoEmblem_Emission" {
Properties {
...
void main()
{
    ...
    u_xlat16_17 = (-u_xlat26) + 1.0;
    u_xlat16_8 = u_xlat16_17 * u_xlat16_17;
    u_xlat16_8 = u_xlat16_17 * u_xlat16_8;
    u_xlat16_8 = u_xlat16_17 * u_xlat16_8;
    u_xlat16_17 = (-u_xlat16_1.x) * 0.779083729 + 0.779083729;
    u_xlat16_9 = (-u_xlat16_17) + u_xlat16_1.y;
    ...
    u_xlat16_1.xyw = vec3(u_xlat16_8) * u_xlat16_1.xyw + u_xlat16_7.xyz;
    u_xlat16_7.xyz = u_xlat0.xxx * u_xlat16_7.xyz;
    u_xlat16_7.xyz = u_xlat16_2.xyz * vec3(u_xlat16_17) + u_xlat16_7.xyz;
...
void main()
{
    ...
    u_xlat16_5.x = (u_xlatb26) ? 0.0 : u_xlat27;
    ...
    u_xlat16_17 = u_xlat24 * u_xlat2.x;
    ...
    u_xlat16_1.xyw = vec3(u_xlat16_25) * u_xlat16_7.xyz + u_xlat16_6.xyz;
    ...
    u_xlat8.xyz = u_xlat16_4.xyz * vec3(u_xlat16_17) + u_xlat8.xyz;
    SV_Target0.w = u_xlat16_4.w * _AlphaFactor;
    u_xlat8.xyz = u_xlat8.xyz * _LightColor0.xyz;
    u_xlat0.xyz = u_xlat8.xyz * u_xlat0.xxx + u_xlat16_1.xyw;
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat16_1.zzz * u_xlat16_0.xyz;
    u_xlat16_8.xyz = vec3(u_xlat16_28) * u_xlat16_3.xyz;
    SV_Target0.w = u_xlat16_3.w * _AlphaFactor;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_8.xyz + u_xlat16_5.xyz;
    u_xlat16_5.xyz = u_xlat2.xxx * u_xlat16_6.xyz + u_xlat16_8.xyz;
...
void main()
{
    ...
    u_xlat16_1.xyw = vec3(u_xlat16_28) * u_xlat16_8.xyz + u_xlat16_6.xyz;
    u_xlat2.xyz = u_xlat2.xxx * u_xlat16_6.xyz + u_xlat16_7.xyz;
    ...
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
    u_xlat16_0.xyz = max(u_xlat16_0.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_6.xyz = u_xlat16_1.zzz * u_xlat16_0.xyz;
...
void main()
{
    ...
    u_xlat16_0.xyz = max(u_xlat16_0.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_1.xyz = u_xlat16_1.zzz * u_xlat16_0.xyz;
    u_xlat16_7.xyz = vec3(u_xlat16_25) * u_xlat16_3.xyz;
    SV_Target0.w = u_xlat16_3.w * _AlphaFactor;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_7.xyz + u_xlat16_5.xyz;
    u_xlat16_5.xyz = u_xlat2.xxx * u_xlat16_6.xyz + u_xlat16_7.xyz;
...
void main()
{
    ...
    u_xlat16_7.xyz = unity_SHC.xyz * u_xlat16_2.xxx + u_xlat16_7.xyz;
    ...
    u_xlat16_7.xyz = max(u_xlat16_7.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat0.yzw = log2(u_xlat16_7.xyz);
    ...
    u_xlat16_7.xyz = unity_Lightmap_HDR.xxx * u_xlat16_1.xyz + u_xlat10.xyz;
    u_xlat16_2.xyz = u_xlat16_2.zzz * u_xlat16_7.xyz;
    u_xlat16_7.xyz = vec3(u_xlat16_32) * u_xlat16_3.xyz;
    SV_Target0.w = u_xlat16_3.w * _AlphaFactor;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_7.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat16_10.x = u_xlat20 * u_xlat28;
    ...
    u_xlat4.xyw = u_xlat4.xxx * u_xlat16_7.xyz + u_xlat16_6.xyz;
    ...
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_10.xxx;
    u_xlat16_10.xyz = vec3(u_xlat16_25) + (-u_xlat16_7.xyz);
...
void main()
{
    ...
    u_xlat16_6.xyz = u_xlat16_1.xxx * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_7.xyz = vec3(u_xlat16_9) + (-u_xlat16_6.xyz);
    u_xlat16_7.xyz = vec3(u_xlat16_16) * u_xlat16_7.xyz + u_xlat16_6.xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat16_7.xyz;
    u_xlat16_3.xyz = texture2D(unity_Lightmap, vs_TEXCOORD5.xy).xyz;
    u_xlat16_7.xyz = u_xlat16_3.xyz * unity_Lightmap_HDR.xxx;
    u_xlat16_1.xyz = u_xlat16_1.zzz * u_xlat16_7.xyz;
    u_xlat16_7.xyz = vec3(u_xlat16_25) * u_xlat16_2.xyz;
    SV_Target0.w = u_xlat16_2.w * _AlphaFactor;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_7.xyz + u_xlat16_5.xyz;
    u_xlat16_5.xyz = vec3(u_xlat8) * u_xlat16_6.xyz + u_xlat16_7.xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = max(u_xlat16_1.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_9.xyz = texture2D(unity_Lightmap, vs_TEXCOORD5.xy).xyz;
    u_xlat16_7.xyz = unity_Lightmap_HDR.xxx * u_xlat16_9.xyz + u_xlat16_1.xyz;
    u_xlat16_2.xyz = u_xlat16_2.zzz * u_xlat16_7.xyz;
    u_xlat16_7.xyz = vec3(u_xlat16_32) * u_xlat16_3.xyz;
    SV_Target0.w = u_xlat16_3.w * _AlphaFactor;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_7.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat16_11.x = u_xlat22 * u_xlat31;
    ...
    u_xlat4.xyw = u_xlat4.xxx * u_xlat16_8.xyz + u_xlat16_6.xyz;
    u_xlat4.xyw = u_xlat16_7.xyz * u_xlat4.xyw;
    ...
    u_xlat16_11.xyz = vec3(u_xlat16_28) + (-u_xlat16_8.xyz);
    u_xlat16_2.xyz = u_xlat16_2.xxx * u_xlat16_11.xyz + u_xlat16_8.xyz;
    u_xlat0.xyz = u_xlat16_1.xyz * u_xlat16_2.xyz + u_xlat4.xyw;
    u_xlat10_4.xyz = texture2D(_EmissionMap, vs_TEXCOORD1.zw).xyz;
    u_xlat16_4.xyz = u_xlat10_4.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    SV_Target0.xyz = u_xlat16_4.xyz * vec3(_EmissionIntensity) + u_xlat0.xyz;
...
void main()
{
    ...
    u_xlat0.x = texture2D(unity_NHxRoughness, u_xlat4.xz).x;
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_18 = (-u_xlat25) + 1.0;
    u_xlat16_8 = u_xlat16_18 * u_xlat16_18;
    u_xlat16_8 = u_xlat16_18 * u_xlat16_8;
    u_xlat16_8 = u_xlat16_18 * u_xlat16_8;
    u_xlat16_18 = (-u_xlat16_2.x) * 0.779083729 + 0.779083729;
    u_xlat16_10 = (-u_xlat16_18) + u_xlat16_2.y;
    u_xlat16_10 = u_xlat16_10 + 1.0;
    u_xlat16_10 = clamp(u_xlat16_10, 0.0, 1.0);
    ...
    u_xlat16_2.xyw = vec3(u_xlat16_8) * u_xlat16_2.xyw + u_xlat16_7.xyz;
    u_xlat16_7.xyz = u_xlat0.xxx * u_xlat16_7.xyz;
    u_xlat16_7.xyz = u_xlat16_1.xyz * vec3(u_xlat16_18) + u_xlat16_7.xyz;
...
void main()
{
    ...
    u_xlat27 = u_xlat24 * 8.29800034;
    u_xlat16_5.x = (u_xlatb25) ? 0.0 : u_xlat27;
    ...
    u_xlat16_18 = u_xlat24 * u_xlat1.x;
    u_xlat24 = u_xlat24 * u_xlat24 + 1.5;
    ...
    u_xlat16_6.xyz = u_xlat16_2.xxx * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_7.xyz = vec3(u_xlat16_10) + (-u_xlat16_6.xyz);
    u_xlat16_2.xyw = vec3(u_xlat16_26) * u_xlat16_7.xyz + u_xlat16_6.xyz;
    ...
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat8 = max(u_xlat17, 0.319999993);
    ...
    u_xlat0.xyz = u_xlat16_4.xyz * vec3(u_xlat16_18) + u_xlat0.xyz;
    SV_Target0.w = u_xlat16_4.w * _AlphaFactor;
    u_xlat0.xyz = u_xlat0.xyz * _LightColor0.xyz;
    u_xlat0.xyz = u_xlat0.xyz * u_xlat9.xxx + u_xlat16_2.xyw;
...
void main()
{
    ...
    u_xlat16_6.xyz = u_xlat16_3.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = u_xlat16_2.xxx * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_7.xyz = vec3(u_xlat16_11) + (-u_xlat16_6.xyz);
    u_xlat16_7.xyz = vec3(u_xlat16_10) * u_xlat16_7.xyz + u_xlat16_6.xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat16_7.xyz;
    u_xlat10.x = dot(u_xlat0.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat10.x = clamp(u_xlat10.x, 0.0, 1.0);
    ...
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
    u_xlat16_0.xyz = max(u_xlat16_0.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_2.xyz = u_xlat16_2.zzz * u_xlat16_0.xyz;
    u_xlat16_8.xyz = vec3(u_xlat16_29) * u_xlat16_3.xyz;
    SV_Target0.w = u_xlat16_3.w * _AlphaFactor;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_8.xyz + u_xlat16_5.xyz;
    u_xlat16_5.xyz = u_xlat1.xxx * u_xlat16_6.xyz + u_xlat16_8.xyz;
    u_xlat16_2.xyz = u_xlat16_5.xyz * u_xlat16_7.xyz + u_xlat16_2.xyz;
    u_xlat10_0.xyz = texture2D(_EmissionMap, vs_TEXCOORD1.zw).xyz;
    u_xlat16_0.xyz = u_xlat10_0.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_2.xyz = u_xlat16_0.xyz * vec3(_EmissionIntensity) + u_xlat16_2.xyz;
    u_xlat16_0.xyz = u_xlat16_2.xyz + (-unity_FogColor.xyz);
...
void main()
{
    ...
    u_xlat16_2.xyw = vec3(u_xlat16_29) * u_xlat16_8.xyz + u_xlat16_6.xyz;
...
void main()
{
    ...
    u_xlat16_0.xyz = max(u_xlat16_0.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_2.xyz = u_xlat16_2.zzz * u_xlat16_0.xyz;
    u_xlat16_7.xyz = vec3(u_xlat16_26) * u_xlat16_3.xyz;
    SV_Target0.w = u_xlat16_3.w * _AlphaFactor;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_7.xyz + u_xlat16_5.xyz;
    u_xlat16_5.xyz = u_xlat1.xxx * u_xlat16_6.xyz + u_xlat16_7.xyz;
    u_xlat10_0 = texture2D(unity_ShadowMask, vs_TEXCOORD7.xy);
...
void main()
{
    ...
    u_xlat16_9.x = u_xlat16_29 * u_xlat16_29;
    ...
    u_xlat16_9.xyz = texture2D(unity_Lightmap, vs_TEXCOORD5.xy).xyz;
    u_xlat16_8.xyz = u_xlat16_9.xyz * unity_Lightmap_HDR.xxx;
    u_xlat16_2.xyz = u_xlat16_2.zzz * u_xlat16_8.xyz;
...
void main()
{
    ...
    u_xlat11.x = dot(u_xlat0.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat11.x = clamp(u_xlat11.x, 0.0, 1.0);
    u_xlat16_8.xyz = u_xlat11.xxx * _LightColor0.xyz;
    u_xlat0.w = 1.0;
    ...
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
    u_xlat16_0.xyz = max(u_xlat16_0.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_11.xyz = texture2D(unity_Lightmap, vs_TEXCOORD5.xy).xyz;
    u_xlat16_7.xyz = unity_Lightmap_HDR.xxx * u_xlat16_11.xyz + u_xlat16_0.xyz;
    u_xlat16_2.xyz = u_xlat16_2.zzz * u_xlat16_7.xyz;
    u_xlat16_7.xyz = vec3(u_xlat16_32) * u_xlat16_3.xyz;
    SV_Target0.w = u_xlat16_3.w * _AlphaFactor;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_7.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat16_29 = (-u_xlat16_29) + u_xlat16_4.y;
    ...
    u_xlat7.xyz = u_xlat5.xyz * u_xlat12.xxx + _WorldSpaceLightPos0.xyz;
    ...
    u_xlat5.xyw = u_xlat5.xxx * u_xlat16_8.xyz + u_xlat16_6.xyz;
    u_xlat5.xyw = u_xlat5.xyw * _LightColor0.xyz;
    u_xlat5.xyw = u_xlat5.xyw * vec3(u_xlat27) + u_xlat16_2.xyz;
    ...
    u_xlat3.x = u_xlat23 * 8.29800034;
    u_xlat16_2.x = (u_xlatb27) ? 0.0 : u_xlat3.x;
    ...
    u_xlat16_13.xyz = vec3(u_xlat16_29) + (-u_xlat16_8.xyz);
    u_xlat16_4.xyz = u_xlat16_4.xxx * u_xlat16_13.xyz + u_xlat16_8.xyz;
    u_xlat0.xyz = u_xlat16_2.xyz * u_xlat16_4.xyz + u_xlat5.xyw;
    u_xlat10_3.xyz = texture2D(_EmissionMap, vs_TEXCOORD1.zw).xyz;
    u_xlat16_3.xyz = u_xlat10_3.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_2.xyz = u_xlat16_3.xyz * vec3(_EmissionIntensity) + u_xlat0.xyz;
    u_xlat16_0.xyz = u_xlat16_2.xyz + (-unity_FogColor.xyz);
...
void main()
{
    ...
    u_xlat16_0.xyz = max(u_xlat16_0.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_9.xyz = texture2D(unity_Lightmap, vs_TEXCOORD5.xy).xyz;
    u_xlat16_7.xyz = unity_Lightmap_HDR.xxx * u_xlat16_9.xyz + u_xlat16_0.xyz;
    u_xlat16_2.xyz = u_xlat16_2.zzz * u_xlat16_7.xyz;
    u_xlat16_7.xyz = vec3(u_xlat16_32) * u_xlat16_3.xyz;
    SV_Target0.w = u_xlat16_3.w * _AlphaFactor;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_7.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat5.xyw = u_xlat5.xyw * u_xlat16_6.xyz;
    u_xlat5.xyw = u_xlat5.xyw * vec3(u_xlat27) + u_xlat16_2.xyz;
    u_xlat16_2.x = dot((-u_xlat12.xyz), u_xlat0.xyz);
    u_xlat16_2.x = u_xlat16_2.x + u_xlat16_2.x;
    u_xlat16_2.xyz = u_xlat0.xyz * (-u_xlat16_2.xxx) + (-u_xlat12.xyz);
