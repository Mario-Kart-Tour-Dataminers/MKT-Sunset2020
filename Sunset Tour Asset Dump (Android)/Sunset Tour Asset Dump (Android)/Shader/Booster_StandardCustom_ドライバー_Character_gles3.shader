...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat16_4.xyz * u_xlat16_8.xyz + _AddColor.xyz;
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat16_2.xyz * u_xlat16_5.xyz + _AddColor.xyz;
...
void main()
{
    ...
    u_xlat16_4 = texture(unity_SpecCube0, u_xlat4.xyz, u_xlat16_42);
    ...
    u_xlat16_6.xyz = u_xlat16_4.xyz * vec3(u_xlat16_42);
...
void main()
{
    ...
    u_xlat16_6.xyz = u_xlat16_3.xyz * u_xlat16_4.xyz + _AddColor.xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat16_5.xyz * u_xlat16_6.xyz + _AddColor.xyz;
...
void main()
{
    ...
    u_xlat16_11.xyz = u_xlat16_1.xyz * u_xlat16_3.xyz + _AddColor.xyz;
...
void main()
{
    ...
    u_xlat16_18 = u_xlat16_1.z + -1.0;
    u_xlat16_18 = _Occlusion * u_xlat16_18 + 1.0;
    u_xlat16_18 = max(u_xlat16_18, _MinMSA.z);
    u_xlat16_1.x = (-u_xlat16_2.y) + 1.0;
    u_xlat16_9.x = u_xlat16_1.x * u_xlat16_1.x + 1.5;
    u_xlat16_1.x = u_xlat16_1.x * u_xlat16_1.x;
    u_xlat24 = u_xlat24 * u_xlat16_9.x;
    u_xlat16_9.xyz = texture(_BumpMap, vs_TEXCOORD0.zw).xyz;
...
#endif
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat16_16 = u_xlat16_1.x * u_xlat16_1.x + -1.0;
    ...
    u_xlat16_1.xyz = texture(_SphereMap, u_xlat16_10.xz).xyz;
    u_xlat16_4.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat16_5.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_3.xyz = u_xlat16_4.xyz * u_xlat16_5.xyz + _AddColor.xyz;
    u_xlat16_3.xyz = u_xlat16_1.xyz * _SphereMapScale.xyz + u_xlat16_3.xyz;
