...
void main()
{
    u_xlat16_0 = texture(_TransparencyLM, vs_TEXCOORD0.zw).x;
    ...
    u_xlat16_2.xyz = texture(_BumpMap, vs_TEXCOORD1.xy).xyz;
    ...
    u_xlat16_5.xyz = texture(_MSA, vs_TEXCOORD1.zw).xyz;
    u_xlat16_1.xy = max(u_xlat16_5.xy, _MinMSA.xy);
    u_xlat16_23.x = u_xlat16_5.z + -1.0;
    ...
    u_xlat16_4 = texture(unity_SpecCube0, u_xlat4.xyz, u_xlat16_34);
    ...
    u_xlat16_2.xyz = texture(_SphereMap, u_xlat16_23.xy).xyz;
    u_xlat16_4.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_7.xyz = _Color.xyz * u_xlat16_4.xyz + _AddColor.xyz;
    u_xlat16_7.xyz = u_xlat16_2.xyz * _SphereMapScale.xyz + u_xlat16_7.xyz;
...
void main()
{
    ...
    u_xlat16_1 = u_xlat16_0.x + (-_Cutout);
#ifdef UNITY_ADRENO_ES3
...
#endif
    if(((int(u_xlatb0) * int(0xffffffffu)))!=0){discard;}
    u_xlat16_0.xyz = texture(_MSA, vs_TEXCOORD1.zw).xyz;
    u_xlat16_1 = u_xlat16_0.z + -1.0;
    u_xlat16_11.xy = max(u_xlat16_0.xy, _MinMSA.xy);
    ...
    u_xlat16_2 = texture(unity_SpecCube0, u_xlat2.xyz, u_xlat16_4.x);
    ...
    u_xlat16_7.xyz = u_xlat16_12.xyz * _SphereMapScale.xyz + u_xlat16_7.xyz;
    u_xlat16_8.xyz = u_xlat16_7.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat16_7.y = dot(u_xlat4.xyz, u_xlat2.xyz);
    u_xlat16_7.xy = u_xlat16_7.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
    u_xlat16_2.xyz = texture(_SphereMap, u_xlat16_7.xy).xyz;
    u_xlat16_4.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_7.xyz = _Color.xyz * u_xlat16_4.xyz + _AddColor.xyz;
    u_xlat16_7.xyz = u_xlat16_2.xyz * _SphereMapScale.xyz + u_xlat16_7.xyz;
    u_xlat16_8.xyz = u_xlat16_7.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat16_10.xy = max(u_xlat16_4.xy, _MinMSA.xy);
    ...
    u_xlat16_6.xyz = u_xlat16_0.xyz * _SphereMapScale.xyz + u_xlat16_6.xyz;
    ...
    u_xlat24 = inversesqrt(u_xlat24);
    u_xlat0.xyz = vec3(u_xlat24) * u_xlat0.xyz;
    u_xlat16_0 = texture(unity_SpecCube0, u_xlat0.xyz, u_xlat16_5.x);
...
void main()
{
    ...
    u_xlat16_0.xyz = texture(_SphereMap, u_xlat16_19.xy).xyz;
...
void main()
{
    ...
    u_xlat16_4 = texture(unity_SpecCube0, u_xlat4.xyz, u_xlat16_31);
...
void main()
{
    ...
    u_xlat16_28 = dot(u_xlat16_6, unity_OcclusionMaskSelector);
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat16_12.xy = texture(_MSA, vs_TEXCOORD1.zw).xy;
    ...
    u_xlat16_10.xyz = _Color.xyz * u_xlat16_2.xyz + _AddColor.xyz;
...
void main()
{
    ...
    u_xlat16_2.xy = texture(_MSA, vs_TEXCOORD1.zw).xy;
    u_xlat16_1.xy = max(u_xlat16_2.xy, _MinMSA.xy);
    u_xlat16_2.x = (-u_xlat16_1.y) + 1.0;
    u_xlat16_7.x = u_xlat16_2.x * u_xlat16_2.x + 1.5;
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_2.x;
    u_xlat15 = u_xlat15 * u_xlat16_7.x;
    u_xlat16_7.xyz = texture(_BumpMap, vs_TEXCOORD1.xy).xyz;
    u_xlat16_6.xyz = u_xlat16_7.xyz * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
...
#endif
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat16_10 = u_xlat16_2.x * u_xlat16_2.x + -1.0;
