...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat10_1.xyz * vec3(2.0, 2.0, 2.0) + _Color.xyz;
...
void main()
{
    ...
    u_xlat16_6.xyz = u_xlat10_10.xyz * vec3(2.0, 2.0, 2.0) + _Color.xyz;
...
void main()
{
    ...
    u_xlat16_11.xyz = u_xlat10_1.xyz * vec3(2.0, 2.0, 2.0) + _Color.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat10_0.xyz * vec3(2.0, 2.0, 2.0) + _Color.xyz;
...
void main()
{
    ...
    u_xlat10_1.xyz = texture2D(_SphereMap, u_xlat16_10.xy).xyz;
    u_xlat16_10.xyz = u_xlat10_1.xyz * vec3(2.0, 2.0, 2.0) + _Color.xyz;
    ...
    u_xlat1.x = dot(u_xlat1.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat10_3 = textureCube(_HeuristicReflection, u_xlat16_7.xyz);
    ...
    u_xlat16_7.xyz = u_xlat10_3.xyz * vec3(u_xlat16_24);
    u_xlat16_7.xyz = u_xlat16_7.xyz * vec3(_Occlusion);
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat16_7.xyz;
    ...
    u_xlat16_24 = dot(u_xlat10_3, unity_OcclusionMaskSelector);
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat10_2.xyz * vec3(2.0, 2.0, 2.0) + _Color.xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat10_0.xyz * vec3(2.0, 2.0, 2.0) + _Color.xyz;
...
void main()
{
    ...
    u_xlat10_1.xyz = texture2D(_SphereMap, u_xlat16_16.xy).xyz;
    u_xlat16_3.xyz = u_xlat10_1.xyz * vec3(2.0, 2.0, 2.0) + _Color.xyz;
    ...
    u_xlat16_6.xyz = u_xlat10_1.xyz * vec3(u_xlat16_8);
    u_xlat16_6.xyz = u_xlat16_6.xyz * vec3(_Occlusion);
...
void main()
{
    ...
    u_xlat16_12.xyz = u_xlat10_1.xyz * vec3(2.0, 2.0, 2.0) + _Color.xyz;
...
void main()
{
    ...
    u_xlat16_8.xyz = u_xlat10_2.xyz * vec3(2.0, 2.0, 2.0) + _Color.xyz;
...
void main()
{
    ...
    u_xlat10_1.xyz = texture2D(_SphereMap, u_xlat16_14.xy).xyz;
    u_xlat16_3.xyz = u_xlat10_1.xyz * vec3(2.0, 2.0, 2.0) + _Color.xyz;
    u_xlat16_4.xyz = u_xlat16_3.xyz + vec3(-1.22091627, -1.22091627, -1.22091627);
    u_xlat16_3.xyz = u_xlat16_3.xyz + vec3(-1.0, -1.0, -1.0);
    u_xlat16_0.xzw = u_xlat16_0.xxx * u_xlat16_3.xyz;
    ...
    u_xlat16_4.xyz = u_xlat16_6.xyz * u_xlat16_0.xzw + u_xlat16_4.xyz;
    u_xlat5.z = (-_Smoothness) + 1.0;
    u_xlat8 = texture2D(unity_NHxRoughness, u_xlat5.xz).x;
    ...
    u_xlat16_21 = dot(u_xlat10_2, unity_OcclusionMaskSelector);
    u_xlat16_21 = clamp(u_xlat16_21, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_6.xyz = u_xlat10_1.xyz * vec3(2.0, 2.0, 2.0) + _Color.xyz;
    u_xlat16_7.xyz = u_xlat16_6.xyz + vec3(-1.22091627, -1.22091627, -1.22091627);
    u_xlat16_6.xyz = u_xlat16_6.xyz + vec3(-1.0, -1.0, -1.0);
    u_xlat16_7.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_33 = (-_Metallic) * 0.779083729 + 0.779083729;
...
void main()
{
    ...
    u_xlat16_3.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity) + u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat10_1.xyz * vec3(2.0, 2.0, 2.0) + _Color.xyz;
    u_xlat16_6.xyz = u_xlat16_4.xyz + vec3(-1.0, -1.0, -1.0);
    u_xlat16_4.xyz = u_xlat16_4.xyz + vec3(-1.22091627, -1.22091627, -1.22091627);
    u_xlat16_4.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_4.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_24 = (-_Metallic) * 0.779083729 + 0.779083729;
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat10_0.xyz * vec3(2.0, 2.0, 2.0) + _Color.xyz;
    u_xlat16_6.xyz = u_xlat16_4.xyz + vec3(-1.0, -1.0, -1.0);
    u_xlat16_4.xyz = u_xlat16_4.xyz + vec3(-1.22091627, -1.22091627, -1.22091627);
    u_xlat16_4.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_4.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_25 = (-_Metallic) * 0.779083729 + 0.779083729;
...
void main()
{
    ...
    u_xlat40 = dot(u_xlat4.xyz, _NormalRand.xyz);
    u_xlat40 = sin(u_xlat40);
    u_xlat40 = u_xlat40 * _NormalRand.w;
    u_xlat40 = fract(u_xlat40);
    u_xlat41 = dot(u_xlat5.xyz, u_xlat5.xyz);
    u_xlat41 = inversesqrt(u_xlat41);
    u_xlat4.xyz = vec3(u_xlat41) * u_xlat5.xyz;
    u_xlat16_39 = dot((-u_xlat4.xyz), u_xlat1.xyz);
    u_xlat16_39 = u_xlat16_39 + u_xlat16_39;
    u_xlat16_3.xyz = u_xlat1.xyz * (-vec3(u_xlat16_39)) + (-u_xlat4.xyz);
    u_xlat41 = dot(u_xlat16_3.zxy, (-u_xlat16_3.xyz));
    u_xlatb41 = u_xlat41<9.99999975e-06;
    u_xlat41 = (u_xlatb41) ? u_xlat16_3.z : (-u_xlat16_3.z);
    u_xlat5.z = u_xlat41 * u_xlat16_3.x;
    ...
    u_xlat16_39 = clamp(u_xlat16_39, 0.0, 1.0);
    u_xlat16_10.xyz = (-u_xlat16_9.xyz) + vec3(u_xlat16_39);
    u_xlat40 = dot(u_xlat4.xyz, u_xlat1.xyz);
    u_xlat2.x = u_xlat40;
    u_xlat2.x = clamp(u_xlat2.x, 0.0, 1.0);
    u_xlat40 = u_xlat40 + u_xlat40;
    u_xlat15.xyz = u_xlat1.xyz * (-vec3(u_xlat40)) + u_xlat4.xyz;
    u_xlat1.x = dot(u_xlat1.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat4.z = vs_TEXCOORD3.w;
    u_xlat5.xyz = (-u_xlat4.xyz) + _WorldSpaceCameraPos.xyz;
    u_xlat37 = dot(u_xlat4.xyz, _NormalRand.xyz);
    u_xlat37 = sin(u_xlat37);
    u_xlat37 = u_xlat37 * _NormalRand.w;
    u_xlat37 = fract(u_xlat37);
    u_xlat38 = dot(u_xlat5.xyz, u_xlat5.xyz);
    ...
    u_xlat16_36 = u_xlat16_36 + u_xlat16_36;
    u_xlat16_3.xyz = u_xlat1.xyz * (-vec3(u_xlat16_36)) + (-u_xlat4.xyz);
    u_xlat38 = dot(u_xlat16_3.zxy, (-u_xlat16_3.xyz));
    u_xlatb38 = u_xlat38<9.99999975e-06;
    u_xlat38 = (u_xlatb38) ? u_xlat16_3.z : (-u_xlat16_3.z);
    u_xlat5.z = u_xlat38 * u_xlat16_3.x;
    ...
    u_xlat2.x = clamp(u_xlat2.x, 0.0, 1.0);
    u_xlat37 = u_xlat37 + u_xlat37;
    u_xlat14.xyz = u_xlat1.xyz * (-vec3(u_xlat37)) + u_xlat4.xyz;
    u_xlat1.x = dot(u_xlat1.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat13 = dot(u_xlat14.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat13 = u_xlat13 * u_xlat13;
    u_xlat6.x = u_xlat13 * u_xlat13;
    u_xlat13 = texture2D(unity_NHxRoughness, u_xlat6.xz).x;
    u_xlat13 = u_xlat13 * 16.0;
    u_xlat16_11.xyz = vec3(u_xlat13) * u_xlat16_9.xyz + u_xlat16_8.xyz;
    u_xlat16_36 = (-u_xlat2.x) + 1.0;
    u_xlat16_13 = u_xlat16_36 * u_xlat16_36;
    u_xlat16_13 = u_xlat16_36 * u_xlat16_13;
    u_xlat16_13 = u_xlat16_36 * u_xlat16_13;
    u_xlat16_9.xyz = vec3(u_xlat16_13) * u_xlat16_10.xyz + u_xlat16_9.xyz;
    u_xlat16_7.xyz = u_xlat16_7.xyz * u_xlat16_9.xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat16_8.xyz + u_xlat16_7.xyz;
    u_xlat10_2 = texture2D(unity_ShadowMask, vs_TEXCOORD6.xy);
    u_xlat16_36 = dot(u_xlat10_2, unity_OcclusionMaskSelector);
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat10_6.xyz * vec3(2.0, 2.0, 2.0) + _Color.xyz;
