...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/透過/Fade_Alb_Msk" {
Properties {
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat16_11.xyz * u_xlat16_4.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_7.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
...
void main()
{
    ...
    u_xlat16_4.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_6.xyz = u_xlat16_12.xyz * u_xlat16_4.xyz;
    u_xlat16_7.xyz = u_xlat16_12.xyz * u_xlat16_4.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_7.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
...
void main()
{
    ...
    u_xlat16_2.x = texture(_TransparencyLM, vs_TEXCOORD0.zw).x;
