...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/マシンパーツ/MachineParts_Wing_NoEmblem" {
Properties {
...
void main()
{
    ...
    SV_Target0.xyz = u_xlat16_5.xyz * u_xlat16_7.xyz + u_xlat16_1.xyz;
    return;
}
...
void main()
{
    ...
    SV_Target0.xyz = u_xlat16_5.xyz * u_xlat16_8.xyz + u_xlat16_2.xyz;
    return;
}
