...
void main()
{
    ...
    u_xlat16_24 = texture(_MSA, u_xlat3.xy).y;
    u_xlat3.z = (-u_xlat16_1.x) * u_xlat16_24 + 1.0;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_2 = texture(unity_SpecCube0, u_xlat2.xyz, u_xlat16_9.x);
    ...
    u_xlat16_1.x = u_xlat16_1.x * u_xlat16_24 + u_xlat16_12.x;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_1.x = min(max(u_xlat16_1.x, 0.0), 1.0);
#else
    u_xlat16_1.x = clamp(u_xlat16_1.x, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_0 = texture(_MSA, u_xlat4.xy).y;
    u_xlat1 = (-u_xlat16_2.x) * u_xlat16_0 + 1.0;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_3 = texture(unity_SpecCube0, u_xlat3.xyz, u_xlat16_9.x);
    ...
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_0 + u_xlat16_12.x;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_2.x = min(max(u_xlat16_2.x, 0.0), 1.0);
#else
    u_xlat16_2.x = clamp(u_xlat16_2.x, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat4.xy = vs_TEXCOORD0.xy * _CameraNearColorUVScale.xy;
    u_xlat16_27 = texture(_MSA, u_xlat4.xy).y;
    u_xlat4.z = (-u_xlat16_28) * u_xlat16_27 + 1.0;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_28 = u_xlat16_28 * u_xlat16_27 + u_xlat16_6.x;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_28 = min(max(u_xlat16_28, 0.0), 1.0);
#else
    u_xlat16_28 = clamp(u_xlat16_28, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_3 = texture(unity_SpecCube0, u_xlat3.xyz, u_xlat16_10.x);
    ...
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_0 + u_xlat16_5.x;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_2.x = min(max(u_xlat16_2.x, 0.0), 1.0);
#else
    u_xlat16_2.x = clamp(u_xlat16_2.x, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat4.xy = vs_TEXCOORD0.xy * _CameraNearColorUVScale.xy;
    u_xlat16_24 = texture(_MSA, u_xlat4.xy).y;
    u_xlat4.z = (-u_xlat16_25) * u_xlat16_24 + 1.0;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_25 = u_xlat16_25 * u_xlat16_24 + u_xlat16_6.x;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_25 = min(max(u_xlat16_25, 0.0), 1.0);
#else
    u_xlat16_25 = clamp(u_xlat16_25, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_30 = texture(_MSA, u_xlat5.xy).y;
    u_xlat5.z = (-u_xlat16_27) * u_xlat16_30 + 1.0;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_1 = texture(unity_SpecCube0, u_xlat4.xyz, u_xlat16_2.x);
    ...
    u_xlat16_29 = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_6.x = (-u_xlat16_29) + 1.0;
    u_xlat16_27 = u_xlat16_27 * u_xlat16_30 + u_xlat16_6.x;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_27 = min(max(u_xlat16_27, 0.0), 1.0);
#else
    u_xlat16_27 = clamp(u_xlat16_27, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_3 = texture(unity_SpecCube0, u_xlat3.xyz, u_xlat16_13.x);
...
void main()
{
    ...
    u_xlat16_1.x = u_xlat16_1.x * _CameraNearColor.y;
    u_xlat3.xy = vs_TEXCOORD0.xy * _CameraNearColorUVScale.xy;
    u_xlat16_21 = texture(_MSA, u_xlat3.xy).y;
    u_xlat3.z = (-u_xlat16_1.x) * u_xlat16_21 + 1.0;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_2 = texture(unity_SpecCube0, u_xlat2.xyz, u_xlat16_8.x);
    ...
    u_xlat16_1.x = u_xlat16_1.x * u_xlat16_21 + u_xlat16_11.x;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_1.x = min(max(u_xlat16_1.x, 0.0), 1.0);
#else
    u_xlat16_1.x = clamp(u_xlat16_1.x, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat5.xy = vs_TEXCOORD0.xy * _CameraNearColorUVScale.xy;
    u_xlat16_27 = texture(_MSA, u_xlat5.xy).y;
    u_xlat5.z = (-u_xlat16_24) * u_xlat16_27 + 1.0;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_24 = u_xlat16_24 * u_xlat16_27 + u_xlat16_6.x;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_24 = min(max(u_xlat16_24, 0.0), 1.0);
#else
    u_xlat16_24 = clamp(u_xlat16_24, 0.0, 1.0);
...
void main()
{
    ...
    vs_TEXCOORD5 = max(u_xlat1.x, u_xlat16_2);
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * _MSA_ST.xy + _MSA_ST.zw;
    u_xlat1.x = dot(in_NORMAL0.xyz, hlslcc_mtx4x4unity_WorldToObject[0].xyz);
    u_xlat1.y = dot(in_NORMAL0.xyz, hlslcc_mtx4x4unity_WorldToObject[1].xyz);
    u_xlat1.z = dot(in_NORMAL0.xyz, hlslcc_mtx4x4unity_WorldToObject[2].xyz);
...
void main()
{
    ...
    u_xlat16_1.x = texture(_MSA, u_xlat1.xy).y;
    u_xlat1.y = (-u_xlat16_0.x) * u_xlat16_1.x + 1.0;
...
void main()
{
    ...
    u_xlat16_2.x = texture(_MSA, u_xlat2.xy).y;
    u_xlat16_2.x = (-u_xlat16_1.x) * u_xlat16_2.x + 1.0;
