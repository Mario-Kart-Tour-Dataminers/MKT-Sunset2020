...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/Alb_AO" {
Properties {
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat16_11.xyz * u_xlat16_8.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat10_4.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_7.xyz = u_xlat16_11.xyz * u_xlat10_4.xyz;
    u_xlat16_6.xyz = u_xlat16_11.xyz * u_xlat10_4.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat16_10.xyz = vec3(u_xlat16_38) * u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat16_9 = u_xlat16_1.x * u_xlat16_9;
    u_xlat16_9 = u_xlat16_1.x * u_xlat16_9;
    u_xlat16_1.x = (-_Metallic) * 0.779083729 + 0.779083729;
    ...
    u_xlat16_1.xyz = u_xlat16_10.xyz * u_xlat16_7.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_3.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_15.xyz = u_xlat16_2.xyz * u_xlat10_3.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat10_3.xyz;
    u_xlat16_7.xyz = vec3(u_xlat16_32) * u_xlat16_2.xyz;
    ...
    u_xlat16_8.xyz = vec3(u_xlat16_9) * u_xlat16_8.xyz + u_xlat16_15.xyz;
    u_xlat16_6.xyz = u_xlat0.xxx * u_xlat16_15.xyz + u_xlat16_7.xyz;
...
void main()
{
    ...
    u_xlat10_4.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_7.xyz = u_xlat16_12.xyz * u_xlat10_4.xyz;
    u_xlat16_6.xyz = u_xlat16_12.xyz * u_xlat10_4.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_42 = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_8.xyz = vec3(u_xlat16_42) * u_xlat16_7.xyz;
    u_xlat16_42 = (-u_xlat16_42) + _Smoothness;
    ...
    u_xlat16_4.xyz = u_xlat16_4.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
    u_xlat16_4.xyz = max(u_xlat16_4.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_7.xyz = texture2D(unity_Lightmap, vs_TEXCOORD3.xy).xyz;
    u_xlat16_10.xyz = unity_Lightmap_HDR.xxx * u_xlat16_7.xyz + u_xlat16_4.xyz;
    ...
    u_xlat16_41 = u_xlat16_41 * u_xlat16_41;
    u_xlat16_6.xyz = vec3(u_xlat16_41) * u_xlat16_9.xyz + u_xlat16_6.xyz;
...
void main()
{
    ...
    u_xlat16_13 = (-u_xlat16_5.x) + _Smoothness;
