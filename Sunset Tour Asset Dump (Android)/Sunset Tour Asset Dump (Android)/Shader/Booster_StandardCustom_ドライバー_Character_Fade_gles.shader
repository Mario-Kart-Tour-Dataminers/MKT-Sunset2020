...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/ドライバー/Character_Fade" {
Properties {
...
void main()
{
    ...
    u_xlat10_13.xyz = texture2D(_BumpMap, vs_TEXCOORD1.xy).xyz;
...
void main()
{
    ...
    u_xlat10_1.x = texture2D(_TransparencyLM, vs_TEXCOORD0.zw).x;
    u_xlat0.w = (-u_xlat10_1.x) + 1.0;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat30 = clamp(u_xlat30, 0.0, 1.0);
    u_xlat0.xyz = vec3(u_xlat30) * u_xlat0.xyz + unity_FogColor.xyz;
    u_xlat10_2.x = texture2D(_TransparencyLM, vs_TEXCOORD0.zw).x;
    u_xlat0.w = (-u_xlat10_2.x) + 1.0;
    SV_Target0 = u_xlat0;
    return;
}
