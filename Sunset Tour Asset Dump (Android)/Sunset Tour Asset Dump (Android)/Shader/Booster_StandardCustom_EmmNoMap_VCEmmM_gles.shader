...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/EmmNoMap_VCEmmM" {
Properties {
...
void main()
{
    ...
    u_xlat16_0.xyz = vs_COLOR0.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    SV_Target0.xyz = u_xlat16_0.xyz * vec3(_EmissionIntensity) + u_xlat16_4.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_1.xyz = vs_COLOR0.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
...
void main()
{
    ...
    u_xlat16_3.xyz = vs_COLOR0.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    SV_Target0.xyz = u_xlat16_3.xyz * vec3(_EmissionIntensity) + u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat16_6.xyz * u_xlat16_5.xyz + u_xlat16_4.xyz;
    u_xlat16_0.xyz = vs_COLOR0.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_4.xyz = u_xlat16_0.xyz * vec3(_EmissionIntensity) + u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat0.xyz = u_xlat0.xyw * vec3(u_xlat16) + u_xlat16_5.xyz;
    u_xlat16_1.xyz = vs_COLOR0.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_5.xyz = u_xlat16_1.xyz * vec3(_EmissionIntensity) + u_xlat0.xyz;
...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat16_8.xyz * u_xlat16_6.xyz + u_xlat16_0.xyz;
    u_xlat16_3.xyz = vs_COLOR0.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_0.xyz = u_xlat16_3.xyz * vec3(_EmissionIntensity) + u_xlat16_0.xyz;
...
void main()
{
    ...
    u_xlat16_9 = dot(vs_TEXCOORD0.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat16_9 = max(u_xlat16_9, 0.0);
    SV_Target0.xyz = u_xlat16_0.xyz * vec3(u_xlat16_9) + u_xlat16_2.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_1.xyz = vs_COLOR0.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    SV_Target0.xyz = u_xlat16_1.xyz * vec3(_EmissionIntensity) + u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat16_2.xyz * u_xlat16_0.xxx + u_xlat16_3.xyz;
    u_xlat16_1.xyz = vs_COLOR0.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_0.xyz = u_xlat16_1.xyz * vec3(_EmissionIntensity) + u_xlat16_0.xyz;
    u_xlat16_1.xyz = u_xlat16_0.xyz + (-unity_FogColor.xyz);
    u_xlat10 = vs_TEXCOORD1.w;
    u_xlat10 = clamp(u_xlat10, 0.0, 1.0);
    u_xlat1.xyz = vec3(u_xlat10) * u_xlat16_1.xyz + unity_FogColor.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = vs_COLOR0.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    ...
    SV_Target0.xyz = u_xlat16_3.xyz * u_xlat0.xyz + u_xlat16_1.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_0.xyz = vs_COLOR0.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_2.xyz = u_xlat16_0.xyz * vec3(_EmissionIntensity);
    u_xlat16_3.xyz = (-booster_PowerSavingAdjustColor.xyz) + vec3(1.0, 1.0, 1.0);
    u_xlat16_3.xyz = u_xlat16_3.xyz * _Color.xyz;
...
void main()
{
    ...
    u_xlat1.w = 1.0;
    SV_Target2 = u_xlat1;
    u_xlat16_18 = vs_TEXCOORD0.y * vs_TEXCOORD0.y;
    u_xlat16_18 = vs_TEXCOORD0.x * vs_TEXCOORD0.x + (-u_xlat16_18);
    u_xlat16_1 = vs_TEXCOORD0.yzzx * vs_TEXCOORD0.xyzz;
    u_xlat16_2.x = dot(unity_SHBr, u_xlat16_1);
    u_xlat16_2.y = dot(unity_SHBg, u_xlat16_1);
    u_xlat16_2.z = dot(unity_SHBb, u_xlat16_1);
    ...
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat16_2.xyz;
    u_xlat16_4.xyz = vs_COLOR0.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_0.xyz = u_xlat16_4.xyz * vec3(_EmissionIntensity) + u_xlat16_0.xyz;
    SV_Target3.xyz = exp2((-u_xlat16_0.xyz));
    SV_Target3.w = 1.0;
    return;
}
