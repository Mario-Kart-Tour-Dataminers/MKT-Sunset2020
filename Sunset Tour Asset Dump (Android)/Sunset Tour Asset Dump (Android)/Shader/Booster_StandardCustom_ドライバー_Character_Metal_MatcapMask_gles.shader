...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/ドライバー/Character_Metal_MatcapMask" {
Properties {
...
void main()
{
    ...
    u_xlat16_24.x = u_xlat10_5.z + -1.0;
    u_xlat16_24.x = _Occlusion * u_xlat16_24.x + 1.0;
    u_xlat16_24.x = max(u_xlat16_24.x, _MinMSA.z);
    ...
    u_xlat10_1.xyz = texture2D(_SphereMap, u_xlat16_24.xy).xyz;
    u_xlat16_7.xyz = u_xlat10_1.xyz * _SphereMapScale.xyz;
    u_xlat10_1.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_8.xyz = _Color.xyz * u_xlat10_1.xyz + _AddColor.xyz;
    u_xlat10_1.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    u_xlat16_7.xyz = u_xlat16_7.xyz * u_xlat10_1.xyz + u_xlat16_8.xyz;
...
void main()
{
    ...
    u_xlat16_8.xyz = _Color.xyz * u_xlat10_12.xyz + _AddColor.xyz;
    u_xlat10_12.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
...
void main()
{
    ...
    u_xlat16_7.xyz = _Color.xyz * u_xlat10_0.xyz + _AddColor.xyz;
    u_xlat10_0.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
...
void main()
{
    ...
    u_xlat10_4 = textureCube(unity_SpecCube0, u_xlat4.xyz, u_xlat16_32);
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat10_0.xyz * _SphereMapScale.xyz;
    u_xlat10_0.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    u_xlat16_2.xyz = u_xlat16_4.xyz * u_xlat10_0.xyz + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat16_32 = (u_xlatb31) ? 0.0 : u_xlat33;
    u_xlat10_4 = textureCube(unity_SpecCube0, u_xlat4.xyz, u_xlat16_32);
    u_xlat16_32 = u_xlat10_4.w + -1.0;
    u_xlat16_32 = unity_SpecCube0_HDR.w * u_xlat16_32 + 1.0;
    u_xlat16_32 = u_xlat16_32 * unity_SpecCube0_HDR.x;
    ...
    u_xlat16_9.xyz = u_xlat1.xxx * u_xlat16_8.xyz + u_xlat16_7.xyz;
    u_xlat16_36 = (-u_xlat11) + 1.0;
    u_xlat16_1 = u_xlat16_36 * u_xlat16_36;
    u_xlat16_1 = u_xlat16_36 * u_xlat16_1;
    u_xlat16_1 = u_xlat16_36 * u_xlat16_1;
    u_xlat16_2.xyw = vec3(u_xlat16_1) * u_xlat16_2.xyw + u_xlat16_8.xyz;
    u_xlat16_2.xyw = u_xlat16_2.xyw * u_xlat16_6.xyz;
    ...
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
    u_xlat16_0.xyz = max(u_xlat16_0.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_8.xyz = vec3(u_xlat16_22) * u_xlat16_0.xyz;
    u_xlat16_2.xyz = u_xlat16_8.xyz * u_xlat16_7.xyz + u_xlat16_2.xyw;
...
void main()
{
    ...
    u_xlat16_6.xyz = u_xlat10_1.xyz * _SphereMapScale.xyz;
    u_xlat10_1.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_7.xyz = _Color.xyz * u_xlat10_1.xyz + _AddColor.xyz;
    u_xlat10_1.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    u_xlat16_6.xyz = u_xlat16_6.xyz * u_xlat10_1.xyz + u_xlat16_7.xyz;
    u_xlat16_26 = (-u_xlat16_10.x) * 0.779083729 + 0.779083729;
    u_xlat16_7.xyz = vec3(u_xlat16_26) * u_xlat16_6.xyz;
    u_xlat16_6.xyz = u_xlat16_6.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = u_xlat16_10.xxx * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_10.x = (-u_xlat16_26) + u_xlat16_10.y;
    u_xlat24 = (-u_xlat16_10.y) + 1.0;
    u_xlat16_10.x = u_xlat16_10.x + 1.0;
    u_xlat16_10.x = clamp(u_xlat16_10.x, 0.0, 1.0);
    u_xlat16_10.xyz = (-u_xlat16_6.xyz) + u_xlat16_10.xxx;
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat16_7.xyz;
    ...
    u_xlat4.xyz = u_xlat3.xyz * u_xlat9.xxx + _WorldSpaceLightPos0.xyz;
    ...
    u_xlat16_13 = dot((-u_xlat9.xyz), u_xlat0.xyz);
    u_xlat16_13 = u_xlat16_13 + u_xlat16_13;
    u_xlat16_7.xyz = u_xlat0.xyz * (-vec3(u_xlat16_13)) + (-u_xlat9.xyz);
    ...
    u_xlat16_5.xyz = u_xlat16_2.xxx * u_xlat16_5.xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * vec3(u_xlat16_29);
    u_xlat0.xyz = u_xlat16_5.xyz * u_xlat16_10.xyz + u_xlat3.xyz;
    u_xlat0.xyz = u_xlat0.xyz + (-unity_FogColor.xyz);
...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
    u_xlat16_0.xyz = max(u_xlat16_0.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_6.xyz = vec3(u_xlat16_22) * u_xlat16_0.xyz;
    u_xlat16_2.xyz = u_xlat16_6.xyz * u_xlat16_7.xyz + u_xlat16_2.xyw;
    u_xlat10_0 = texture2D(unity_ShadowMask, vs_TEXCOORD7.xy);
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat10_0.xyz * _SphereMapScale.xyz;
    u_xlat10_0.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_5.xyz = _Color.xyz * u_xlat10_0.xyz + _AddColor.xyz;
    u_xlat10_0.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat10_0.xyz + u_xlat16_5.xyz;
    u_xlat16_5.xyz = u_xlat16_3.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat10_0.xyz = texture2D(_MSA, vs_TEXCOORD1.xy).xyz;
    u_xlat16_6.xy = max(u_xlat10_0.xy, _MinMSA.xy);
    u_xlat16_27 = u_xlat10_0.z + -1.0;
    ...
    u_xlat9.x = inversesqrt(u_xlat9.x);
    u_xlat4.xyz = u_xlat2.xyz * u_xlat9.xxx + _WorldSpaceLightPos0.xyz;
    ...
    u_xlat10 = u_xlat10 * u_xlat26 + 1.00001001;
    u_xlat26 = u_xlat0.x * u_xlat0.x + 1.5;
    ...
    u_xlat2.xyz = u_xlat2.xxx * u_xlat16_5.xyz + u_xlat16_3.xyz;
    ...
    u_xlat26 = dot(u_xlat8.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat26 = clamp(u_xlat26, 0.0, 1.0);
    u_xlat2.xyz = u_xlat2.xyz * vec3(u_xlat26) + u_xlat16_3.xyz;
    u_xlatb26 = u_xlat0.x<0.00499999989;
    u_xlat0.x = u_xlat0.x * 8.29800034;
    u_xlat16_3.x = (u_xlatb26) ? 0.0 : u_xlat0.x;
    u_xlat16_11 = dot((-u_xlat9.xyz), u_xlat8.xyz);
    u_xlat16_11 = u_xlat16_11 + u_xlat16_11;
    u_xlat16_7.xyz = u_xlat8.xyz * (-vec3(u_xlat16_11)) + (-u_xlat9.xyz);
    u_xlat0.x = dot(u_xlat8.xyz, u_xlat9.xyz);
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat16_11 = (-u_xlat0.x) + 1.0;
    u_xlat16_11 = u_xlat16_11 * u_xlat16_11;
    u_xlat16_11 = u_xlat16_11 * u_xlat16_11;
    u_xlat16_5.xyz = vec3(u_xlat16_11) * u_xlat16_6.xyz + u_xlat16_5.xyz;
    u_xlat0.x = dot(u_xlat16_7.zxy, (-u_xlat16_7.xyz));
    u_xlatb0 = u_xlat0.x<9.99999975e-06;
    u_xlat0.x = (u_xlatb0) ? u_xlat16_7.z : (-u_xlat16_7.z);
    u_xlat4.z = u_xlat0.x * u_xlat16_7.x;
    ...
    u_xlat24 = inversesqrt(u_xlat24);
    u_xlat0.xyz = vec3(u_xlat24) * u_xlat0.xyz;
    u_xlat10_0 = textureCube(unity_SpecCube0, u_xlat0.xyz, u_xlat16_3.x);
    ...
    u_xlat16_3.xyz = u_xlat16_3.xyz * vec3(u_xlat16_29);
    u_xlat0.xyz = u_xlat16_3.xyz * u_xlat16_5.xyz + u_xlat2.xyz;
    u_xlat0.xyz = u_xlat0.xyz + (-unity_FogColor.xyz);
    u_xlat24 = vs_TEXCOORD4.y;
    u_xlat24 = clamp(u_xlat24, 0.0, 1.0);
    u_xlat0.xyz = vec3(u_xlat24) * u_xlat0.xyz + unity_FogColor.xyz;
...
void main()
{
    ...
    u_xlat16_1.x = u_xlat16_39 * u_xlat16_1.x;
    u_xlat16_2.xyw = u_xlat16_1.xxx * u_xlat16_2.xyw + u_xlat16_8.xyz;
    u_xlat16_2.xyw = u_xlat16_2.xyw * u_xlat16_6.xyz;
...
void main()
{
    ...
    u_xlat10_1.xyz = texture2D(_SphereMap, u_xlat16_22.xy).xyz;
    u_xlat16_7.xyz = u_xlat10_1.xyz * _SphereMapScale.xyz;
    u_xlat10_1.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_8.xyz = _Color.xyz * u_xlat10_1.xyz + _AddColor.xyz;
    u_xlat10_1.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    ...
    u_xlat32 = clamp(u_xlat32, 0.0, 1.0);
    u_xlat5.xyz = u_xlat5.xyz * vec3(u_xlat32) + u_xlat16_2.xyz;
    u_xlatb32 = u_xlat27<0.00499999989;
    u_xlat27 = u_xlat27 * 8.29800034;
    u_xlat16_2.x = (u_xlatb32) ? 0.0 : u_xlat27;
    u_xlat16_11 = dot((-u_xlat10.xyz), u_xlat0.xyz);
    u_xlat16_11 = u_xlat16_11 + u_xlat16_11;
    u_xlat16_8.xyz = u_xlat0.xyz * (-vec3(u_xlat16_11)) + (-u_xlat10.xyz);
    u_xlat0.x = dot(u_xlat0.xyz, u_xlat10.xyz);
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat16_11 = (-u_xlat0.x) + 1.0;
    u_xlat16_11 = u_xlat16_11 * u_xlat16_11;
    u_xlat16_11 = u_xlat16_11 * u_xlat16_11;
    u_xlat16_4.xyz = vec3(u_xlat16_11) * u_xlat16_4.xyz + u_xlat16_7.xyz;
...
void main()
{
    ...
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat30 = u_xlat30 + u_xlat30;
    u_xlat11.xyz = u_xlat0.xyz * (-vec3(u_xlat30)) + u_xlat3.xyz;
    u_xlat0.x = dot(u_xlat0.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    ...
    u_xlat16_10.x = u_xlat16_36 * u_xlat16_10.x;
    u_xlat16_2.xyw = u_xlat16_10.xxx * u_xlat16_2.xyw + u_xlat16_8.xyz;
    u_xlat16_2.xyw = u_xlat16_2.xyw * u_xlat16_6.xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat10_0.xyz * _SphereMapScale.xyz;
    u_xlat10_0.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_6.xyz = _Color.xyz * u_xlat10_0.xyz + _AddColor.xyz;
    u_xlat10_0.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat16_3.xyz * u_xlat10_0.xyz + u_xlat16_1.xyz;
    u_xlat16_3.xyz = u_xlat16_1.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat10_0.xy = texture2D(_MSA, vs_TEXCOORD1.xy).xy;
    u_xlat16_4.xy = max(u_xlat10_0.xy, _MinMSA.xy);
    u_xlat16_3.xyz = u_xlat16_4.xxx * u_xlat16_3.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat0.x = dot(u_xlat2.xyz, u_xlat2.xyz);
    u_xlat0.x = inversesqrt(u_xlat0.x);
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat10_1.xyz * _SphereMapScale.xyz;
    u_xlat10_1.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_4.xyz = _Color.xyz * u_xlat10_1.xyz + _AddColor.xyz;
    u_xlat10_1.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    u_xlat16_7.xyz = u_xlat16_7.xyz * u_xlat10_1.xyz + u_xlat16_4.xyz;
