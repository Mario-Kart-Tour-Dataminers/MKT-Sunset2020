...
void main()
{
    ...
    u_xlat16_6 = _Color * u_xlat16_6 + _AddColor;
...
void main()
{
    ...
    SV_Target0.xyz = u_xlat16_1.xyz * u_xlat16_4.xyz + u_xlat0.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat16_3 = texture(unity_SpecCube0, u_xlat3.xyz, u_xlat16_35);
...
void main()
{
    ...
    SV_Target0.xyz = u_xlat16_1.xyz * u_xlat16_5.xyz + u_xlat0.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_7.xyz;
    u_xlat16_3 = texture(unity_ShadowMask, vs_TEXCOORD8.xy);
    u_xlat16_34 = dot(u_xlat16_3, unity_OcclusionMaskSelector);
#ifdef UNITY_ADRENO_ES3
    u_xlat16_34 = min(max(u_xlat16_34, 0.0), 1.0);
#else
    u_xlat16_34 = clamp(u_xlat16_34, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_1.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat16_4.xyz = texture(_EmissionMap, vs_TEXCOORD2.xy).xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_4.xyz + u_xlat0.xyz;
    u_xlat16_0.xyz = u_xlat16_1.xyz + (-unity_FogColor.xyz);
    u_xlat27 = vs_TEXCOORD7;
#ifdef UNITY_ADRENO_ES3
    u_xlat27 = min(max(u_xlat27, 0.0), 1.0);
...
void main()
{
    ...
    u_xlat16_5.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat16_1.xyz = texture(_EmissionMap, vs_TEXCOORD2.xy).xyz;
    u_xlat16_2.xyz = u_xlat16_5.xyz * u_xlat16_1.xyz + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat16_5.xyz = texture(_EmissionMap, vs_TEXCOORD2.xy).xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_5.xyz + u_xlat0.xyz;
    u_xlat16_0.xyz = u_xlat16_1.xyz + (-unity_FogColor.xyz);
    u_xlat30 = vs_TEXCOORD7;
#ifdef UNITY_ADRENO_ES3
    u_xlat30 = min(max(u_xlat30, 0.0), 1.0);
