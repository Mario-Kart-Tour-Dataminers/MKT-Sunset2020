...
void main()
{
    ...
    u_xlat16_7.xyz = _Color.xyz * u_xlat16_1.xyz + u_xlat16_7.xyz;
...
void main()
{
    ...
    u_xlat16_6.xyz = _Color.xyz * u_xlat16_10.xyz + u_xlat16_6.xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_3.xyz = _Color.xyz * u_xlat16_1.xyz + u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat16_11.xyz = u_xlat16_1.xyz + u_xlat16_1.xyz;
    u_xlat16_1.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_11.xyz = _Color.xyz * u_xlat16_1.xyz + u_xlat16_11.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = _Color.xyz * u_xlat16_0.xyz + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat16_0.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_3.xyz = _Color.xyz * u_xlat16_0.xyz + u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat16_12.xyz = u_xlat16_1.xyz + u_xlat16_1.xyz;
    u_xlat16_1.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_12.xyz = _Color.xyz * u_xlat16_1.xyz + u_xlat16_12.xyz;
...
void main()
{
    ...
    u_xlat16_8.xyz = _Color.xyz * u_xlat16_2.xyz + u_xlat16_8.xyz;
...
void main()
{
    ...
    u_xlat16_6.xyz = u_xlat16_1.xyz * vec3(u_xlat16_23);
    u_xlat16_6.xyz = u_xlat16_6.xyz * vec3(_Occlusion);
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat16_6.xyz;
    ...
    u_xlat16_4.xyz = u_xlat16_6.xyz * u_xlat16_2.xyz + u_xlat16_4.xyz;
    u_xlat5.z = (-_Smoothness) + 1.0;
    u_xlat7 = texture(unity_NHxRoughness, u_xlat5.xz).x;
...
void main()
{
    ...
    vs_TEXCOORD5 = max(u_xlat15, u_xlat16_4);
    vs_TEXCOORD6 = vec4(0.0, 0.0, 0.0, 0.0);
    return;
}
...
void main()
{
    ...
    vs_TEXCOORD4.xyz = unity_SHC.xyz * vec3(u_xlat16_4) + u_xlat16_5.xyz;
    u_xlat16_4 = (-unity_FogColor.w) + 1.0;
    vs_TEXCOORD5 = max(u_xlat18, u_xlat16_4);
    vs_TEXCOORD6 = vec4(0.0, 0.0, 0.0, 0.0);
    return;
}
...
void main()
{
    ...
    u_xlat16_4.xyz = _Color.xyz * u_xlat16_6.xyz + u_xlat16_4.xyz;
