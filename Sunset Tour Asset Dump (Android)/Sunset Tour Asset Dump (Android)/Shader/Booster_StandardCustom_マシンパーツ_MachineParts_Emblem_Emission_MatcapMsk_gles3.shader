...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/マシンパーツ/MachineParts_Emblem_Emission_MatcapMsk" {
Properties {
...
void main()
{
    ...
    vs_TEXCOORD2.xy = in_TEXCOORD1.xy * _Decal_ST.xy + _Decal_ST.zw;
    vs_TEXCOORD2.zw = in_TEXCOORD0.xy * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
...
void main()
{
    ...
    u_xlat16_8.xyz = _Color.xyz * u_xlat16_1.xyz + _AddColor.xyz;
    u_xlat16_1 = texture(_Decal, vs_TEXCOORD2.xy);
    u_xlat16_1 = u_xlat16_1 * _Color + _AddColor;
    u_xlat16_9.xyz = (-u_xlat16_8.xyz) + u_xlat16_1.xyz;
    u_xlat16_8.xyz = u_xlat16_1.www * u_xlat16_9.xyz + u_xlat16_8.xyz;
    u_xlat16_4.xyz = texture(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    u_xlat16_7.xyz = u_xlat16_7.xyz * u_xlat16_4.xyz + u_xlat16_8.xyz;
    ...
    u_xlat16_0.xyz = texture(_EmissionMap, vs_TEXCOORD2.zw).xyz;
...
void main()
{
    ...
    u_xlat16_8.xyz = _Color.xyz * u_xlat16_11.xyz + _AddColor.xyz;
    u_xlat16_2 = texture(_Decal, vs_TEXCOORD2.xy);
    u_xlat16_2 = u_xlat16_2 * _Color + _AddColor;
    u_xlat16_9.xyz = (-u_xlat16_8.xyz) + u_xlat16_2.xyz;
    u_xlat16_8.xyz = u_xlat16_2.www * u_xlat16_9.xyz + u_xlat16_8.xyz;
    ...
    u_xlat16_1.xyz = texture(_EmissionMap, vs_TEXCOORD2.zw).xyz;
...
void main()
{
    ...
    u_xlat16_0 = texture(_Decal, vs_TEXCOORD2.xy);
    ...
    u_xlat16_2.xyz = u_xlat16_3.xyz * _SphereMapScale.xyz;
    u_xlat16_3.xyz = texture(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    ...
    u_xlat16_4.xyz = texture(_EmissionMap, vs_TEXCOORD2.zw).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    SV_Target0.xyz = u_xlat16_4.xyz * vec3(_EmissionIntensity) + u_xlat3.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat4.x = min(u_xlat4.x, 100.0);
    u_xlat4.xyw = u_xlat4.xxx * u_xlat16_1.xyz + u_xlat16_5.xyz;
    u_xlat16_5 = texture(unity_ShadowMask, vs_TEXCOORD8.xy);
...
void main()
{
    ...
    u_xlat16_6.xyz = unity_Lightmap_HDR.xxx * u_xlat16_5.xyz + u_xlat16_4.xyz;
    u_xlat16_6.xyz = u_xlat16_3.zzz * u_xlat16_6.xyz;
    u_xlat16_3.xyz = u_xlat16_6.xyz * u_xlat16_7.xyz + u_xlat16_3.xyw;
    u_xlat16_3.xyz = u_xlat16_9.xyz * u_xlat16_8.xyz + u_xlat16_3.xyz;
    u_xlat16_4.xyz = texture(_EmissionMap, vs_TEXCOORD2.zw).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    SV_Target0.xyz = u_xlat16_4.xyz * vec3(_EmissionIntensity) + u_xlat16_3.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_0.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_7.xyz = _Color.xyz * u_xlat16_0.xyz + _AddColor.xyz;
    u_xlat16_0 = texture(_Decal, vs_TEXCOORD2.xy);
    u_xlat16_0 = u_xlat16_0 * _Color + _AddColor;
    u_xlat16_8.xyz = (-u_xlat16_7.xyz) + u_xlat16_0.xyz;
    u_xlat16_7.xyz = u_xlat16_0.www * u_xlat16_8.xyz + u_xlat16_7.xyz;
    u_xlat16_5.xyz = texture(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    ...
    u_xlat9.xyz = u_xlat6.xyz * u_xlat16.xxx + _WorldSpaceLightPos0.xyz;
    ...
    u_xlat16.x = dot(u_xlat16_2.zxy, (-u_xlat16_2.xyz));
#ifdef UNITY_ADRENO_ES3
    u_xlatb16 = !!(u_xlat16.x<9.99999975e-06);
#else
    u_xlatb16 = u_xlat16.x<9.99999975e-06;
#endif
    u_xlat16.x = (u_xlatb16) ? u_xlat16_2.z : (-u_xlat16_2.z);
    u_xlat9.z = u_xlat16_2.x * u_xlat16.x;
    u_xlat10.x = u_xlat16_2.z * u_xlat16.x;
    u_xlat9.xy = (-u_xlat16_2.xy) * u_xlat16_2.yz;
    u_xlat10.yz = (-u_xlat16_2.xy) * u_xlat16_2.xy;
    u_xlat16.xyz = u_xlat9.xyz + (-u_xlat10.xyz);
    u_xlat9.x = dot(u_xlat16.xyz, u_xlat16.xyz);
    u_xlat9.x = inversesqrt(u_xlat9.x);
    u_xlat16.xyz = u_xlat16.xyz * u_xlat9.xxx;
    u_xlat16.xyz = u_xlat16.xyz * vec3(_NormalDiff);
    u_xlat5.xyz = u_xlat16.xyz * u_xlat5.xxx + u_xlat16_2.xyz;
    u_xlat38 = dot(u_xlat5.xyz, u_xlat5.xyz);
    u_xlat38 = inversesqrt(u_xlat38);
    u_xlat5.xyz = vec3(u_xlat38) * u_xlat5.xyz;
#ifdef UNITY_ADRENO_ES3
    u_xlatb38 = !!(u_xlat28<0.00499999989);
#else
    u_xlatb38 = u_xlat28<0.00499999989;
#endif
    u_xlat28 = u_xlat28 * 8.29800034;
    u_xlat16_2.x = (u_xlatb38) ? 0.0 : u_xlat28;
    u_xlat16_0 = texture(unity_SpecCube0, u_xlat5.xyz, u_xlat16_2.x);
    u_xlat16_2.x = u_xlat16_0.w + -1.0;
    u_xlat16_2.x = unity_SpecCube0_HDR.w * u_xlat16_2.x + 1.0;
    u_xlat16_2.x = u_xlat16_2.x * unity_SpecCube0_HDR.x;
    ...
    u_xlat5.xyz = u_xlat16_2.xyz * u_xlat16_3.xyw + u_xlat6.xyw;
    u_xlat16_6.xyz = texture(_EmissionMap, vs_TEXCOORD2.zw).xyz;
    u_xlat16_6.xyz = u_xlat16_6.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    SV_Target0.xyz = u_xlat16_6.xyz * vec3(_EmissionIntensity) + u_xlat5.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat16_4.xyz * _SphereMapScale.xyz;
    u_xlat16_4.xyz = texture(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    ...
    u_xlat16_5.xyz = texture(_EmissionMap, vs_TEXCOORD2.zw).xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    SV_Target0.xyz = u_xlat16_5.xyz * vec3(_EmissionIntensity) + u_xlat4.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_6.xyz = max(u_xlat16_6.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_14.xyz = log2(u_xlat16_6.xyz);
    ...
    u_xlat16_5.xyz = texture(unity_Lightmap, vs_TEXCOORD6.xy).xyz;
    u_xlat16_6.xyz = unity_Lightmap_HDR.xxx * u_xlat16_5.xyz + u_xlat16_14.xyz;
    u_xlat16_6.xyz = u_xlat16_3.zzz * u_xlat16_6.xyz;
    u_xlat16_3.xyz = u_xlat16_6.xyz * u_xlat16_7.xyz + u_xlat16_3.xyw;
    u_xlat16_0 = texture(unity_ShadowMask, vs_TEXCOORD8.xy);
...
void main()
{
    ...
    vs_TEXCOORD7 = max(u_xlat15, u_xlat16_4);
    vs_TEXCOORD8 = vec4(0.0, 0.0, 0.0, 0.0);
    return;
}
...
void main()
{
    ...
    vs_TEXCOORD6.xyz = unity_SHC.xyz * vec3(u_xlat16_4) + u_xlat16_5.xyz;
    u_xlat16_4 = (-unity_FogColor.w) + 1.0;
    vs_TEXCOORD7 = max(u_xlat18, u_xlat16_4);
    vs_TEXCOORD8 = vec4(0.0, 0.0, 0.0, 0.0);
    return;
}
...
void main()
{
    ...
    u_xlat16_4.xyz = texture(_EmissionMap, vs_TEXCOORD2.zw).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_1.xyz = u_xlat16_4.xyz * vec3(_EmissionIntensity) + u_xlat3.xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = texture(_EmissionMap, vs_TEXCOORD2.zw).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_3.xyz = u_xlat16_4.xyz * vec3(_EmissionIntensity) + u_xlat16_3.xyz;
    u_xlat16_4.xyz = u_xlat16_3.xyz + (-unity_FogColor.xyz);
    u_xlat37 = vs_TEXCOORD7;
#ifdef UNITY_ADRENO_ES3
    u_xlat37 = min(max(u_xlat37, 0.0), 1.0);
#else
    u_xlat37 = clamp(u_xlat37, 0.0, 1.0);
#endif
    u_xlat4.xyz = vec3(u_xlat37) * u_xlat16_4.xyz + unity_FogColor.xyz;
...
void main()
{
    ...
    u_xlat16_6.xyz = texture(_EmissionMap, vs_TEXCOORD2.zw).xyz;
    u_xlat16_6.xyz = u_xlat16_6.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_2.xyz = u_xlat16_6.xyz * vec3(_EmissionIntensity) + u_xlat5.xyz;
    u_xlat16_5.xyz = u_xlat16_2.xyz + (-unity_FogColor.xyz);
    u_xlat38 = vs_TEXCOORD7;
#ifdef UNITY_ADRENO_ES3
    u_xlat38 = min(max(u_xlat38, 0.0), 1.0);
#else
    u_xlat38 = clamp(u_xlat38, 0.0, 1.0);
#endif
    u_xlat5.xyz = vec3(u_xlat38) * u_xlat16_5.xyz + unity_FogColor.xyz;
...
void main()
{
    ...
    u_xlat16_5.xyz = texture(_EmissionMap, vs_TEXCOORD2.zw).xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_1.xyz = u_xlat16_5.xyz * vec3(_EmissionIntensity) + u_xlat4.xyz;
...
void main()
{
    ...
    u_xlat16_7.x = u_xlat16_1.x * u_xlat16_1.x + 1.5;
    u_xlat16_1.x = u_xlat16_1.x * u_xlat16_1.x;
    u_xlat18 = u_xlat18 * u_xlat16_7.x;
    u_xlat16_7.xyz = texture(_BumpMap, vs_TEXCOORD0.zw).xyz;
    u_xlat16_8.xyz = u_xlat16_7.xyz * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    u_xlat3.x = dot(vs_TEXCOORD3.xyz, u_xlat16_8.xyz);
    u_xlat3.y = dot(vs_TEXCOORD4.xyz, u_xlat16_8.xyz);
    u_xlat3.z = dot(vs_TEXCOORD5.xyz, u_xlat16_8.xyz);
    u_xlat7.x = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat7.x = inversesqrt(u_xlat7.x);
    ...
    u_xlat16_8.xy = u_xlat16_4.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
    u_xlat16_1.xyz = texture(_SphereMap, u_xlat16_8.xy).xyz;
    u_xlat16_8.xyz = u_xlat16_1.xyz * _SphereMapScale.xyz;
    u_xlat16_1.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_4.xyz = _Color.xyz * u_xlat16_1.xyz + _AddColor.xyz;
    u_xlat16_1 = texture(_Decal, vs_TEXCOORD2.xy);
    u_xlat16_1 = u_xlat16_1 * _Color + _AddColor;
    u_xlat16_5.xyz = (-u_xlat16_4.xyz) + u_xlat16_1.xyz;
    u_xlat16_4.xyz = u_xlat16_1.www * u_xlat16_5.xyz + u_xlat16_4.xyz;
    u_xlat16_3.xyz = texture(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    u_xlat16_8.xyz = u_xlat16_8.xyz * u_xlat16_3.xyz + u_xlat16_4.xyz;
    ...
    u_xlat0.xzw = u_xlat16_8.xyz * u_xlat16_2.xxx + u_xlat0.xzw;
    u_xlat0.xzw = u_xlat0.xzw * _LightColor0.xyz;
