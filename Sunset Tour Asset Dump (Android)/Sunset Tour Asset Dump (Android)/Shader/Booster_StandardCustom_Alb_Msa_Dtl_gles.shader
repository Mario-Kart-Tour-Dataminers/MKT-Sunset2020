...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/Alb_Msa_Dtl" {
Properties {
...
void main()
{
    ...
    vs_TEXCOORD1.xy = in_TEXCOORD1.xy * _DetailAlbedo_ST.xy + _DetailAlbedo_ST.zw;
...
void main()
{
    ...
    u_xlat30 = dot(vs_TEXCOORD3.xyz, _NormalRand.xyz);
    ...
    u_xlat10_13.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD1.xy).xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat10_13.xyz;
    u_xlat16_16.xyz = u_xlat16_2.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_2.xyz = u_xlat16_2.xyz + u_xlat16_2.xyz;
    u_xlat16_16.xyz = u_xlat10_3.xxx * u_xlat16_16.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat16_9.xyz = u_xlat16_2.xyz * vec3(u_xlat16_35) + u_xlat16_9.xyz;
    u_xlat16_35 = (-u_xlat32) + 1.0;
    u_xlat16_0 = u_xlat16_35 * u_xlat16_35;
    u_xlat16_0 = u_xlat16_35 * u_xlat16_0;
    u_xlat16_0 = u_xlat16_35 * u_xlat16_0;
    u_xlat16_6.xyz = vec3(u_xlat16_0) * u_xlat16_7.xyz + u_xlat16_16.xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat16_6.xyz;
    SV_Target0.xyz = u_xlat16_9.xyz * u_xlat16_8.xyz + u_xlat16_5.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    u_xlat0.x = dot(vs_TEXCOORD3.xyz, _NormalRand.xyz);
    ...
    u_xlat16_2.x = dot((-u_xlat9.xyz), vs_TEXCOORD2.xyz);
    u_xlat16_2.x = u_xlat16_2.x + u_xlat16_2.x;
    u_xlat16_2.xyz = vs_TEXCOORD2.xyz * (-u_xlat16_2.xxx) + (-u_xlat9.xyz);
    ...
    u_xlat16_29 = (-u_xlat10_4.x) * 0.779083729 + 0.779083729;
    u_xlat16_6 = (-u_xlat16_29) + 1.0;
    u_xlat16_6 = u_xlat10_4.y + u_xlat16_6;
    u_xlat16_6 = clamp(u_xlat16_6, 0.0, 1.0);
    u_xlat16_3.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_12.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat10_12.xyz;
    u_xlat10_12.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD1.xy).xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat10_12.xyz;
    u_xlat16_14.xyz = u_xlat16_3.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_3.xyz = u_xlat16_3.xyz + u_xlat16_3.xyz;
    u_xlat16_14.xyz = u_xlat10_4.xxx * u_xlat16_14.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat0.xyw = u_xlat16_3.xyz * vec3(u_xlat16_29) + u_xlat0.xyw;
...
void main()
{
    ...
    u_xlat2.xyz = u_xlat2.xyz * vec3(_NormalDiff);
    u_xlat33 = dot(vs_TEXCOORD3.xyz, _NormalRand.xyz);
    ...
    u_xlat16_17 = u_xlat10_3.y + u_xlat16_17;
    u_xlat16_17 = clamp(u_xlat16_17, 0.0, 1.0);
    u_xlat16_2.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_14.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat10_14.xyz;
    u_xlat10_14.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD1.xy).xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat10_14.xyz;
    u_xlat16_7.xyz = u_xlat16_2.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_2.xyz = u_xlat16_2.xyz + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
    u_xlat16_0.xyz = max(u_xlat16_0.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat10_2.xyz = texture2D(_MSA, vs_TEXCOORD0.zw).xyz;
    u_xlat16_1.x = u_xlat10_2.z + -1.0;
    ...
    u_xlat10_3.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD1.xy).xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat10_3.xyz;
    u_xlat16_3.xyz = u_xlat16_0.xyz + u_xlat16_0.xyz;
    u_xlat16_4.xyz = u_xlat16_0.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_4.xyz = u_xlat10_2.xxx * u_xlat16_4.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_25 = (-u_xlat10_2.x) * 0.779083729 + 0.779083729;
    u_xlat16_5.xyz = u_xlat16_3.xyz * vec3(u_xlat16_25);
    u_xlat16_25 = (-u_xlat16_25) + 1.0;
    u_xlat16_25 = u_xlat10_2.y + u_xlat16_25;
    u_xlat16_25 = clamp(u_xlat16_25, 0.0, 1.0);
    u_xlat0.x = (-u_xlat10_2.y) + 1.0;
    ...
    u_xlat2.xyz = u_xlat2.xyz * vec3(u_xlat23) + u_xlat16_8.xyz;
    u_xlatb23 = u_xlat0.x<0.00499999989;
    u_xlat0.x = u_xlat0.x * 8.29800034;
    u_xlat16_8.x = (u_xlatb23) ? 0.0 : u_xlat0.x;
    u_xlat16_15 = dot((-u_xlat7.xyz), vs_TEXCOORD2.xyz);
    u_xlat16_15 = u_xlat16_15 + u_xlat16_15;
    u_xlat16_5.xyz = vs_TEXCOORD2.xyz * (-vec3(u_xlat16_15)) + (-u_xlat7.xyz);
    ...
    u_xlat21 = dot(vs_TEXCOORD3.xyz, _NormalRand.xyz);
...
void main()
{
    ...
    u_xlat16_16 = u_xlat10_3.y + u_xlat16_16;
    ...
    SV_Target0.xyz = u_xlat16_9.xyz * u_xlat16_6.xyz + u_xlat16_5.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_28 = u_xlat10_2.y + u_xlat16_28;
    ...
    u_xlat16_28 = u_xlat0.x * u_xlat10.x;
    ...
    u_xlat16_30 = dot(u_xlat10_5, unity_OcclusionMaskSelector);
    ...
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    u_xlat16_30 = (-u_xlat3.x) + 1.0;
    u_xlat16_30 = u_xlat16_30 * u_xlat16_30;
    u_xlat16_30 = u_xlat16_30 * u_xlat16_30;
    u_xlat16_4.xyz = vec3(u_xlat16_30) * u_xlat16_6.xyz + u_xlat16_4.xyz;
    ...
    u_xlat16_17 = dot((-u_xlat8.xyz), vs_TEXCOORD2.xyz);
    u_xlat16_17 = u_xlat16_17 + u_xlat16_17;
    u_xlat16_6.xyz = vs_TEXCOORD2.xyz * (-vec3(u_xlat16_17)) + (-u_xlat8.xyz);
    ...
    u_xlat0.xyz = u_xlat0.xyz * vec3(_NormalDiff);
    u_xlat24 = dot(vs_TEXCOORD3.xyz, _NormalRand.xyz);
    ...
    u_xlat24 = inversesqrt(u_xlat24);
    u_xlat0.xyz = vec3(u_xlat24) * u_xlat0.xyz;
    u_xlat10_0 = textureCube(unity_SpecCube0, u_xlat0.xyz, u_xlat16_9.x);
...
void main()
{
    ...
    u_xlat16_2.x = dot((-u_xlat12.xyz), vs_TEXCOORD2.xyz);
    u_xlat16_2.x = u_xlat16_2.x + u_xlat16_2.x;
    u_xlat16_2.xyz = vs_TEXCOORD2.xyz * (-u_xlat16_2.xxx) + (-u_xlat12.xyz);
    u_xlat1 = dot(u_xlat16_2.zxy, (-u_xlat16_2.xyz));
    u_xlatb1 = u_xlat1<9.99999975e-06;
    u_xlat1 = (u_xlatb1) ? u_xlat16_2.z : (-u_xlat16_2.z);
    u_xlat3.z = u_xlat1 * u_xlat16_2.x;
    ...
    u_xlat16_11.xyz = u_xlat16_11.xyz * u_xlat10_7.xyz;
    u_xlat10_7.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD1.xy).xyz;
    u_xlat16_11.xyz = u_xlat16_11.xyz * u_xlat10_7.xyz;
    u_xlat16_7.xyz = u_xlat16_11.xyz + u_xlat16_11.xyz;
    u_xlat16_6.xyz = u_xlat16_11.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat16_0.xxx * u_xlat16_8.xyz + u_xlat16_7.xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat16_7.xyz;
    u_xlat16_17 = vs_TEXCOORD2.y * vs_TEXCOORD2.y;
    u_xlat16_17 = vs_TEXCOORD2.x * vs_TEXCOORD2.x + (-u_xlat16_17);
...
void main()
{
    ...
    u_xlat10_5.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD1.xy).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat10_5.xyz;
    u_xlat16_5.xyz = u_xlat16_4.xyz + u_xlat16_4.xyz;
    u_xlat16_2.xyz = u_xlat16_4.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
    ...
    u_xlat16_26 = u_xlat16_26 + u_xlat10_3.y;
    u_xlat16_26 = clamp(u_xlat16_26, 0.0, 1.0);
    u_xlat3.x = (-u_xlat10_3.y) + 1.0;
    ...
    u_xlatb28 = u_xlat3.x<0.00499999989;
    u_xlat3.x = u_xlat3.x * 8.29800034;
    u_xlat16_0.x = (u_xlatb28) ? 0.0 : u_xlat3.x;
    u_xlat16_8 = dot((-u_xlat11.xyz), vs_TEXCOORD2.xyz);
    u_xlat16_8 = u_xlat16_8 + u_xlat16_8;
    u_xlat16_6.xyz = vs_TEXCOORD2.xyz * (-vec3(u_xlat16_8)) + (-u_xlat11.xyz);
    ...
    u_xlat3.xyz = u_xlat3.xyz * vec3(_NormalDiff);
    u_xlat27 = dot(vs_TEXCOORD3.xyz, _NormalRand.xyz);
...
void main()
{
    ...
    u_xlat16_39 = dot(u_xlat10_2, unity_OcclusionMaskSelector);
    u_xlat16_39 = clamp(u_xlat16_39, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat16_0.xxx * u_xlat16_8.xyz + u_xlat16_7.xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat16_7.xyz;
    u_xlat16_16 = vs_TEXCOORD2.y * vs_TEXCOORD2.y;
    u_xlat16_16 = vs_TEXCOORD2.x * vs_TEXCOORD2.x + (-u_xlat16_16);
    u_xlat16_1 = vs_TEXCOORD2.yzzx * vs_TEXCOORD2.xyzz;
...
void main()
{
    ...
    vs_TEXCOORD2.xyz = vec3(u_xlat3) * u_xlat1.xyz;
    u_xlat16_2 = (-unity_FogColor.w) + 1.0;
    vs_TEXCOORD3.w = max(u_xlat0.x, u_xlat16_2);
    vs_COLOR0 = in_COLOR0;
    vs_TEXCOORD6 = vec4(0.0, 0.0, 0.0, 0.0);
    return;
}
...
void main()
{
    ...
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat10_10.xy = texture2D(_MSA, vs_TEXCOORD0.zw).xy;
    ...
    u_xlat10_3.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD1.xy).xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat10_3.xyz;
    u_xlat16_4.xyz = u_xlat16_1.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat10_1.xy = texture2D(_MSA, vs_TEXCOORD0.zw).xy;
    ...
    u_xlat10_2.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD1.xy).xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat10_2.xyz;
    u_xlat16_3.xyz = u_xlat16_5.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    vs_TEXCOORD0.zw = in_TEXCOORD0.xy * _MSA_ST.xy + _MSA_ST.zw;
    u_xlat16_2 = (-unity_FogColor.w) + 1.0;
    vs_TEXCOORD6 = max(u_xlat0.x, u_xlat16_2);
    vs_TEXCOORD1.xy = in_TEXCOORD1.xy * _DetailAlbedo_ST.xy + _DetailAlbedo_ST.zw;
    u_xlat0.x = dot(in_NORMAL0.xyz, hlslcc_mtx4x4unity_WorldToObject[0].xyz);
    u_xlat0.y = dot(in_NORMAL0.xyz, hlslcc_mtx4x4unity_WorldToObject[1].xyz);
    u_xlat0.z = dot(in_NORMAL0.xyz, hlslcc_mtx4x4unity_WorldToObject[2].xyz);
