...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat0.xyz * u_xlat16_2.xyz + u_xlat16_6.xyz;
    u_xlat16_0.xyz = u_xlat16_2.xyz + (-unity_FogColor.xyz);
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat16_1.xyz + u_xlat10_2.xyz;
    u_xlat16_5.xyz = u_xlat16_1.xyz * vec3(_EmissionIntensity);
    u_xlat16_15 = roundEven(u_xlat16_30);
    u_xlat16_30 = u_xlat16_30 * 2.0 + -1.0;
    u_xlat16_3.xyz = (-u_xlat16_3.xyz) * vec3(u_xlat16_32) + vec3(u_xlat16_15);
...
void main()
{
    ...
    u_xlat16_4.x = roundEven(u_xlat16_35);
    u_xlat16_35 = u_xlat16_35 * 2.0 + -1.0;
    ...
    u_xlat16_2.xyz = u_xlat0.xyz * u_xlat16_4.xyz + u_xlat16_2.xyz;
    u_xlat16_0.xyz = u_xlat16_2.xyz + (-unity_FogColor.xyz);
    u_xlat33 = vs_TEXCOORD4.y;
    u_xlat33 = clamp(u_xlat33, 0.0, 1.0);
    u_xlat0.xyz = vec3(u_xlat33) * u_xlat16_0.xyz + unity_FogColor.xyz;
