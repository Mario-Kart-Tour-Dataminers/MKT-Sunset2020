...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/マシンパーツ/MachineParts_Wing_Emission" {
Properties {
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat16_2.www * u_xlat16_7.xyz + u_xlat16_3.xyz;
    ...
    SV_Target0.xyz = u_xlat16_5.xyz * u_xlat10_0.xyz + u_xlat16_1.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat16_5.x = (u_xlatb32) ? 0.0 : u_xlat33;
    ...
    u_xlat16_21 = u_xlat30 * u_xlat2.x;
    ...
    u_xlat10_6 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_6 = _Color * u_xlat10_6 + _AddColor;
    u_xlat16_7.xyz = u_xlat16_4.xyz + (-u_xlat16_6.xyz);
    u_xlat16_7.xyz = u_xlat16_4.www * u_xlat16_7.xyz + u_xlat16_6.xyz;
    SV_Target0.w = u_xlat16_6.w * _AlphaFactor;
    u_xlat16_8.xyz = u_xlat16_7.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_8.xyz = u_xlat16_1.xxx * u_xlat16_8.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_9.xyz = vec3(u_xlat16_11) + (-u_xlat16_8.xyz);
    u_xlat16_1.xyw = vec3(u_xlat16_31) * u_xlat16_9.xyz + u_xlat16_8.xyz;
    ...
    u_xlat10.xyz = u_xlat16_7.xyz * vec3(u_xlat16_21) + u_xlat10.xyz;
    u_xlat10.xyz = u_xlat10.xyz * _LightColor0.xyz;
    u_xlat0.xyz = u_xlat10.xyz * u_xlat0.xxx + u_xlat16_1.xyw;
    ...
    SV_Target0.xyz = u_xlat16_1.xyz * u_xlat10_2.xyz + u_xlat0.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat16_6.xyz = u_xlat16_3.www * u_xlat16_6.xyz + u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat16_6.xyz = u_xlat16_2.www * u_xlat16_6.xyz + u_xlat16_3.xyz;
    SV_Target0.w = u_xlat16_3.w * _AlphaFactor;
    u_xlat16_7.xyz = u_xlat16_6.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_7.xyz = u_xlat16_1.xxx * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_1.x = (-u_xlat16_1.x) * 0.779083729 + 0.779083729;
    ...
    SV_Target0.xyz = u_xlat16_1.xyz * u_xlat10_4.xyz + u_xlat0.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat16_35 = (u_xlatb0) ? 0.0 : u_xlat36;
    u_xlat10_3 = textureCube(unity_SpecCube0, u_xlat3.xyz, u_xlat16_35);
    ...
    u_xlat16_35 = (-u_xlat16_2.x) * 0.779083729 + 0.779083729;
    ...
    u_xlat16_7.xyz = u_xlat16_3.www * u_xlat16_7.xyz + u_xlat16_6.xyz;
    SV_Target0.w = u_xlat16_6.w * _AlphaFactor;
    u_xlat16_8.xyz = u_xlat16_7.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    ...
    u_xlat16_2.xyw = vec3(u_xlat16_13) + (-u_xlat16_8.xyz);
    ...
    SV_Target0.xyz = u_xlat16_5.xyz * u_xlat10_1.xyz + u_xlat16_2.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_2.x;
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_2.x;
    u_xlat16_2.xyw = u_xlat16_2.xxx * u_xlat16_8.xyz + u_xlat16_6.xyz;
    ...
    SV_Target0.xyz = u_xlat16_1.xyz * u_xlat10_5.xyz + u_xlat0.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat16_8.xyz = u_xlat16_2.xxx * u_xlat16_8.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_2.xyw = vec3(u_xlat16_12) + (-u_xlat16_8.xyz);
    ...
    u_xlat16_5.xyz = unity_Lightmap_HDR.xxx * u_xlat16_14.xyz + u_xlat16_1.xyz;
    u_xlat16_5.xyz = u_xlat16_2.zzz * u_xlat16_5.xyz;
    u_xlat16_2.xyz = u_xlat16_5.xyz * u_xlat16_7.xyz + u_xlat16_2.xyw;
    u_xlat10_0 = texture2D(unity_ShadowMask, vs_TEXCOORD8.xy);
...
void main()
{
    ...
    u_xlat16_6.xyz = u_xlat16_3.www * u_xlat16_6.xyz + u_xlat16_4.xyz;
    SV_Target0.w = u_xlat16_4.w * _AlphaFactor;
    u_xlat16_34 = (-u_xlat16_2.x) * 0.779083729 + 0.779083729;
    ...
    u_xlat5.x = inversesqrt(u_xlat5.x);
    u_xlat16.xyz = u_xlat10.xyz * u_xlat5.xxx + _WorldSpaceLightPos0.xyz;
    ...
    u_xlat43 = u_xlat38 * u_xlat38 + -1.0;
    u_xlat16.x = u_xlat16.x * u_xlat43 + 1.00001001;
    u_xlat43 = u_xlat27 * u_xlat27 + 1.5;
    ...
    u_xlat5.x = min(u_xlat5.x, 100.0);
    u_xlat5.xyw = u_xlat5.xxx * u_xlat16_6.xyz + u_xlat16_7.xyz;
    u_xlat5.xyw = u_xlat16_9.xyz * u_xlat5.xyw;
    u_xlat43 = dot(u_xlat0.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat43 = clamp(u_xlat43, 0.0, 1.0);
    u_xlat5.xyw = u_xlat5.xyw * vec3(u_xlat43) + u_xlat16_1.xyz;
    u_xlat16_1.x = dot((-u_xlat10.xyz), u_xlat0.xyz);
    u_xlat16_1.x = u_xlat16_1.x + u_xlat16_1.x;
    u_xlat16_1.xyz = u_xlat0.xyz * (-u_xlat16_1.xxx) + (-u_xlat10.xyz);
    ...
    u_xlatb0 = u_xlat0.x<9.99999975e-06;
    u_xlat0.x = (u_xlatb0) ? u_xlat16_1.z : (-u_xlat16_1.z);
    u_xlat10.z = u_xlat0.x * u_xlat16_1.x;
    u_xlat0.x = u_xlat0.x * u_xlat16_1.z;
    u_xlat10.xy = (-u_xlat16_1.xy) * u_xlat16_1.yz;
    u_xlat0.yz = (-u_xlat16_1.xy) * u_xlat16_1.xy;
    ...
    u_xlat16_1.x = (u_xlatb33) ? 0.0 : u_xlat27;
    u_xlat10_0 = textureCube(unity_SpecCube0, u_xlat0.xyz, u_xlat16_1.x);
    u_xlat16_1.x = u_xlat10_0.w + -1.0;
    u_xlat16_1.x = unity_SpecCube0_HDR.w * u_xlat16_1.x + 1.0;
    u_xlat16_1.x = u_xlat16_1.x * unity_SpecCube0_HDR.x;
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat16_1.www * u_xlat16_7.xyz + u_xlat16_3.xyz;
    SV_Target0.w = u_xlat16_3.w * _AlphaFactor;
    u_xlat16_8.xyz = u_xlat16_7.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_8.xyz = u_xlat16_2.xxx * u_xlat16_8.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat16_5.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat10_0.xyz = texture2D(_EmissionMap, vs_TEXCOORD2.xy).xyz;
    u_xlat16_2.xyz = u_xlat16_5.xyz * u_xlat10_0.xyz + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat1.x = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat1.x = inversesqrt(u_xlat1.x);
    u_xlat11.xyz = u_xlat1.xxx * u_xlat3.xyz;
    ...
    u_xlat1.x = dot(u_xlat0.xyz, u_xlat11.xyz);
    ...
    u_xlat1.xyz = u_xlat1.xyz * vec3(u_xlat30) + u_xlat16_2.xyz;
    ...
    u_xlat33 = u_xlat30 * 8.29800034;
    u_xlat16_5.x = (u_xlatb31) ? 0.0 : u_xlat33;
    ...
    u_xlat16_8.xyz = u_xlat16_7.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_8.xyz = u_xlat16_2.xxx * u_xlat16_8.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_9.xyz = vec3(u_xlat16_12) + (-u_xlat16_8.xyz);
    u_xlat16_2.xyw = vec3(u_xlat16_32) * u_xlat16_9.xyz + u_xlat16_8.xyz;
    u_xlat16_2.xyw = u_xlat16_2.xyw * u_xlat16_5.xyz;
    ...
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat10 = max(u_xlat21, 0.319999993);
    ...
    u_xlat0.xyz = u_xlat16_7.xyz * vec3(u_xlat16_22) + u_xlat0.xyz;
    u_xlat0.xyz = u_xlat0.xyz * _LightColor0.xyz;
    u_xlat0.xyz = u_xlat0.xyz * u_xlat11.xxx + u_xlat16_2.xyw;
...
void main()
{
    ...
    u_xlat16_6.xyz = u_xlat16_1.www * u_xlat16_6.xyz + u_xlat16_3.xyz;
    SV_Target0.w = u_xlat16_3.w * _AlphaFactor;
    u_xlat16_7.xyz = u_xlat16_6.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_7.xyz = u_xlat16_2.xxx * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_2.x = (-u_xlat16_2.x) * 0.779083729 + 0.779083729;
    ...
    u_xlat16_2.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat10_4.xyz = texture2D(_EmissionMap, vs_TEXCOORD2.xy).xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat10_4.xyz + u_xlat0.xyz;
    u_xlat16_0.xyz = u_xlat16_2.xyz + (-unity_FogColor.xyz);
    u_xlat27 = vs_TEXCOORD5.y;
    u_xlat27 = clamp(u_xlat27, 0.0, 1.0);
    u_xlat0.xyz = vec3(u_xlat27) * u_xlat16_0.xyz + unity_FogColor.xyz;
...
void main()
{
    ...
    u_xlatb1 = u_xlat4.z<0.00499999989;
    u_xlat36 = u_xlat4.z * 8.29800034;
    u_xlat16_35 = (u_xlatb1) ? 0.0 : u_xlat36;
    u_xlat10_3 = textureCube(unity_SpecCube0, u_xlat3.xyz, u_xlat16_35);
    u_xlat16_35 = u_xlat10_3.w + -1.0;
    u_xlat16_35 = unity_SpecCube0_HDR.w * u_xlat16_35 + 1.0;
    u_xlat16_35 = u_xlat16_35 * unity_SpecCube0_HDR.x;
    ...
    u_xlat16_7.xyz = u_xlat16_2.xxx * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_2.xyw = vec3(u_xlat16_13) + (-u_xlat16_7.xyz);
    u_xlat16_2.xyw = vec3(u_xlat16_12) * u_xlat16_2.xyw + u_xlat16_7.xyz;
    u_xlat16_7.xyz = u_xlat1.xxx * u_xlat16_7.xyz + u_xlat16_6.xyz;
    u_xlat16_2.xyw = u_xlat16_2.xyw * u_xlat16_5.xyz;
    ...
    u_xlat16_5.xyz = unity_SHC.xyz * u_xlat16_5.xxx + u_xlat16_8.xyz;
    u_xlat9 = dot(u_xlat0.xyz, _WorldSpaceLightPos0.xyz);
    ...
    u_xlat16_5.xyz = unity_Lightmap_HDR.xxx * u_xlat16_9.xyz + u_xlat16_0.xyz;
    u_xlat16_5.xyz = u_xlat16_2.zzz * u_xlat16_5.xyz;
    u_xlat16_2.xyz = u_xlat16_5.xyz * u_xlat16_6.xyz + u_xlat16_2.xyw;
...
void main()
{
    ...
    u_xlat16_35 = (-u_xlat16_35) + u_xlat16_4.y;
    ...
    u_xlat10.xyz = u_xlat9.xyz * u_xlat16.xxx + _WorldSpaceLightPos0.xyz;
    u_xlat16.xyz = u_xlat16.xxx * u_xlat9.xyz;
    ...
    u_xlat10.x = u_xlat31 * u_xlat31 + 1.5;
    u_xlat9.x = u_xlat9.x * u_xlat10.x;
    u_xlat9.x = u_xlat20 * u_xlat9.x;
    u_xlat9.x = u_xlat42 / u_xlat9.x;
    u_xlat16_35 = u_xlat31 * u_xlat42;
    u_xlat16_35 = (-u_xlat16_35) * 0.280000001 + 1.0;
    u_xlat9.x = u_xlat9.x + -9.99999975e-05;
    u_xlat9.x = max(u_xlat9.x, 0.0);
    u_xlat9.x = min(u_xlat9.x, 100.0);
    u_xlat9.xyw = u_xlat9.xxx * u_xlat16_6.xyz + u_xlat16_7.xyz;
    u_xlat9.xyw = u_xlat9.xyw * _LightColor0.xyz;
    u_xlat9.xyw = u_xlat9.xyw * vec3(u_xlat33) + u_xlat16_2.xyz;
    u_xlat16_2.x = dot((-u_xlat16.xyz), u_xlat0.xyz);
    u_xlat16_2.x = u_xlat16_2.x + u_xlat16_2.x;
    u_xlat16_2.xyz = u_xlat0.xyz * (-u_xlat16_2.xxx) + (-u_xlat16.xyz);
    ...
    u_xlat10.z = u_xlat0.x * u_xlat16_2.x;
    ...
    u_xlat0.xyz = vec3(u_xlat33) * u_xlat0.xyz;
    u_xlat0.xyz = u_xlat0.xyz * vec3(_NormalDiff);
    u_xlat0.xyz = u_xlat0.xyz * u_xlat5.xxx + u_xlat16_2.xyz;
    u_xlat33 = dot(u_xlat0.xyz, u_xlat0.xyz);
    u_xlat33 = inversesqrt(u_xlat33);
    u_xlat0.xyz = vec3(u_xlat33) * u_xlat0.xyz;
    u_xlatb33 = u_xlat31<0.00499999989;
    u_xlat5.x = u_xlat31 * 8.29800034;
    u_xlat16_2.x = (u_xlatb33) ? 0.0 : u_xlat5.x;
    ...
    u_xlat0.xyz = u_xlat16_2.xyz * u_xlat16_4.xyw + u_xlat9.xyw;
    u_xlat16_2.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat10_5.xyz = texture2D(_EmissionMap, vs_TEXCOORD2.xy).xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat10_5.xyz + u_xlat0.xyz;
    u_xlat16_0.xyz = u_xlat16_2.xyz + (-unity_FogColor.xyz);
    u_xlat33 = vs_TEXCOORD5.y;
    u_xlat33 = clamp(u_xlat33, 0.0, 1.0);
    u_xlat0.xyz = vec3(u_xlat33) * u_xlat16_0.xyz + unity_FogColor.xyz;
...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
    u_xlat16_0.xyz = max(u_xlat16_0.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_19.xyz = texture2D(unity_Lightmap, vs_TEXCOORD6.xy).xyz;
    u_xlat16_5.xyz = unity_Lightmap_HDR.xxx * u_xlat16_19.xyz + u_xlat16_0.xyz;
    u_xlat16_5.xyz = u_xlat16_2.zzz * u_xlat16_5.xyz;
    u_xlat16_2.xyz = u_xlat16_5.xyz * u_xlat16_6.xyz + u_xlat16_2.xyw;
    u_xlat10_0 = texture2D(unity_ShadowMask, vs_TEXCOORD8.xy);
    u_xlat16_32 = dot(u_xlat10_0, unity_OcclusionMaskSelector);
...
void main()
{
    ...
    u_xlat9.xyw = u_xlat16_4.xyw * u_xlat9.xyw;
    u_xlat9.xyw = u_xlat9.xyw * vec3(u_xlat33) + u_xlat16_2.xyz;
    u_xlat16_2.x = dot((-u_xlat16.xyz), u_xlat0.xyz);
    u_xlat16_2.x = u_xlat16_2.x + u_xlat16_2.x;
    u_xlat16_2.xyz = u_xlat0.xyz * (-u_xlat16_2.xxx) + (-u_xlat16.xyz);
