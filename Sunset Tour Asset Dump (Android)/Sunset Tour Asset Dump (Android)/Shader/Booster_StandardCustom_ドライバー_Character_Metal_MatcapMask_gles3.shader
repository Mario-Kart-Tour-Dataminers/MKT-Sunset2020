...
void main()
{
    ...
    u_xlat16_8.xyz = _Color.xyz * u_xlat16_12.xyz + _AddColor.xyz;
    u_xlat16_12.xyz = texture(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat16_3.xyz * u_xlat16_0.xyz + u_xlat16_1.xyz;
    u_xlat16_3.xyz = u_xlat16_1.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_0.xy = texture(_MSA, vs_TEXCOORD1.xy).xy;
    u_xlat16_4.xy = max(u_xlat16_0.xy, _MinMSA.xy);
    u_xlat16_3.xyz = u_xlat16_4.xxx * u_xlat16_3.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat0.x = dot(u_xlat2.xyz, u_xlat2.xyz);
    u_xlat0.x = inversesqrt(u_xlat0.x);
...
void main()
{
    ...
    u_xlat16_1.xyz = texture(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    u_xlat16_7.xyz = u_xlat16_7.xyz * u_xlat16_1.xyz + u_xlat16_4.xyz;
