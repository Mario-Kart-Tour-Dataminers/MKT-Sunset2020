...
void main()
{
    ...
    u_xlat16_3 = texture(unity_SpecCube0, u_xlat3.xyz, u_xlat16_31);
    ...
    u_xlat16_0.x = u_xlat16_21 * u_xlat16_0.x;
    u_xlat16_1.xyz = u_xlat16_0.xxx * u_xlat16_1.xyw + u_xlat16_7.xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = max(u_xlat16_3.xyz, _MinMSA.xyz);
    ...
    u_xlat16_0 = texture(unity_SpecCube0, u_xlat0.xyz, u_xlat16_11.x);
...
void main()
{
    ...
    u_xlat16_31 = dot(u_xlat16_4, unity_OcclusionMaskSelector);
#ifdef UNITY_ADRENO_ES3
    u_xlat16_31 = min(max(u_xlat16_31, 0.0), 1.0);
#else
    u_xlat16_31 = clamp(u_xlat16_31, 0.0, 1.0);
