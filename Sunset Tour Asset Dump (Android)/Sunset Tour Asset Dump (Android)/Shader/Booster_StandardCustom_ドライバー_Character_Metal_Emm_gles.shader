...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/ドライバー/Character_Metal_Emm" {
Properties {
...
void main()
{
    ...
    SV_Target0.xyz = u_xlat16_0.xyz * vec3(_EmissionIntensity) + u_xlat16_2.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat10_0.xyz = texture2D(_EmissionMap, vs_TEXCOORD1.zw).xyz;
    u_xlat16_0.xyz = u_xlat10_0.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    SV_Target0.xyz = u_xlat16_0.xyz * vec3(_EmissionIntensity) + u_xlat16_3.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    SV_Target0.xyz = u_xlat16_3.xyz * vec3(_EmissionIntensity) + u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    SV_Target0.xyz = u_xlat16_1.xyz * vec3(_EmissionIntensity) + u_xlat16_3.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat10_5.xyz = texture2D(_EmissionMap, vs_TEXCOORD1.zw).xyz;
    u_xlat16_5.xyz = u_xlat10_5.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    SV_Target0.xyz = u_xlat16_5.xyz * vec3(_EmissionIntensity) + u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_3.xyz = _Color.xyz * u_xlat10_1.xyz + _AddColor.xyz;
    ...
    u_xlat10_1.xyz = texture2D(_EmissionMap, vs_TEXCOORD1.zw).xyz;
    u_xlat16_1.xyz = u_xlat10_1.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_3.xyz = u_xlat16_1.xyz * vec3(_EmissionIntensity) + u_xlat0.xyz;
...
void main()
{
    ...
    u_xlat10_2.xyz = texture2D(_EmissionMap, vs_TEXCOORD1.zw).xyz;
    u_xlat16_2.xyz = u_xlat10_2.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_1.xyz = u_xlat16_2.xyz * vec3(_EmissionIntensity) + u_xlat0.xyz;
...
void main()
{
    ...
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat10_12.xy = texture2D(_MSA, vs_TEXCOORD1.xy).xy;
    ...
    u_xlat10_1.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_10.xyz = _Color.xyz * u_xlat10_1.xyz + _AddColor.xyz;
