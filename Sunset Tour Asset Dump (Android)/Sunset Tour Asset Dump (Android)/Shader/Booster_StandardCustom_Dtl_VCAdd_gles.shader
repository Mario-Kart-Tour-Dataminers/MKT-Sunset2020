...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/Dtl_VCAdd" {
Properties {
...
void main()
{
    ...
    u_xlat10_3.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD0.xy).xyz;
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat16_9.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat10_3.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD0.xy).xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat10_3.xyz;
    u_xlat16_13.xyz = u_xlat16_2.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_2.xyz = u_xlat16_2.xyz + u_xlat16_2.xyz;
