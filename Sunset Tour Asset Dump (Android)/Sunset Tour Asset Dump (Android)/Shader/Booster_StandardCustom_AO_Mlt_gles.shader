...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/AO_Mlt" {
Properties {
...
void main()
{
    ...
    u_xlat10_30 = texture2D(_MSA, vs_TEXCOORD0.xy).z;
    u_xlat16_34 = u_xlat10_30 + -1.0;
...
void main()
{
    ...
    u_xlat10_1 = texture2D(_MSA, vs_TEXCOORD0.xy).z;
    u_xlat16_32 = u_xlat10_1 + -1.0;
...
void main()
{
    ...
    u_xlat10_33 = texture2D(_MSA, vs_TEXCOORD0.xy).z;
    ...
    u_xlat16_38 = (-u_xlat16_1.x) + _Smoothness;
    u_xlat16_6.xyz = u_xlat16_1.xxx * u_xlat16_6.xyz;
    u_xlat16_1.x = u_xlat16_38 + 1.0;
    ...
    u_xlat16_1.xyz = u_xlat16_12.xyz * u_xlat16_6.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat16_8.xyz = (-u_xlat16_7.xyz) + vec3(u_xlat16_36);
...
void main()
{
    ...
    u_xlat16_7.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_1.x = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_35 = (-u_xlat16_1.x) + _Smoothness;
    u_xlat16_6.xyz = u_xlat16_1.xxx * u_xlat16_6.xyz;
    ...
    u_xlat16_7.xyz = u_xlat16_0.xxx * u_xlat16_8.xyz + u_xlat16_7.xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat16_7.xyz;
    u_xlat16_1.xyz = u_xlat16_11.xyz * u_xlat16_6.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat10_3 = texture2D(_MSA, vs_TEXCOORD0.xy).z;
...
void main()
{
    ...
    u_xlat16_4.xyz = texture2D(unity_Lightmap, vs_TEXCOORD3.xy).xyz;
    u_xlat16_0.xyz = unity_Lightmap_HDR.xxx * u_xlat16_4.xyz + u_xlat16_3.xyz;
    u_xlat10_3.x = texture2D(_MSA, vs_TEXCOORD0.xy).z;
    u_xlat16_24 = u_xlat10_3.x + -1.0;
...
void main()
{
    ...
    u_xlat16_4.x = u_xlat16_4.x * unity_SpecCube0_HDR.x;
    u_xlat16_4.xyz = u_xlat10_1.xyz * u_xlat16_4.xxx;
    u_xlat10_27 = texture2D(_MSA, vs_TEXCOORD0.xy).z;
...
void main()
{
    ...
    u_xlat2.y = hlslcc_mtx4x4unity_MatrixV[1].y;
    u_xlat2.z = hlslcc_mtx4x4unity_MatrixV[2].y;
    u_xlat16_1.y = dot(u_xlat2.xyz, vs_TEXCOORD0.xyz);
    u_xlat16_1.xy = u_xlat16_1.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
    u_xlat10_2.xyz = texture2D(_SphereMap, u_xlat16_1.xy).xyz;
    u_xlat16_1.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat10_2.xyz;
...
void main()
{
    ...
    u_xlat10_0.xyz = texture2D(_SphereMap, vec2(0.5, 0.5)).xyz;
