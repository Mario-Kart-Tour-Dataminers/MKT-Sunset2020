...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat16_2.xyz * vec3(u_xlat16_28);
    u_xlat16_3.xyz = u_xlat16_3.xyz * vec3(_Occlusion);
...
void main()
{
    ...
    u_xlat16_2 = texture(unity_SpecCube0, u_xlat5.xyz, u_xlat16_31);
...
void main()
{
    ...
    u_xlat16_2 = texture(unity_SpecCube0, u_xlat2.xyz, u_xlat16_3.x);
    u_xlat16_3.x = u_xlat16_2.w + -1.0;
    u_xlat16_3.x = unity_SpecCube0_HDR.w * u_xlat16_3.x + 1.0;
    u_xlat16_3.x = u_xlat16_3.x * unity_SpecCube0_HDR.x;
    u_xlat16_3.xyz = u_xlat16_2.xyz * u_xlat16_3.xxx;
...
void main()
{
    ...
    u_xlat16_30 = dot(u_xlat16_3, unity_OcclusionMaskSelector);
#ifdef UNITY_ADRENO_ES3
    u_xlat16_30 = min(max(u_xlat16_30, 0.0), 1.0);
#else
    u_xlat16_30 = clamp(u_xlat16_30, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_2 = texture(unity_SpecCube0, u_xlat5.xyz, u_xlat16_28);
    u_xlat16_28 = u_xlat16_2.w + -1.0;
    u_xlat16_28 = unity_SpecCube0_HDR.w * u_xlat16_28 + 1.0;
    u_xlat16_28 = u_xlat16_28 * unity_SpecCube0_HDR.x;
    u_xlat16_3.xyz = u_xlat16_2.xyz * vec3(u_xlat16_28);
...
void main()
{
    ...
    u_xlat16_19 = u_xlat16_19 * u_xlat16_19;
    u_xlat16_3 = texture(_HeuristicReflection, u_xlat16_1.xyz);
    u_xlat16_1.x = u_xlat16_3.w + -1.0;
    u_xlat16_1.x = unity_SpecCube0_HDR.w * u_xlat16_1.x + 1.0;
    u_xlat16_1.x = u_xlat16_1.x * unity_SpecCube0_HDR.x;
    u_xlat16_1.xyz = u_xlat16_3.xyz * u_xlat16_1.xxx;
