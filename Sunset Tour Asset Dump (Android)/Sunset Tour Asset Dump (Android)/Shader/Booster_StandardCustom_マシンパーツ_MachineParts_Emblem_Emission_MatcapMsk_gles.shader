...
void main()
{
    ...
    u_xlat10_1 = texture2D(_Decal, vs_TEXCOORD2.xy);
    ...
    u_xlat10_4.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    u_xlat16_7.xyz = u_xlat16_7.xyz * u_xlat10_4.xyz + u_xlat16_8.xyz;
    ...
    u_xlat10_0.xyz = texture2D(_EmissionMap, vs_TEXCOORD2.zw).xyz;
...
void main()
{
    ...
    u_xlat16_8.xyz = _Color.xyz * u_xlat10_11.xyz + _AddColor.xyz;
    u_xlat10_2 = texture2D(_Decal, vs_TEXCOORD2.xy);
    ...
    u_xlat10_1.xyz = texture2D(_EmissionMap, vs_TEXCOORD2.zw).xyz;
...
void main()
{
    ...
    u_xlat10_0 = texture2D(_Decal, vs_TEXCOORD2.xy);
    ...
    u_xlat16_2.xyz = u_xlat10_3.xyz * _SphereMapScale.xyz;
    u_xlat10_3.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    u_xlat16_1.xyz = u_xlat16_2.xyz * u_xlat10_3.xyz + u_xlat16_1.xyz;
    ...
    u_xlat10_4.xyz = texture2D(_EmissionMap, vs_TEXCOORD2.zw).xyz;
...
void main()
{
    ...
    u_xlat10_5.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat10_5.xyz + u_xlat16_7.xyz;
    ...
    u_xlat10_0 = textureCube(unity_SpecCube0, u_xlat5.xyz, u_xlat16_2.x);
    u_xlat16_2.x = u_xlat10_0.w + -1.0;
    u_xlat16_2.x = unity_SpecCube0_HDR.w * u_xlat16_2.x + 1.0;
    u_xlat16_2.x = u_xlat16_2.x * unity_SpecCube0_HDR.x;
    ...
    u_xlat10_6.xyz = texture2D(_EmissionMap, vs_TEXCOORD2.zw).xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat10_4.xyz * _SphereMapScale.xyz;
    u_xlat10_4.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    u_xlat16_2.xyz = u_xlat16_3.xyz * u_xlat10_4.xyz + u_xlat16_2.xyz;
    ...
    u_xlat10_5.xyz = texture2D(_EmissionMap, vs_TEXCOORD2.zw).xyz;
...
void main()
{
    ...
    u_xlat6.xyw = u_xlat6.xxx * u_xlat16_4.xyz + u_xlat16_7.xyz;
    u_xlat10_0 = texture2D(unity_ShadowMask, vs_TEXCOORD8.xy);
    u_xlat16_3.x = dot(u_xlat10_0, unity_OcclusionMaskSelector);
    u_xlat16_3.x = clamp(u_xlat16_3.x, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_32 = (-u_xlat16_31) + u_xlat16_7.y;
    ...
    u_xlat5.xyz = u_xlat5.xyz * u_xlat4.xxx + _WorldSpaceLightPos0.xyz;
    u_xlat4.x = dot(u_xlat3.xyz, u_xlat14.xyz);
    u_xlat4.x = clamp(u_xlat4.x, 0.0, 1.0);
    u_xlat16_32 = (-u_xlat4.x) + 1.0;
    u_xlat16_32 = u_xlat16_32 * u_xlat16_32;
    u_xlat16_32 = u_xlat16_32 * u_xlat16_32;
    u_xlat16_8.xyz = vec3(u_xlat16_32) * u_xlat16_8.xyz + u_xlat16_2.xyz;
    u_xlat16_32 = dot((-u_xlat14.xyz), u_xlat3.xyz);
    u_xlat16_32 = u_xlat16_32 + u_xlat16_32;
    u_xlat16_9.xyz = u_xlat3.xyz * (-vec3(u_xlat16_32)) + (-u_xlat14.xyz);
    u_xlat4.x = dot(u_xlat16_9.zxy, (-u_xlat16_9.xyz));
    u_xlatb4 = u_xlat4.x<9.99999975e-06;
    u_xlat4.x = (u_xlatb4) ? u_xlat16_9.z : (-u_xlat16_9.z);
    u_xlat6.z = u_xlat4.x * u_xlat16_9.x;
    u_xlat4.x = u_xlat4.x * u_xlat16_9.z;
    u_xlat6.xy = (-u_xlat16_9.xy) * u_xlat16_9.yz;
    u_xlat4.yz = (-u_xlat16_9.xy) * u_xlat16_9.xy;
    u_xlat4.xyz = (-u_xlat4.xyz) + u_xlat6.xyz;
    u_xlat34 = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat34 = inversesqrt(u_xlat34);
    u_xlat4.xyz = vec3(u_xlat34) * u_xlat4.xyz;
    u_xlat4.xyz = u_xlat4.xyz * vec3(_NormalDiff);
    u_xlat4.xyz = u_xlat4.xyz * vec3(u_xlat33) + u_xlat16_9.xyz;
    u_xlat33 = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat33 = inversesqrt(u_xlat33);
    u_xlat4.xyz = vec3(u_xlat33) * u_xlat4.xyz;
    u_xlat33 = (-u_xlat16_7.y) + 1.0;
    u_xlatb34 = u_xlat33<0.00499999989;
    u_xlat35 = u_xlat33 * 8.29800034;
    u_xlat16_32 = (u_xlatb34) ? 0.0 : u_xlat35;
    u_xlat10_0 = textureCube(unity_SpecCube0, u_xlat4.xyz, u_xlat16_32);
    u_xlat16_32 = u_xlat10_0.w + -1.0;
    u_xlat16_32 = unity_SpecCube0_HDR.w * u_xlat16_32 + 1.0;
    u_xlat16_32 = u_xlat16_32 * unity_SpecCube0_HDR.x;
    u_xlat16_7.xyw = u_xlat10_0.xyz * vec3(u_xlat16_32);
    u_xlat16_7.xyz = u_xlat16_7.zzz * u_xlat16_7.xyw;
    u_xlat4.x = u_xlat33 * u_xlat33;
    u_xlat16_32 = u_xlat33 * u_xlat4.x;
    ...
    u_xlat5.x = dot(_WorldSpaceLightPos0.xyz, u_xlat14.xyz);
    u_xlat5.x = clamp(u_xlat5.x, 0.0, 1.0);
    u_xlat14.x = dot(u_xlat3.xyz, u_xlat14.xyz);
    u_xlat14.x = clamp(u_xlat14.x, 0.0, 1.0);
    u_xlat3.x = dot(u_xlat3.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    u_xlat13.x = u_xlat14.x * u_xlat14.x;
    u_xlat23 = max(u_xlat5.x, 0.319999993);
    u_xlat23 = u_xlat33 * u_xlat23;
    u_xlat33 = u_xlat4.x * u_xlat4.x + -1.0;
    u_xlat13.x = u_xlat13.x * u_xlat33 + 1.00001001;
    ...
    u_xlat13.xyz = u_xlat16_2.xyz * u_xlat13.xxx;
    u_xlat13.xyz = u_xlat16_1.xyz * vec3(u_xlat16_31) + u_xlat13.xyz;
    u_xlat13.xyz = u_xlat13.xyz * _LightColor0.xyz;
    u_xlat3.xyz = u_xlat13.xyz * u_xlat3.xxx + u_xlat16_7.xyz;
    u_xlat10_4.xyz = texture2D(_EmissionMap, vs_TEXCOORD2.zw).xyz;
    u_xlat16_4.xyz = u_xlat10_4.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
...
void main()
{
    ...
    u_xlat16_9.xyz = u_xlat3.xxx * u_xlat16_8.xyz + u_xlat16_7.xyz;
    u_xlat16_36 = (-u_xlat4.x) + 1.0;
    u_xlat16_3 = u_xlat16_36 * u_xlat16_36;
    u_xlat16_3 = u_xlat16_36 * u_xlat16_3;
    u_xlat16_3 = u_xlat16_36 * u_xlat16_3;
    u_xlat16_2.xyw = vec3(u_xlat16_3) * u_xlat16_2.xyw + u_xlat16_8.xyz;
    u_xlat16_2.xyw = u_xlat16_2.xyw * u_xlat16_6.xyz;
...
void main()
{
    ...
    u_xlat16_3.x = u_xlat16_39 * u_xlat16_3.x;
    u_xlat16_2.xyw = u_xlat16_3.xxx * u_xlat16_2.xyw + u_xlat16_8.xyz;
    u_xlat16_2.xyw = u_xlat16_2.xyw * u_xlat16_6.xyz;
...
void main()
{
    ...
    u_xlat16_7.xyz = vec3(u_xlat16_37) * u_xlat16_1.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_1.xyz = u_xlat16_2.xxx * u_xlat16_1.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_37 = (-u_xlat16_37) + u_xlat16_2.y;
    ...
    u_xlat4.z = vs_TEXCOORD5.w;
    u_xlat5.xyz = (-u_xlat4.xyz) + _WorldSpaceCameraPos.xyz;
    u_xlat4.x = dot(u_xlat4.xyz, _NormalRand.xyz);
    u_xlat4.x = sin(u_xlat4.x);
    u_xlat4.x = u_xlat4.x * _NormalRand.w;
    u_xlat4.x = fract(u_xlat4.x);
    u_xlat16.x = dot(u_xlat5.xyz, u_xlat5.xyz);
    u_xlat16.x = inversesqrt(u_xlat16.x);
    u_xlat6.xyz = u_xlat5.xyz * u_xlat16.xxx + _WorldSpaceLightPos0.xyz;
    ...
    u_xlat29 = (-u_xlat16_2.y) + 1.0;
    u_xlat41 = u_xlat29 * u_xlat29;
    u_xlat6.x = u_xlat41 * u_xlat41 + -1.0;
    u_xlat17 = u_xlat17 * u_xlat6.x + 1.00001001;
    u_xlat6.x = u_xlat29 * u_xlat29 + 1.5;
    u_xlat5.x = u_xlat5.x * u_xlat6.x;
    u_xlat5.x = u_xlat17 * u_xlat5.x;
    u_xlat5.x = u_xlat41 / u_xlat5.x;
    u_xlat16_37 = u_xlat29 * u_xlat41;
    u_xlat16_37 = (-u_xlat16_37) * 0.280000001 + 1.0;
    u_xlat5.x = u_xlat5.x + -9.99999975e-05;
    u_xlat5.x = max(u_xlat5.x, 0.0);
    u_xlat5.x = min(u_xlat5.x, 100.0);
    u_xlat5.xyw = u_xlat5.xxx * u_xlat16_1.xyz + u_xlat16_7.xyz;
    u_xlat5.xyw = u_xlat5.xyw * _LightColor0.xyz;
    u_xlat6.x = dot(u_xlat0.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat6.x = clamp(u_xlat6.x, 0.0, 1.0);
    u_xlat5.xyw = u_xlat5.xyw * u_xlat6.xxx + u_xlat16_9.xyz;
    u_xlat16_2.x = dot((-u_xlat16.xyz), u_xlat0.xyz);
    u_xlat16_2.x = u_xlat16_2.x + u_xlat16_2.x;
    u_xlat16_2.xyw = u_xlat0.xyz * (-u_xlat16_2.xxx) + (-u_xlat16.xyz);
    u_xlat16.x = dot(u_xlat0.xyz, u_xlat16.xyz);
    u_xlat16.x = clamp(u_xlat16.x, 0.0, 1.0);
    u_xlat16_7.x = (-u_xlat16.x) + 1.0;
    u_xlat16_7.x = u_xlat16_7.x * u_xlat16_7.x;
    u_xlat16_7.x = u_xlat16_7.x * u_xlat16_7.x;
    u_xlat16_1.xyz = u_xlat16_7.xxx * u_xlat16_8.xyz + u_xlat16_1.xyz;
    u_xlat16.x = dot(u_xlat16_2.wxy, (-u_xlat16_2.xyw));
    u_xlatb16 = u_xlat16.x<9.99999975e-06;
    u_xlat16.x = (u_xlatb16) ? u_xlat16_2.w : (-u_xlat16_2.w);
    u_xlat6.z = u_xlat16_2.x * u_xlat16.x;
    u_xlat11.x = u_xlat16_2.w * u_xlat16.x;
    u_xlat6.xy = (-u_xlat16_2.xy) * u_xlat16_2.yw;
    u_xlat11.yz = (-u_xlat16_2.xy) * u_xlat16_2.xy;
    u_xlat16.xyz = u_xlat6.xyz + (-u_xlat11.xyz);
    u_xlat6.x = dot(u_xlat16.xyz, u_xlat16.xyz);
    u_xlat6.x = inversesqrt(u_xlat6.x);
    u_xlat16.xyz = u_xlat16.xyz * u_xlat6.xxx;
    u_xlat16.xyz = u_xlat16.xyz * vec3(_NormalDiff);
    u_xlat4.xyz = u_xlat16.xyz * u_xlat4.xxx + u_xlat16_2.xyw;
    u_xlat40 = dot(u_xlat4.xyz, u_xlat4.xyz);
    u_xlat40 = inversesqrt(u_xlat40);
    u_xlat4.xyz = vec3(u_xlat40) * u_xlat4.xyz;
    u_xlatb40 = u_xlat29<0.00499999989;
    u_xlat29 = u_xlat29 * 8.29800034;
    u_xlat16_2.x = (u_xlatb40) ? 0.0 : u_xlat29;
    u_xlat10_0 = textureCube(unity_SpecCube0, u_xlat4.xyz, u_xlat16_2.x);
    u_xlat16_2.x = u_xlat10_0.w + -1.0;
    u_xlat16_2.x = unity_SpecCube0_HDR.w * u_xlat16_2.x + 1.0;
    u_xlat16_2.x = u_xlat16_2.x * unity_SpecCube0_HDR.x;
    u_xlat16_2.xyw = u_xlat10_0.xyz * u_xlat16_2.xxx;
    ...
    u_xlat4.xyz = u_xlat16_2.xyz * u_xlat16_1.xyz + u_xlat5.xyw;
    u_xlat10_5.xyz = texture2D(_EmissionMap, vs_TEXCOORD2.zw).xyz;
    u_xlat16_5.xyz = u_xlat10_5.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_1.xyz = u_xlat16_5.xyz * vec3(_EmissionIntensity) + u_xlat4.xyz;
    u_xlat16_4.xyz = u_xlat16_1.xyz + (-unity_FogColor.xyz);
    u_xlat40 = vs_TEXCOORD5.y;
    u_xlat40 = clamp(u_xlat40, 0.0, 1.0);
    u_xlat4.xyz = vec3(u_xlat40) * u_xlat16_4.xyz + unity_FogColor.xyz;
...
void main()
{
    ...
    u_xlat16_2.x = dot(u_xlat10_3, unity_OcclusionMaskSelector);
    u_xlat16_2.x = clamp(u_xlat16_2.x, 0.0, 1.0);
    u_xlat16_2.xyw = u_xlat16_2.xxx * _LightColor0.xyz;
    u_xlat5.xyw = u_xlat16_2.xyw * u_xlat5.xyw;
    u_xlat6.x = dot(u_xlat0.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat6.x = clamp(u_xlat6.x, 0.0, 1.0);
    u_xlat5.xyw = u_xlat5.xyw * u_xlat6.xxx + u_xlat16_9.xyz;
    u_xlat16_2.x = dot((-u_xlat16.xyz), u_xlat0.xyz);
...
void main()
{
    ...
    u_xlat10_1.xyz = texture2D(_SphereMap, u_xlat16_8.xy).xyz;
    u_xlat16_8.xyz = u_xlat10_1.xyz * _SphereMapScale.xyz;
    u_xlat10_1.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    ...
    u_xlat10_3.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    u_xlat16_8.xyz = u_xlat16_8.xyz * u_xlat10_3.xyz + u_xlat16_4.xyz;
