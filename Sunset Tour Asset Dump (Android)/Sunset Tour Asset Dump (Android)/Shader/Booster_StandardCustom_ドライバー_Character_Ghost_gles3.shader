...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat16_0.xyz * _SphereMapScale.xyz + u_xlat16_1.xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat16_2.xyz * _SphereMapScale.xyz + u_xlat16_1.xyz;
    SV_Target0.w = u_xlat16_1.w * _AlphaFactor;
...
void main()
{
    ...
    u_xlat16_2 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_1 = u_xlat16_1 * u_xlat16_2;
    u_xlat16_5.xyz = u_xlat16_3.xyz * _SphereMapScale.xyz + u_xlat16_1.xyz;
    SV_Target0.w = u_xlat16_1.w * _AlphaFactor;
...
void main()
{
    ...
    u_xlat16_1.xy = u_xlat16_1.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
    u_xlat16_0.xyz = texture(_SphereMap, u_xlat16_1.xy).xyz;
    u_xlat16_1.xyz = u_xlat16_0.xyz * _SphereMapScale.xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat16_2.xyz * _SphereMapScale.xyz + u_xlat16_1.xyz;
    SV_Target0.w = u_xlat16_1.w * _AlphaFactor;
    u_xlat16_4.xyz = (-booster_PowerSavingAdjustColor.xyz) + vec3(1.0, 1.0, 1.0);
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = texture(_SphereMap, vec2(0.5, 0.5)).xyz;
    u_xlat16_3.xyz = u_xlat16_2.xyz * _SphereMapScale.xyz + u_xlat16_0.xyz;
