...
void main()
{
    ...
    u_xlat16_5.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat16_6.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat16_10.xyz;
...
void main()
{
    ...
    u_xlat16_5.xy = u_xlat16_5.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
    u_xlat16_4.xyz = texture(_SphereMap, u_xlat16_5.xy).xyz;
    u_xlat16_5.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat16_4.xyz;
    u_xlat16_6.xyz = u_xlat16_5.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
...
void main()
{
    ...
    u_xlat16_2.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat16_0.xyz;
...
void main()
{
    ...
    u_xlat16_6.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat16_3.xyz;
    u_xlat16_7.xyz = u_xlat16_6.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_7.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_34 = (-_Metallic) * 0.779083729 + 0.779083729;
...
void main()
{
    ...
    u_xlat16_3.xyz = texture(_SphereMap, u_xlat16_4.xy).xyz;
    u_xlat16_4.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat16_6.y = dot(u_xlat4.xyz, vs_TEXCOORD0.xyz);
    u_xlat16_6.xy = u_xlat16_6.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
    u_xlat16_4.xyz = texture(_SphereMap, u_xlat16_6.xy).xyz;
    u_xlat16_6.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat16_4.xyz;
    u_xlat16_7.xyz = u_xlat16_6.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_7.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_33 = (-_Metallic) * 0.779083729 + 0.779083729;
...
void main()
{
    ...
    u_xlat16_23 = dot(u_xlat16_1, unity_OcclusionMaskSelector);
#ifdef UNITY_ADRENO_ES3
    u_xlat16_23 = min(max(u_xlat16_23, 0.0), 1.0);
#else
    u_xlat16_23 = clamp(u_xlat16_23, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat16_6.xyz * u_xlat16_5.xyz + u_xlat16_4.xyz;
    u_xlat16_1 = texture(unity_ShadowMask, vs_TEXCOORD4.xy);
    u_xlat16_31 = dot(u_xlat16_1, unity_OcclusionMaskSelector);
#ifdef UNITY_ADRENO_ES3
    u_xlat16_31 = min(max(u_xlat16_31, 0.0), 1.0);
#else
    u_xlat16_31 = clamp(u_xlat16_31, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_1.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat16_0.xyz;
    ...
    u_xlat16_2 = texture(_HeuristicReflection, u_xlat16_5.xyz);
    u_xlat16_5.x = u_xlat16_2.w + -1.0;
    u_xlat16_5.x = unity_SpecCube0_HDR.w * u_xlat16_5.x + 1.0;
    u_xlat16_5.x = u_xlat16_5.x * unity_SpecCube0_HDR.x;
    u_xlat16_5.xyz = u_xlat16_2.xyz * u_xlat16_5.xxx;
...
void main()
{
    ...
    u_xlat16_5.xyz = texture(_SphereMap, u_xlat16_3.xy).xyz;
    u_xlat16_3.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat16_1.xyz;
