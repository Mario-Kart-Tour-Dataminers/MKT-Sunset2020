...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/路面/Road_VCAdd" {
Properties {
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_6.xyz * u_xlat10_2.xyz + u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat16_9.xyz = u_xlat16_6.xyz * u_xlat10_9.xyz + u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = vs_COLOR0.xyz + _Color.xyz;
    u_xlat16_3.xyz = u_xlat16_7.xyz * u_xlat10_3.xyz + u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = vs_COLOR0.xyz + _Color.xyz;
    u_xlat16_10.xyz = u_xlat16_6.xyz * u_xlat10_10.xyz + u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = vs_COLOR0.xyz + _Color.xyz;
    u_xlat16_3.xyz = u_xlat16_6.xyz * u_xlat10_3.xyz + u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat16_7.xyz * u_xlat10_4.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat10_3.xyz = texture2D(_CameraNearFogMap, u_xlat3.xy).xyz;
    u_xlat16_4.xyz = vs_COLOR0.xyz + _Color.xyz;
    u_xlat16_3.xyz = u_xlat16_2.xyz * u_xlat10_3.xyz + u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = vs_COLOR0.xyz + _Color.xyz;
    u_xlat16_2.xyz = u_xlat16_5.xyz * u_xlat10_2.xyz + u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat16_5.xyz = vs_COLOR0.xyz + _Color.xyz;
    u_xlat16_4.xyz = u_xlat16_6.xyz * u_xlat10_4.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat16_3.xyz * u_xlat10_4.xyz + u_xlat16_1.xyz;
...
void main()
{
    ...
    u_xlat8.xy = vs_TEXCOORD0.xy * _CameraNearColorUVScale.xy;
    u_xlat10_1.xyz = texture2D(_CameraNearFogMap, u_xlat8.xy).xyz;
    u_xlat16_3.xyz = vs_COLOR0.xyz + _Color.xyz;
    u_xlat16_1.xyz = u_xlat16_2.xyz * u_xlat10_1.xyz + u_xlat16_3.xyz;
