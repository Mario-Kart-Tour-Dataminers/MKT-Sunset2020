...
void main()
{
    ...
    u_xlat16_24.x = u_xlat16_5.z + -1.0;
    ...
    u_xlat16_0.xyz = texture(_EmissionMap, vs_TEXCOORD1.zw).xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = texture(_EmissionMap, vs_TEXCOORD1.zw).xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = texture(_EmissionMap, vs_TEXCOORD1.zw).xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = texture(_EmissionMap, vs_TEXCOORD1.zw).xyz;
...
void main()
{
    ...
    u_xlat16_5.xyz = texture(_EmissionMap, vs_TEXCOORD1.zw).xyz;
...
void main()
{
    ...
    u_xlat2.x = u_xlat30 * u_xlat30;
    u_xlat16_1.x = u_xlat30 * u_xlat2.x;
    u_xlat30 = u_xlat30 * u_xlat30 + 1.5;
    ...
    u_xlat16_8.xyz = u_xlat16_7.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_8.xyz = u_xlat16_11.xxx * u_xlat16_8.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_1.x = (-u_xlat16_11.x) * 0.779083729 + 0.779083729;
    u_xlat16_11.x = (-u_xlat16_1.x) + u_xlat16_11.y;
    u_xlat16_11.x = u_xlat16_11.x + 1.0;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_11.x = min(max(u_xlat16_11.x, 0.0), 1.0);
#else
    ...
    u_xlat0.x = min(u_xlat0.x, 100.0);
    u_xlat0.xzw = u_xlat16_8.xyz * u_xlat0.xxx;
    u_xlat0.xzw = u_xlat16_7.xyz * u_xlat16_1.xxx + u_xlat0.xzw;
    u_xlat0.xzw = u_xlat0.xzw * _LightColor0.xyz;
    u_xlat0.xyz = u_xlat0.xzw * vec3(u_xlat10) + u_xlat16_11.xyz;
    u_xlat16_2.xyz = texture(_EmissionMap, vs_TEXCOORD1.zw).xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
...
void main()
{
    ...
    u_xlat16_0.xyz = texture(_EmissionMap, vs_TEXCOORD1.zw).xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_3.xyz = u_xlat16_0.xyz * vec3(_EmissionIntensity) + u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = texture(_EmissionMap, vs_TEXCOORD1.zw).xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_3.xyz = u_xlat16_1.xyz * vec3(_EmissionIntensity) + u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat16_5.xyz = texture(_EmissionMap, vs_TEXCOORD1.zw).xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_2.xyz = u_xlat16_5.xyz * vec3(_EmissionIntensity) + u_xlat0.xyz;
    u_xlat16_0.xyz = u_xlat16_2.xyz + (-unity_FogColor.xyz);
    u_xlat24 = vs_TEXCOORD6;
#ifdef UNITY_ADRENO_ES3
    u_xlat24 = min(max(u_xlat24, 0.0), 1.0);
