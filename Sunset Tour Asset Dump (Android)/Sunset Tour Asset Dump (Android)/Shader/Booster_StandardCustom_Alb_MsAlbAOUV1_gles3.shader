...
void main()
{
    ...
    u_xlat27 = inversesqrt(u_xlat27);
    u_xlat2.xyz = vec3(u_xlat27) * u_xlat2.xyz;
    u_xlat16_3.xy = texture(_MSA, vs_TEXCOORD0.xy).xy;
    ...
    u_xlat16_27 = texture(_MSA, vs_TEXCOORD0.zw).z;
...
void main()
{
    u_xlat16_0 = texture(_MSA, vs_TEXCOORD0.zw).z;
    ...
    u_xlat16_4.xy = texture(_MSA, vs_TEXCOORD0.xy).xy;
    ...
    u_xlat16_3 = texture(unity_SpecCube0, u_xlat3.xyz, u_xlat16_8.x);
    ...
    u_xlat16_22 = u_xlat16_22 * u_xlat16_22;
    u_xlat16_5 = (-u_xlat16_4.x) * 0.779083729 + 0.779083729;
    u_xlat16_12.x = (-u_xlat16_5) + 1.0;
    u_xlat16_12.x = u_xlat16_4.y + u_xlat16_12.x;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_6.xyz = u_xlat16_9.xyz * u_xlat16_11.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat16_33 = texture(_MSA, vs_TEXCOORD0.zw).z;
    ...
    u_xlat16_11 = u_xlat16_1.x * u_xlat16_11;
    u_xlat16_1.x = (-u_xlat16_4.x) * 0.779083729 + 0.779083729;
    ...
    u_xlat16_8.xyz = u_xlat16_3.xyz * u_xlat16_15.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
    u_xlat16_0.xyz = max(u_xlat16_0.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_24 = texture(_MSA, vs_TEXCOORD0.zw).z;
    u_xlat16_1.x = u_xlat16_24 + -1.0;
    u_xlat16_1.x = _Occlusion * u_xlat16_1.x + 1.0;
    ...
    u_xlat16_4.xyz = u_xlat16_0.xyz * u_xlat16_2.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_0.xy = texture(_MSA, vs_TEXCOORD0.xy).xy;
...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
    u_xlat16_0.xyz = max(u_xlat16_0.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_30 = texture(_MSA, vs_TEXCOORD0.zw).z;
    u_xlat16_1.x = u_xlat16_30 + -1.0;
    u_xlat16_1.x = _Occlusion * u_xlat16_1.x + 1.0;
    ...
    u_xlat16_7.xyz = u_xlat16_3.xyz * u_xlat16_14.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat16_1 = texture(_MSA, vs_TEXCOORD0.zw).z;
    u_xlat16_41 = u_xlat16_1 + -1.0;
...
void main()
{
    ...
    u_xlat16_3.x = texture(_MSA, vs_TEXCOORD0.zw).z;
    ...
    u_xlat36 = inversesqrt(u_xlat36);
    u_xlat4.xyz = vec3(u_xlat36) * u_xlat4.xyz;
    u_xlat16_5.xy = texture(_MSA, vs_TEXCOORD0.xy).xy;
    u_xlat6.z = (-u_xlat16_5.y) + 1.0;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_8.xyz = u_xlat16_4.xyz * u_xlat16_16.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat16_4.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat16_15.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_7.xyz = u_xlat16_4.xyz * u_xlat16_15.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat16_10.xy = texture(_MSA, vs_TEXCOORD0.xy).xy;
