...
void main()
{
    ...
    u_xlat16_13.xyz = texture(_BumpMap, vs_TEXCOORD1.xy).xyz;
...
void main()
{
    ...
    u_xlat16_3.x = texture(_TransparencyLM, vs_TEXCOORD0.zw).x;
...
#endif
    u_xlat0.xyz = vec3(u_xlat33) * u_xlat0.xyz + unity_FogColor.xyz;
    u_xlat16_1 = texture(_TransparencyLM, vs_TEXCOORD0.zw).x;
...
#endif
    u_xlat0.xyz = vec3(u_xlat36) * u_xlat16_0.xyz + unity_FogColor.xyz;
    u_xlat16_4.x = texture(_TransparencyLM, vs_TEXCOORD0.zw).x;
...
#endif
    u_xlat0.xyz = vec3(u_xlat33) * u_xlat0.xyz + unity_FogColor.xyz;
    u_xlat16_5.x = texture(_TransparencyLM, vs_TEXCOORD0.zw).x;
    u_xlat0.w = (-u_xlat16_5.x) + 1.0;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat16_2 = texture(_TransparencyLM, vs_TEXCOORD0.zw).x;
