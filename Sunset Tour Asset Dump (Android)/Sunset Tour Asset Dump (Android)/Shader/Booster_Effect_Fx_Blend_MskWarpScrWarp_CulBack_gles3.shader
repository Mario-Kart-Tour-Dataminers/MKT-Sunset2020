...
uniform mediump sampler2D _WarpTexture;
...
void main()
{
    ...
    u_xlat16_1.xyz = texture(_WarpTexture, u_xlat2.xy).xyz;
    u_xlat16_2.xy = u_xlat16_1.xy + vec2(-0.5, -0.5);
    u_xlat16_1.x = u_xlat16_1.z * _WarpScale;
