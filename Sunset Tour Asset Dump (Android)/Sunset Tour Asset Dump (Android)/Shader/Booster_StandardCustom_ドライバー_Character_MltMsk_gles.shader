...
void main()
{
    ...
    u_xlat16_8.xyz = u_xlat16_1.xyz * u_xlat10_4.xyz + _AddColor.xyz;
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat10_11.xyz * _SphereMapScale.xyz;
    u_xlat16_11.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_2.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_8.xyz = u_xlat16_11.xyz * u_xlat10_2.xyz + _AddColor.xyz;
    u_xlat10_11.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    u_xlat16_7.xyz = u_xlat16_7.xyz * u_xlat10_11.xyz + u_xlat16_8.xyz;
    u_xlat16_8.xyz = u_xlat16_7.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat10_0.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    u_xlat16_2.xyz = u_xlat16_3.xyz * u_xlat10_0.xyz + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_3.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_8.xyz = u_xlat16_1.xyz * u_xlat10_3.xyz + _AddColor.xyz;
    u_xlat10_1.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    u_xlat16_7.xyz = u_xlat16_7.xyz * u_xlat10_1.xyz + u_xlat16_8.xyz;
    u_xlat16_8.xyz = u_xlat16_7.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_8.xyz = u_xlat16_2.xxx * u_xlat16_8.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
...
void main()
{
    ...
    u_xlat16_1.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_3.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_7.xyz = u_xlat16_1.xyz * u_xlat10_3.xyz + _AddColor.xyz;
    u_xlat10_1.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
...
void main()
{
    ...
    u_xlat1.x = texture2D(unity_NHxRoughness, u_xlat5.xz).x;
    u_xlat1.x = u_xlat1.x * 16.0;
    u_xlat16_13 = (-u_xlat12) + 1.0;
    u_xlat16_12 = u_xlat16_13 * u_xlat16_13;
    ...
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
    u_xlat16_0.xyz = max(u_xlat16_0.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_9.xyz = vec3(u_xlat16_24) * u_xlat16_0.xyz;
    u_xlat16_10.xyz = u_xlat16_2.xxx * u_xlat16_7.xyz;
    u_xlat16_6.xyz = u_xlat16_9.xyz * u_xlat16_10.xyz + u_xlat16_6.xyz;
...
void main()
{
    ...
    u_xlat16_26 = u_xlat16_26 * 2.0 + -1.0;
    u_xlat16_2.xyw = (-u_xlat16_7.xyz) * u_xlat16_2.xxx + vec3(u_xlat16_14);
    u_xlat16_2.xyz = abs(vec3(u_xlat16_26)) * u_xlat16_2.xyw + u_xlat16_9.xyz;
    u_xlat16_0.xyz = u_xlat16_6.xyz * u_xlat16_2.xyz + (-unity_FogColor.xyz);
    u_xlat36 = vs_TEXCOORD4.y;
    u_xlat36 = clamp(u_xlat36, 0.0, 1.0);
    u_xlat0.xyz = vec3(u_xlat36) * u_xlat16_0.xyz + unity_FogColor.xyz;
...
void main()
{
    ...
    u_xlat16_0.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_1.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_5.xyz = u_xlat16_0.xyz * u_xlat10_1.xyz + _AddColor.xyz;
    u_xlat10_0.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
...
void main()
{
    ...
    u_xlat1.x = u_xlat1.x * 16.0;
    u_xlat16_14 = (-u_xlat13) + 1.0;
    u_xlat16_13.x = u_xlat16_14 * u_xlat16_14;
    u_xlat16_13.x = u_xlat16_14 * u_xlat16_13.x;
    u_xlat16_13.x = u_xlat16_14 * u_xlat16_13.x;
    ...
    u_xlat13 = dot(u_xlat0.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat13 = clamp(u_xlat13, 0.0, 1.0);
    u_xlat16_10.xyz = vec3(u_xlat13) * _LightColor0.xyz;
    u_xlat0.w = 1.0;
    ...
    u_xlat16_9.xyz = unity_Lightmap_HDR.xxx * u_xlat16_13.xyz + u_xlat16_0.xyz;
    u_xlat16_9.xyz = vec3(u_xlat16_26) * u_xlat16_9.xyz;
    u_xlat16_11.xyz = u_xlat16_2.xxx * u_xlat16_7.xyz;
    u_xlat16_6.xyz = u_xlat16_9.xyz * u_xlat16_11.xyz + u_xlat16_6.xyz;
    u_xlat16_8.xyz = u_xlat1.xxx * u_xlat16_8.xyz + u_xlat16_11.xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_5.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_8.xyz = u_xlat16_1.xyz * u_xlat10_5.xyz + _AddColor.xyz;
    u_xlat10_1.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    u_xlat16_7.xyz = u_xlat16_7.xyz * u_xlat10_1.xyz + u_xlat16_8.xyz;
...
void main()
{
    ...
    u_xlat16_22 = u_xlat16_13 * u_xlat16_22;
    u_xlat16_22 = u_xlat16_13 * u_xlat16_22;
    ...
    u_xlat16_13 = dot(u_xlat10_1, unity_OcclusionMaskSelector);
    u_xlat16_13 = clamp(u_xlat16_13, 0.0, 1.0);
    u_xlat16_10.xyz = vec3(u_xlat16_13) * _LightColor0.xyz;
...
void main()
{
    ...
    u_xlat10_1.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_5.xyz = u_xlat16_7.xyz * u_xlat10_1.xyz + _AddColor.xyz;
    u_xlat10_7.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
...
void main()
{
    ...
    u_xlat16_8 = u_xlat16_1.x * u_xlat16_1.x + 1.5;
    ...
    u_xlat16_3.xyz = u_xlat10_1.xyz * _SphereMapScale.xyz;
    u_xlat16_1.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_4.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_5.xyz = u_xlat16_1.xyz * u_xlat10_4.xyz + _AddColor.xyz;
    u_xlat10_1.xyz = texture2D(_SphereMapMask, vs_TEXCOORD1.zw).xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat10_1.xyz + u_xlat16_5.xyz;
    u_xlat16_5.xyz = u_xlat16_3.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
