...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/透過/Fade_Msk_NoPS" {
Properties {
...
void main()
{
    ...
    u_xlat16_6.xyz = u_xlat16_0.xyz * vec3(u_xlat16_28) + u_xlat16_6.xyz;
    SV_Target0.xyz = u_xlat16_6.xyz * u_xlat16_5.xyz + u_xlat16_4.xyz;
    u_xlat16_0.x = texture(_TransparencyLM, vs_TEXCOORD0.xy).x;
...
void main()
{
    ...
    u_xlat0.xyw = u_xlat16_1.xyz * vec3(u_xlat16_6) + u_xlat0.xyw;
    u_xlat0.xyw = u_xlat0.xyw * _LightColor0.xyz;
    u_xlat0.xyz = u_xlat0.xyw * vec3(u_xlat16) + u_xlat16_5.xyz;
    u_xlat16_1.x = texture(_TransparencyLM, vs_TEXCOORD0.xy).x;
    u_xlat0.w = (-u_xlat16_1.x) + 1.0;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat16_3 = texture(_TransparencyLM, vs_TEXCOORD0.xy).x;
    u_xlat0.w = (-u_xlat16_3) + 1.0;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat16_8.xyz = vec3(u_xlat16_28) * u_xlat16_9.xyz;
...
void main()
{
    ...
    u_xlat16_6.xyz = u_xlat16_9.xyz * vec3(u_xlat16_32);
...
void main()
{
    ...
    u_xlat16_2.xyz = vs_TEXCOORD1.xyz * (-vec3(u_xlat16_22)) + (-u_xlat0.xyz);
    u_xlat16_2 = texture(_HeuristicReflection, u_xlat16_2.xyz);
    ...
    u_xlat16_24 = (-u_xlat16_22) + _Smoothness;
...
void main()
{
    ...
    u_xlat16_23 = u_xlat16_24 * u_xlat16_10;
    ...
    u_xlat16_5.xyz = _Color.xyz * vs_COLOR0.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_5.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_5.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat3.xyz = vec3(u_xlat21) * u_xlat16_5.xyz + u_xlat16_2.xyz;
    u_xlat16_6 = texture(unity_ShadowMask, vs_TEXCOORD5.xy);
    u_xlat16_2.x = dot(u_xlat16_6, unity_OcclusionMaskSelector);
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_9.xyz = vec3(u_xlat16_22) + (-u_xlat16_5.xyz);
    u_xlat16_2.xyz = u_xlat16_2.xxx * u_xlat16_9.xyz + u_xlat16_5.xyz;
    u_xlat0.xyz = u_xlat16_1.xyz * u_xlat16_2.xyz + u_xlat3.xyz;
    u_xlat16_3 = texture(_TransparencyLM, vs_TEXCOORD0.xy).x;
    u_xlat0.w = (-u_xlat16_3) + 1.0;
    SV_Target0 = u_xlat0;
...
void main()
{
    ...
    u_xlat16_8 = u_xlat16_25 * u_xlat16_8;
    u_xlat16_25 = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_29 = (-u_xlat16_25) + _Smoothness;
    u_xlat16_29 = u_xlat16_29 + 1.0;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_29 = min(max(u_xlat16_29, 0.0), 1.0);
#else
...
void main()
{
    ...
    u_xlat16_5.xyz = _Color.xyz * vs_COLOR0.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_5.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_5.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat1.xyz = vec3(u_xlat24) * u_xlat16_5.xyz + u_xlat16_4.xyz;
    ...
    u_xlat25 = clamp(u_xlat25, 0.0, 1.0);
#endif
    u_xlat16_19 = (-u_xlat25) + 1.0;
    u_xlat16_19 = u_xlat16_19 * u_xlat16_19;
    u_xlat16_19 = u_xlat16_19 * u_xlat16_19;
    u_xlat1.xyz = u_xlat1.xyz * vec3(u_xlat24) + u_xlat16_4.xyz;
    u_xlat16_27 = dot((-u_xlat0.xyz), vs_TEXCOORD1.xyz);
    u_xlat16_27 = u_xlat16_27 + u_xlat16_27;
    u_xlat16_4.xyz = vs_TEXCOORD1.xyz * (-vec3(u_xlat16_27)) + (-u_xlat0.xyz);
    ...
    u_xlat16_3.xyw = vec3(u_xlat16_11) + (-u_xlat16_5.xyz);
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat16_7.xyz * vec3(_Occlusion);
    u_xlat16_9.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat16_8.xyz = vec3(u_xlat16_31) * u_xlat16_9.xyz;
...
void main()
{
    ...
    u_xlat16_3.x = texture(_TransparencyLM, vs_TEXCOORD0.xy).x;
...
void main()
{
    ...
    u_xlat16_2.xyz = vec3(u_xlat16_21) * u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat16_7.xyz = _Color.xyz * vs_COLOR0.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_7.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_8.xyz = vec3(u_xlat16_29) + (-u_xlat16_7.xyz);
    u_xlat16_8.xyz = u_xlat16_12.xxx * u_xlat16_8.xyz + u_xlat16_7.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_8.xyz;
    u_xlat16_12.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat16_8.xyz = vec3(u_xlat16_27) * u_xlat16_12.xyz;
...
void main()
{
    ...
    u_xlat16_6.xyz = u_xlat16_11.xyz * vec3(u_xlat16_38);
    ...
    u_xlat16_8.xyz = unity_Lightmap_HDR.xxx * u_xlat16_10.xyz + u_xlat16_4.xyz;
    u_xlat16_8.xyz = u_xlat16_8.xyz * vec3(_Occlusion);
    u_xlat16_6.xyz = u_xlat16_6.xyz * u_xlat16_8.xyz;
    ...
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
#endif
    u_xlat16_39 = (-u_xlat1) + 1.0;
    u_xlat16_39 = u_xlat16_39 * u_xlat16_39;
    u_xlat16_39 = u_xlat16_39 * u_xlat16_39;
    u_xlat0.xyz = u_xlat0.xyz * vec3(u_xlat33) + u_xlat16_6.xyz;
    u_xlat16_6.xyz = vec3(u_xlat16_38) + (-u_xlat16_7.xyz);
...
void main()
{
    ...
    u_xlat16_11.xyz = u_xlat16_2.xyz * u_xlat16_4.xxx;
    ...
    u_xlat16_5.xyz = _Color.xyz * vs_COLOR0.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_5.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_5.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat2.xyz = vec3(u_xlat21) * u_xlat16_5.xyz + u_xlat16_11.xyz;
    ...
    u_xlat21 = clamp(u_xlat21, 0.0, 1.0);
#endif
    u_xlat23 = dot(u_xlat3.xyz, u_xlat0.xyz);
#ifdef UNITY_ADRENO_ES3
    u_xlat23 = min(max(u_xlat23, 0.0), 1.0);
#else
    u_xlat23 = clamp(u_xlat23, 0.0, 1.0);
#endif
    u_xlat16_11.x = (-u_xlat23) + 1.0;
    ...
    u_xlat16_4.xyz = u_xlat16_11.xxx * u_xlat16_4.xzw + u_xlat16_5.xyz;
    u_xlat0.xyz = u_xlat16_1.xyz * u_xlat16_4.xyz + u_xlat2.xyz;
    u_xlat16_2.x = texture(_TransparencyLM, vs_TEXCOORD0.xy).x;
...
void main()
{
...
#endif
    u_xlat16_13.xyz = _Color.xyz * vs_COLOR0.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    ...
    u_xlat16_6.xyz = vec3(u_xlat16_8) * u_xlat16_6.xyz + u_xlat16_13.xyz;
    ...
    u_xlat16_5.xyz = u_xlat0.xxx * u_xlat16_13.xyz + u_xlat16_7.xyz;
    u_xlat16_1 = texture(unity_ShadowMask, vs_TEXCOORD5.xy);
...
void main()
{
    ...
    u_xlat16_10 = u_xlat16_21 * u_xlat16_10;
    u_xlat16_21 = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_23 = (-u_xlat16_21) + _Smoothness;
...
void main()
{
    ...
    u_xlat16_0.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat16_5.xyz = u_xlat16_0.xyz * vec3(u_xlat16_23) + u_xlat16_5.xyz;
    SV_Target0.xyz = u_xlat16_5.xyz * u_xlat16_4.xyz + u_xlat16_2.xyz;
    u_xlat16_0.x = texture(_TransparencyLM, vs_TEXCOORD0.xy).x;
    u_xlat16_0.x = (-u_xlat16_0.x) + 1.0;
    SV_Target0.w = u_xlat16_0.x;
...
void main()
{
    ...
    u_xlat16_2 = texture(_TransparencyLM, vs_TEXCOORD0.xy).x;
    u_xlat0.w = (-u_xlat16_2) + 1.0;
    SV_Target0 = u_xlat0;
    return;
}
...
#endif
    u_xlat0.xyz = vec3(u_xlat24) * u_xlat16_0.xyz + unity_FogColor.xyz;
    u_xlat16_4.x = texture(_TransparencyLM, vs_TEXCOORD0.xy).x;
    u_xlat0.w = (-u_xlat16_4.x) + 1.0;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat27 = clamp(u_xlat27, 0.0, 1.0);
#endif
    u_xlat0.xyz = vec3(u_xlat27) * u_xlat16_3.xyz + unity_FogColor.xyz;
    u_xlat16_3.x = texture(_TransparencyLM, vs_TEXCOORD0.xy).x;
    u_xlat0.w = (-u_xlat16_3.x) + 1.0;
    SV_Target0 = u_xlat0;
    return;
...
void main()
{
    ...
    u_xlat24 = clamp(u_xlat24, 0.0, 1.0);
#endif
    u_xlat0.xyz = vec3(u_xlat24) * u_xlat3.xyz + unity_FogColor.xyz;
    u_xlat16_3.x = texture(_TransparencyLM, vs_TEXCOORD0.xy).x;
    u_xlat0.w = (-u_xlat16_3.x) + 1.0;
    SV_Target0 = u_xlat0;
    return;
...
void main()
{
    ...
    u_xlat24 = clamp(u_xlat24, 0.0, 1.0);
#endif
    u_xlat0.xyz = vec3(u_xlat24) * u_xlat16_3.xyz + unity_FogColor.xyz;
    u_xlat16_3.x = texture(_TransparencyLM, vs_TEXCOORD0.xy).x;
    u_xlat0.w = (-u_xlat16_3.x) + 1.0;
    SV_Target0 = u_xlat0;
    return;
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat16_0.xyz * vec3(u_xlat16_14) + u_xlat16_3.xyz;
