...
void main()
{
    ...
    u_xlat10_1 = texture2D(_TransparencyLM, u_xlat1.xy).x;
...
void main()
{
    ...
    u_xlat10_3 = texture2D(_TransparencyLM, u_xlat3.xy).x;
...
void main()
{
    ...
    vs_TEXCOORD2.w = max(u_xlat18, u_xlat16_5);
    vs_COLOR0 = in_COLOR0;
    vs_TEXCOORD5 = vec4(0.0, 0.0, 0.0, 0.0);
    return;
}
...
void main()
{
    ...
    u_xlat10_2 = texture2D(_TransparencyLM, u_xlat2.xy).x;
...
void main()
{
    ...
    u_xlat0.x = inversesqrt(u_xlat0.x);
    u_xlat1.xyz = u_xlat0.xxx * u_xlat3.xyz;
    u_xlat0.xyz = (bool(u_xlatb14)) ? u_xlat1.xyz : in_NORMAL0.xyz;
    u_xlat1.x = dot(u_xlat0.xyz, hlslcc_mtx4x4unity_WorldToObject[0].xyz);
    u_xlat1.y = dot(u_xlat0.xyz, hlslcc_mtx4x4unity_WorldToObject[1].xyz);
    u_xlat1.z = dot(u_xlat0.xyz, hlslcc_mtx4x4unity_WorldToObject[2].xyz);
    u_xlat0.x = dot(u_xlat1.xyz, u_xlat1.xyz);
    ...
    vs_TEXCOORD1.xyz = u_xlat0.xyz;
    u_xlat16_5 = (-unity_FogColor.w) + 1.0;
    vs_TEXCOORD2.w = max(u_xlat21, u_xlat16_5);
    vs_COLOR0 = in_COLOR0;
    u_xlat16_5 = u_xlat0.y * u_xlat0.y;
    u_xlat16_5 = u_xlat0.x * u_xlat0.x + (-u_xlat16_5);
    u_xlat16_0 = u_xlat0.yzzx * u_xlat0.xyzz;
