...
void main()
{
    ...
    u_xlat24 = inversesqrt(u_xlat24);
    u_xlat2.xyz = vec3(u_xlat24) * u_xlat2.xyz;
    u_xlat10_24 = texture2D(_MSA, vs_TEXCOORD0.zw).y;
    u_xlat3.z = (-u_xlat10_24) + 1.0;
...
void main()
{
    ...
    u_xlat10_0 = texture2D(_MSA, vs_TEXCOORD0.zw).y;
    u_xlat1 = (-u_xlat10_0) + 1.0;
    ...
    u_xlat16_14.x = u_xlat10_0 + u_xlat16_14.x;
...
void main()
{
    ...
    u_xlat30 = inversesqrt(u_xlat30);
    u_xlat3.xyz = vec3(u_xlat30) * u_xlat3.xyz;
    u_xlat10_30 = texture2D(_MSA, vs_TEXCOORD0.zw).y;
    u_xlat4.z = (-u_xlat10_30) + 1.0;
    ...
    u_xlat16_35 = u_xlat10_30 + u_xlat16_35;
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat16_4.xyz * u_xlat10_6.xyz;
    u_xlat16_8.xyz = u_xlat16_4.xyz * u_xlat10_6.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat27 = inversesqrt(u_xlat27);
    u_xlat3.xyz = vec3(u_xlat27) * u_xlat3.xyz;
    u_xlat10_27 = texture2D(_MSA, vs_TEXCOORD0.zw).y;
    u_xlat4.z = (-u_xlat10_27) + 1.0;
    ...
    u_xlat16_32 = u_xlat10_27 + u_xlat16_32;
    ...
    u_xlat16_28 = dot(u_xlat10_0, unity_OcclusionMaskSelector);
...
void main()
{
    ...
    u_xlat33 = inversesqrt(u_xlat33);
    u_xlat4.xyz = vec3(u_xlat33) * u_xlat4.xyz;
    u_xlat10_33 = texture2D(_MSA, vs_TEXCOORD0.zw).y;
    u_xlat5.z = (-u_xlat10_33) + 1.0;
    ...
    u_xlat16_32 = u_xlat16_32 + u_xlat10_33;
    u_xlat16_32 = clamp(u_xlat16_32, 0.0, 1.0);
    u_xlat16_4.xyz = vs_COLOR0.xyz * _Color.xyz;
...
void main()
{
    ...
    u_xlat16_44 = u_xlat10_0 + u_xlat16_44;
...
void main()
{
    ...
    u_xlat10_3.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_13.xyz = u_xlat16_10.xyz * u_xlat10_3.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_10.xyz = u_xlat16_10.xyz * u_xlat10_3.xyz;
...
void main()
{
    ...
    u_xlat16_29 = u_xlat16_29 + u_xlat10_30;
    u_xlat16_29 = clamp(u_xlat16_29, 0.0, 1.0);
    u_xlat16_13.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_5.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_6.xyz = u_xlat16_13.xyz * u_xlat10_5.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_13.xyz = u_xlat16_13.xyz * u_xlat10_5.xyz;
...
void main()
{
    ...
    u_xlat10_31 = texture2D(_MSA, vs_TEXCOORD0.zw).y;
    u_xlat5.x = (-u_xlat10_31) + 1.0;
    u_xlat16_27 = u_xlat16_27 + u_xlat10_31;
    u_xlat16_27 = clamp(u_xlat16_27, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat10_8 = texture2D(_MSA, vs_TEXCOORD0.zw).y;
    u_xlat0.y = (-u_xlat10_8) + 1.0;
...
void main()
{
    ...
    u_xlat10_1 = texture2D(_MSA, vs_TEXCOORD0.zw).y;
