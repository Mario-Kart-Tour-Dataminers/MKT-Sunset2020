...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/マシンパーツ/MachineParts_Wing_NoEmblem_Emission_Matcap_Msk" {
Properties {
...
void main()
{
    ...
    SV_Target0.w = u_xlat16_0 * _AlphaFactor;
    return;
}
...
void main()
{
    ...
    u_xlat16_3.xyz = max(u_xlat10_0.xyz, _MinMSA.xyz);
    ...
    u_xlat16_3.xyw = u_xlat10_0.xyz * u_xlat16_3.xxx;
...
void main()
{
    ...
    u_xlat5.x = min(u_xlat5.x, 100.0);
    u_xlat5.xyw = u_xlat5.xxx * u_xlat16_4.xyz + u_xlat16_7.xyz;
    u_xlat10_6 = texture2D(unity_ShadowMask, vs_TEXCOORD8.xy);
    u_xlat16_3.x = dot(u_xlat10_6, unity_OcclusionMaskSelector);
    u_xlat16_3.x = clamp(u_xlat16_3.x, 0.0, 1.0);
    u_xlat16_3.xyw = u_xlat16_3.xxx * _LightColor0.xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
    u_xlat16_1.xyz = max(u_xlat16_1.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_8.xyz = u_xlat16_5.zzz * u_xlat16_1.xyz;
    ...
    u_xlat16_5.xyw = u_xlat0.xyz * (-u_xlat16_5.xxx) + (-u_xlat2.xyz);
    ...
    u_xlat2.z = u_xlat0.x * u_xlat16_5.x;
    u_xlat0.x = u_xlat0.x * u_xlat16_5.w;
    u_xlat2.xy = (-u_xlat16_5.xy) * u_xlat16_5.yw;
    ...
    u_xlat16_5.x = (u_xlatb27) ? 0.0 : u_xlat19;
    ...
    u_xlat0.xyz = u_xlat16_5.xyz * u_xlat16_3.xyz + u_xlat1.xyw;
    u_xlat10_1.xyz = texture2D(_EmissionMap, vs_TEXCOORD2.xy).xyz;
    u_xlat16_1.xyz = u_xlat10_1.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
...
void main()
{
    ...
    u_xlat1.xyw = u_xlat1.xyw * u_xlat16_5.xyw;
    u_xlat29 = dot(u_xlat0.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat29 = clamp(u_xlat29, 0.0, 1.0);
    u_xlat1.xyw = u_xlat1.xyw * vec3(u_xlat29) + u_xlat16_8.xyz;
    u_xlat16_5.x = dot((-u_xlat2.xyz), u_xlat0.xyz);
...
void main()
{
    ...
    u_xlat16_27 = (-u_xlat16_6.x) * 0.779083729 + 0.779083729;
    u_xlat16_3.xyz = vec3(u_xlat16_27) * u_xlat16_3.xyz;
    u_xlat16_27 = (-u_xlat16_27) + u_xlat16_6.y;
    ...
    u_xlat1.x = dot(u_xlat2.xyz, u_xlat2.xyz);
    u_xlat1.x = inversesqrt(u_xlat1.x);
    u_xlat9.xyz = u_xlat2.xyz * u_xlat1.xxx + _WorldSpaceLightPos0.xyz;
    u_xlat2.xyz = u_xlat1.xxx * u_xlat2.xyz;
    ...
    u_xlat17 = (-u_xlat16_6.y) + 1.0;
    u_xlat25 = u_xlat17 * u_xlat17;
    u_xlat26 = u_xlat25 * u_xlat25 + -1.0;
    u_xlat9.x = u_xlat9.x * u_xlat26 + 1.00001001;
    u_xlat26 = u_xlat17 * u_xlat17 + 1.5;
    u_xlat1.x = u_xlat1.x * u_xlat26;
    u_xlat1.x = u_xlat9.x * u_xlat1.x;
    u_xlat1.x = u_xlat25 / u_xlat1.x;
    u_xlat16_27 = u_xlat17 * u_xlat25;
    u_xlat16_27 = (-u_xlat16_27) * 0.280000001 + 1.0;
    u_xlat1.x = u_xlat1.x + -9.99999975e-05;
    u_xlat1.x = max(u_xlat1.x, 0.0);
    u_xlat1.x = min(u_xlat1.x, 100.0);
    u_xlat1.xyw = u_xlat1.xxx * u_xlat16_5.xyz + u_xlat16_3.xyz;
    u_xlat1.xyw = u_xlat1.xyw * _LightColor0.xyz;
    u_xlat16_4.xyz = texture2D(unity_Lightmap, vs_TEXCOORD6.xy).xyz;
    u_xlat16_6.xyw = u_xlat16_4.xyz * unity_Lightmap_HDR.xxx;
    ...
    u_xlat26 = clamp(u_xlat26, 0.0, 1.0);
    u_xlat1.xyw = u_xlat1.xyw * vec3(u_xlat26) + u_xlat16_3.xyz;
    ...
    u_xlat2.z = u_xlat0.x * u_xlat16_3.x;
    ...
    u_xlat24 = inversesqrt(u_xlat24);
    u_xlat0.xyz = vec3(u_xlat24) * u_xlat0.xyz;
    u_xlatb24 = u_xlat17<0.00499999989;
    u_xlat17 = u_xlat17 * 8.29800034;
    u_xlat16_3.x = (u_xlatb24) ? 0.0 : u_xlat17;
    u_xlat10_0 = textureCube(unity_SpecCube0, u_xlat0.xyz, u_xlat16_3.x);
    u_xlat16_3.x = u_xlat10_0.w + -1.0;
    u_xlat16_3.x = unity_SpecCube0_HDR.w * u_xlat16_3.x + 1.0;
    u_xlat16_3.x = u_xlat16_3.x * unity_SpecCube0_HDR.x;
    ...
    u_xlat0.xyz = u_xlat16_3.xyz * u_xlat16_5.xyz + u_xlat1.xyw;
    u_xlat10_1.xyz = texture2D(_EmissionMap, vs_TEXCOORD2.xy).xyz;
    u_xlat16_1.xyz = u_xlat10_1.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_3.xyz = u_xlat16_1.xyz * vec3(_EmissionIntensity) + u_xlat0.xyz;
    u_xlat16_0.xyz = u_xlat16_3.xyz + (-unity_FogColor.xyz);
    u_xlat24 = vs_TEXCOORD5.y;
...
void main()
{
    ...
    u_xlat2.x = max(u_xlat2.x, 0.0);
    u_xlat2.x = min(u_xlat2.x, 100.0);
    u_xlat2.xyw = u_xlat2.xxx * u_xlat16_6.xyz + u_xlat16_4.xyz;
    ...
    u_xlat16_1.x = (u_xlatb27) ? 0.0 : u_xlat20;
    u_xlat10_0 = textureCube(unity_SpecCube0, u_xlat0.xyz, u_xlat16_1.x);
    u_xlat16_1.x = u_xlat10_0.w + -1.0;
    u_xlat16_1.x = unity_SpecCube0_HDR.w * u_xlat16_1.x + 1.0;
    u_xlat16_1.x = u_xlat16_1.x * unity_SpecCube0_HDR.x;
...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
    u_xlat16_0.xyz = max(u_xlat16_0.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_13.xyz = texture2D(unity_Lightmap, vs_TEXCOORD6.xy).xyz;
