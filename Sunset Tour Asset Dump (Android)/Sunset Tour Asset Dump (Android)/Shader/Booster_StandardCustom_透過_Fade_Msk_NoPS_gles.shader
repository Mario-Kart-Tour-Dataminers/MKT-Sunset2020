...
void main()
{
    ...
    u_xlat10_3 = texture2D(_TransparencyLM, vs_TEXCOORD0.xy).x;
    u_xlat0.w = (-u_xlat10_3) + 1.0;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat10_6 = texture2D(unity_ShadowMask, vs_TEXCOORD5.xy);
    u_xlat16_2.x = dot(u_xlat10_6, unity_OcclusionMaskSelector);
...
void main()
{
    ...
    u_xlat10_2 = textureCube(unity_SpecCube0, u_xlat3.xyz, u_xlat16_25);
    u_xlat16_25 = u_xlat10_2.w + -1.0;
    u_xlat16_25 = unity_SpecCube0_HDR.w * u_xlat16_25 + 1.0;
    u_xlat16_25 = u_xlat16_25 * unity_SpecCube0_HDR.x;
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat10_0.xyz * vec3(u_xlat16_27);
    u_xlat16_4.xyz = u_xlat16_4.xyz * vec3(_Occlusion);
...
void main()
{
    ...
    u_xlat10_2 = texture2D(_TransparencyLM, vs_TEXCOORD0.xy).x;
    u_xlat0.w = (-u_xlat10_2) + 1.0;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat10_1 = textureCube(unity_SpecCube0, u_xlat4.xyz, u_xlat16_24);
    u_xlat16_24 = u_xlat10_1.w + -1.0;
    u_xlat16_24 = unity_SpecCube0_HDR.w * u_xlat16_24 + 1.0;
    u_xlat16_24 = u_xlat16_24 * unity_SpecCube0_HDR.x;
    u_xlat16_2.xyz = u_xlat10_1.xyz * vec3(u_xlat16_24);
...
void main()
{
    ...
    u_xlat24 = clamp(u_xlat24, 0.0, 1.0);
    u_xlat0.xyz = vec3(u_xlat24) * u_xlat16_0.xyz + unity_FogColor.xyz;
    u_xlat10_4 = texture2D(_TransparencyLM, vs_TEXCOORD0.xy).x;
    u_xlat0.w = (-u_xlat10_4) + 1.0;
    SV_Target0 = u_xlat0;
    return;
}
