...
void main()
{
    ...
    u_xlat16_10 = u_xlat16_4 * u_xlat16_4 + 1.5;
    ...
    u_xlat16_9 = u_xlat16_4 * u_xlat16_4;
    u_xlat16_20 = u_xlat16_4 * u_xlat16_9;
...
void main()
{
    ...
    u_xlat16_33 = dot(u_xlat10_4, unity_OcclusionMaskSelector);
    u_xlat16_33 = clamp(u_xlat16_33, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat10_3 = textureCube(_HeuristicReflection, u_xlat16_0.xyz);
    u_xlat16_0.x = u_xlat10_3.w + -1.0;
...
void main()
{
    ...
    u_xlat0.xyz = u_xlat0.xxx * u_xlat16_6.xyz + u_xlat16_7.xyz;
    u_xlat10_4 = texture2D(unity_ShadowMask, vs_TEXCOORD4.xy);
    u_xlat16_42 = dot(u_xlat10_4, unity_OcclusionMaskSelector);
...
void main()
{
    ...
    u_xlat16_6 = u_xlat16_6 * u_xlat16_6;
    u_xlat10_2 = textureCube(_HeuristicReflection, u_xlat16_12.xyz);
