...
void main()
{
    ...
    u_xlat16_7.xyz = _Color.xyz * u_xlat10_9.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat10_2.xyz * vec3(u_xlat16_27);
    ...
    u_xlat1.xyz = u_xlat4.xyz * (-vec3(u_xlat28)) + u_xlat1.xyz;
    u_xlat28 = dot(u_xlat4.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat28 = clamp(u_xlat28, 0.0, 1.0);
    u_xlat16_5.xyz = vec3(u_xlat28) * _LightColor0.xyz;
    ...
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_8.xyz = vec3(u_xlat16_30) + (-u_xlat16_6.xyz);
    u_xlat16_8.xyz = vec3(u_xlat16_10) * u_xlat16_8.xyz + u_xlat16_6.xyz;
    ...
    u_xlat16_3.xyz = u_xlat1.xxx * u_xlat16_6.xyz + u_xlat16_7.xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = vec3(u_xlat16_21) * u_xlat16_2.xyz;
    ...
    u_xlat22 = u_xlat16_9 / u_xlat22;
    u_xlat22 = u_xlat22 + -9.99999975e-05;
    u_xlat22 = max(u_xlat22, 0.0);
    u_xlat22 = min(u_xlat22, 100.0);
    u_xlat2.xyz = vec3(u_xlat22) * u_xlat16_3.xyz + u_xlat16_4.xyz;
    ...
    u_xlat2.xyz = u_xlat2.xyz * vec3(u_xlat22) + u_xlat16_0.xyz;
    u_xlat16_0.x = dot((-u_xlat1.xyz), vs_TEXCOORD1.xyz);
    u_xlat16_0.x = u_xlat16_0.x + u_xlat16_0.x;
    u_xlat16_0.xyz = vs_TEXCOORD1.xyz * (-u_xlat16_0.xxx) + (-u_xlat1.xyz);
    ...
    u_xlat1.xyz = u_xlat16_0.xyz * u_xlat16_3.xyz + u_xlat2.xyz;
...
void main()
{
    ...
    u_xlat10_2 = textureCube(unity_SpecCube0, u_xlat3.xyz, u_xlat16_30);
    ...
    u_xlat16_8.xyz = vec3(u_xlat16_30) * u_xlat16_3.xyz;
    u_xlat16_7.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_9.xyz = vec3(u_xlat16_35) + (-u_xlat16_7.xyz);
    u_xlat16_9.xyz = vec3(u_xlat16_11) * u_xlat16_9.xyz + u_xlat16_7.xyz;
    u_xlat16_7.xyz = u_xlat1.xxx * u_xlat16_7.xyz + u_xlat16_8.xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat16_9.xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat16_8.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat10_10.xyz * _Color.xyz;
...
void main()
{
    ...
    u_xlat16_24 = dot((-u_xlat1.xyz), vs_TEXCOORD1.xyz);
    u_xlat16_24 = u_xlat16_24 + u_xlat16_24;
    u_xlat16_2.xyz = vs_TEXCOORD1.xyz * (-vec3(u_xlat16_24)) + (-u_xlat1.xyz);
    u_xlat10_2 = textureCube(_HeuristicReflection, u_xlat16_2.xyz);
    ...
    u_xlat16_3.xyz = u_xlat10_2.xyz * vec3(u_xlat16_24);
    u_xlat16_3.xyz = u_xlat16_3.xyz * vec3(_Occlusion);
    ...
    u_xlat16_7.xyz = vec3(u_xlat16_27) + (-u_xlat16_5.xyz);
    ...
    u_xlat16_3.xyz = vec3(u_xlat16_24) * _LightColor0.xyz;
    u_xlat16_3.xyz = vec3(u_xlat25) * u_xlat16_3.xyz;
    u_xlat1.z = (-_Smoothness) + 1.0;
    u_xlat1.x = texture2D(unity_NHxRoughness, u_xlat1.xz).x;
    u_xlat1.x = u_xlat1.x * 16.0;
    u_xlat16_5.xyz = u_xlat1.xxx * u_xlat16_5.xyz + u_xlat16_6.xyz;
    SV_Target0.xyz = u_xlat16_5.xyz * u_xlat16_3.xyz + u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat16_4.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
    u_xlat16_4.xyz = max(u_xlat16_4.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_1.xyz = u_xlat16_4.xyz * vec3(_Occlusion);
...
void main()
{
    ...
    u_xlat10_2 = textureCube(unity_SpecCube0, u_xlat3.xyz, u_xlat16_27);
    u_xlat16_27 = u_xlat10_2.w + -1.0;
    u_xlat16_27 = unity_SpecCube0_HDR.w * u_xlat16_27 + 1.0;
    u_xlat16_27 = u_xlat16_27 * unity_SpecCube0_HDR.x;
...
void main()
{
    ...
    u_xlat16_24 = dot((-u_xlat1.xyz), vs_TEXCOORD1.xyz);
    u_xlat16_24 = u_xlat16_24 + u_xlat16_24;
    u_xlat16_3.xyz = vs_TEXCOORD1.xyz * (-vec3(u_xlat16_24)) + (-u_xlat1.xyz);
    u_xlat10_2 = textureCube(_HeuristicReflection, u_xlat16_3.xyz);
    u_xlat16_24 = u_xlat10_2.w + -1.0;
    u_xlat16_24 = unity_SpecCube0_HDR.w * u_xlat16_24 + 1.0;
    u_xlat16_24 = u_xlat16_24 * unity_SpecCube0_HDR.x;
    u_xlat16_3.xyz = u_xlat10_2.xyz * vec3(u_xlat16_24);
    ...
    u_xlat26 = clamp(u_xlat26, 0.0, 1.0);
    u_xlat25 = u_xlat25 + u_xlat25;
    u_xlat1.xyz = u_xlat2.xyz * (-vec3(u_xlat25)) + u_xlat1.xyz;
    ...
    u_xlat1.x = texture2D(unity_NHxRoughness, u_xlat1.xz).x;
    u_xlat1.x = u_xlat1.x * 16.0;
    u_xlat16_3.xyz = u_xlat1.xxx * u_xlat16_5.xyz + u_xlat16_6.xyz;
...
void main()
{
    ...
    u_xlat10_2 = textureCube(unity_SpecCube0, u_xlat2.xyz, u_xlat16_27);
    u_xlat16_27 = u_xlat10_2.w + -1.0;
    u_xlat16_27 = unity_SpecCube0_HDR.w * u_xlat16_27 + 1.0;
    u_xlat16_27 = u_xlat16_27 * unity_SpecCube0_HDR.x;
    u_xlat16_3.xyz = u_xlat10_2.xyz * vec3(u_xlat16_27);
    ...
    u_xlat16_6.xyz = _Color.xyz * u_xlat10_2.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_2.xyz = u_xlat10_2.xyz * _Color.xyz;
    u_xlat16_7.xyz = vec3(u_xlat16_27) * u_xlat16_2.xyz;
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_8.xyz = vec3(u_xlat16_30) + (-u_xlat16_6.xyz);
    u_xlat16_8.xyz = vec3(u_xlat16_10) * u_xlat16_8.xyz + u_xlat16_6.xyz;
    u_xlat16_6.xyz = u_xlat1.xxx * u_xlat16_6.xyz + u_xlat16_7.xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat10_11.xyz * _Color.xyz;
    u_xlat16_6.xyz = _Color.xyz * u_xlat10_11.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
...
void main()
{
    ...
    u_xlat16_5.x = clamp(u_xlat16_5.x, 0.0, 1.0);
    u_xlat10_2.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_13.xyz = _Color.xyz * u_xlat10_2.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_2.xyz = u_xlat10_2.xyz * _Color.xyz;
...
void main()
{
    ...
    u_xlat22 = inversesqrt(u_xlat22);
    u_xlat1.xyz = vec3(u_xlat22) * u_xlat1.xyz;
    u_xlat16_21 = dot((-u_xlat1.xyz), vs_TEXCOORD1.xyz);
    u_xlat16_21 = u_xlat16_21 + u_xlat16_21;
    u_xlat16_3.xyz = vs_TEXCOORD1.xyz * (-vec3(u_xlat16_21)) + (-u_xlat1.xyz);
    u_xlat10_2 = textureCube(_HeuristicReflection, u_xlat16_3.xyz);
    ...
    u_xlat16_3.xyz = u_xlat10_2.xyz * vec3(u_xlat16_21);
    u_xlat16_3.xyz = u_xlat16_3.xyz * vec3(_Occlusion);
    ...
    u_xlat16_3.xyz = vec3(u_xlat22) * u_xlat16_3.xyz;
    u_xlat1.z = (-_Smoothness) + 1.0;
    u_xlat1.x = texture2D(unity_NHxRoughness, u_xlat1.xz).x;
    u_xlat1.x = u_xlat1.x * 16.0;
...
void main()
{
    ...
    u_xlat16_3.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_3.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_24 = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_4.xyz = vec3(u_xlat16_24) * u_xlat16_2.xyz;
    ...
    u_xlat2.xyz = vec3(u_xlat25) * u_xlat16_3.xyz + u_xlat16_4.xyz;
    ...
    u_xlat2.xyz = u_xlat2.xyz * vec3(u_xlat25) + u_xlat16_0.xyz;
    u_xlat16_0.x = dot((-u_xlat1.xyz), vs_TEXCOORD1.xyz);
    u_xlat16_0.x = u_xlat16_0.x + u_xlat16_0.x;
    u_xlat16_0.xyz = vs_TEXCOORD1.xyz * (-u_xlat16_0.xxx) + (-u_xlat1.xyz);
    u_xlat10_1 = textureCube(_HeuristicReflection, u_xlat16_0.xyz);
...
void main()
{
    ...
    u_xlat25 = (u_xlatb25) ? u_xlat16_3.z : (-u_xlat16_3.z);
    u_xlat2.z = u_xlat25 * u_xlat16_3.x;
    u_xlat4.x = u_xlat25 * u_xlat16_3.z;
    u_xlat2.xy = (-u_xlat16_3.xy) * u_xlat16_3.yz;
    u_xlat4.yz = (-u_xlat16_3.xy) * u_xlat16_3.xy;
    u_xlat2.xyz = u_xlat2.xyz + (-u_xlat4.xyz);
    u_xlat25 = dot(u_xlat2.xyz, u_xlat2.xyz);
    ...
    u_xlat2.xyz = vec3(u_xlat25) * u_xlat2.xyz;
    u_xlat2.xyz = u_xlat2.xyz * vec3(_NormalDiff);
    u_xlat25 = dot(vs_TEXCOORD2.xyz, _NormalRand.xyz);
    u_xlat25 = sin(u_xlat25);
    u_xlat25 = u_xlat25 * _NormalRand.w;
    u_xlat25 = fract(u_xlat25);
    u_xlat2.xyz = u_xlat2.xyz * vec3(u_xlat25) + u_xlat16_3.xyz;
    u_xlat25 = dot(u_xlat2.xyz, u_xlat2.xyz);
    u_xlat25 = inversesqrt(u_xlat25);
    u_xlat2.xyz = vec3(u_xlat25) * u_xlat2.xyz;
    u_xlat4.z = (-_Smoothness) + 1.0;
    ...
    u_xlat16_24 = (u_xlatb25) ? 0.0 : u_xlat26;
    u_xlat10_2 = textureCube(unity_SpecCube0, u_xlat2.xyz, u_xlat16_24);
    u_xlat16_24 = u_xlat10_2.w + -1.0;
    u_xlat16_24 = unity_SpecCube0_HDR.w * u_xlat16_24 + 1.0;
    u_xlat16_24 = u_xlat16_24 * unity_SpecCube0_HDR.x;
    u_xlat16_3.xyz = u_xlat10_2.xyz * vec3(u_xlat16_24);
...
void main()
{
    ...
    u_xlat16_5.xyz = u_xlat16_3.xyz * vec3(u_xlat16_23) + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat4.xyz = vec3(u_xlat21) * u_xlat16_10.xyz;
    u_xlat16_5.x = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat1.xyz = u_xlat16_1.xyz * u_xlat16_5.xxx + u_xlat4.xyz;
    u_xlat16_5.x = (-u_xlat16_5.x) + _Smoothness;
    u_xlat16_5.x = u_xlat16_5.x + 1.0;
    u_xlat16_5.x = clamp(u_xlat16_5.x, 0.0, 1.0);
    ...
    u_xlat16_26 = u_xlat16_26 * u_xlat16_26;
    u_xlat16_26 = u_xlat16_26 * u_xlat16_26;
    u_xlat16_10.xyz = vec3(u_xlat16_26) * u_xlat16_5.xyz + u_xlat16_10.xyz;
...
void main()
{
    ...
    u_xlat22 = clamp(u_xlat22, 0.0, 1.0);
    u_xlat1.xyz = vec3(u_xlat22) * u_xlat1.xyz + unity_FogColor.xyz;
    SV_Target0.xyz = u_xlat1.xyz;
    SV_Target0.w = 1.0;
    return;
}
