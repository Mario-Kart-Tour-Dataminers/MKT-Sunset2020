...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/路面/RoadMultiply_AlbUV1" {
Properties {
...
uniform 	vec4 _CameraNearFogMap_ST;
...
void main()
{
    ...
    vs_TEXCOORD0.zw = in_TEXCOORD0.xy * _CameraNearFogMap_ST.xy + _CameraNearFogMap_ST.zw;
...
uniform lowp sampler2D _CameraNearFogMap;
...
void main()
{
    ...
    u_xlat16_9 = u_xlat16_31 * u_xlat16_9;
    u_xlat16_31 = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_31 = max(u_xlat16_31, 0.0);
    u_xlat16_31 = u_xlat16_31 / _CameraNearColorMaxDistance;
    u_xlat16_31 = clamp(u_xlat16_31, 0.0, 1.0);
    u_xlat16_6.xyz = vec3(u_xlat16_31) * _CameraNearColor.xyz;
    u_xlat18.xy = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_2.xyz = texture2D(_CameraNearFogMap, u_xlat18.xy).xyz;
    u_xlat16_2.xyz = (-u_xlat16_6.xyz) * u_xlat10_2.xyz + vec3(1.0, 1.0, 1.0);
    ...
    u_xlat16_6.xyz = u_xlat16_3.xyz * u_xlat16_2.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    ...
    u_xlat16_6.xyz = u_xlat16_2.xyz * vec3(u_xlat16_31) + u_xlat16_6.xyz;
...
void main()
{
    ...
    u_xlat16_32 = u_xlat16_32 * u_xlat16_32;
    u_xlat16_6.x = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_6.x = max(u_xlat16_6.x, 0.0);
    u_xlat16_6.x = u_xlat16_6.x / _CameraNearColorMaxDistance;
    u_xlat16_6.x = clamp(u_xlat16_6.x, 0.0, 1.0);
    u_xlat16_6.xyz = u_xlat16_6.xxx * _CameraNearColor.xyz;
    u_xlat10.xy = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_10.xyz = texture2D(_CameraNearFogMap, u_xlat10.xy).xyz;
    u_xlat16_10.xyz = (-u_xlat16_6.xyz) * u_xlat10_10.xyz + vec3(1.0, 1.0, 1.0);
    ...
    u_xlat16_8.x = (-u_xlat16_33) + _Smoothness;
    ...
    u_xlat30 = dot(_WorldSpaceLightPos0.xyz, u_xlat9.xyz);
    ...
    u_xlat27 = max(u_xlat30, 0.319999993);
    ...
    u_xlat0.xyw = u_xlat16_10.xyz * vec3(u_xlat16_33) + u_xlat0.xyw;
...
void main()
{
    ...
    u_xlat16_2.xyz = vs_TEXCOORD1.xyz * (-vec3(u_xlat16_34)) + (-u_xlat0.xyz);
    ...
    u_xlat16_34 = (u_xlatb33) ? 0.0 : u_xlat36;
    u_xlat10_2 = textureCube(unity_SpecCube0, u_xlat3.xyz, u_xlat16_34);
    ...
    u_xlat16_5.xyz = u_xlat10_2.xyz * vec3(u_xlat16_34);
    u_xlat16_5.xyz = u_xlat16_5.xyz * vec3(_Occlusion);
    ...
    u_xlat16_11 = u_xlat16_34 * u_xlat16_11;
    u_xlat16_34 = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_34 = max(u_xlat16_34, 0.0);
    u_xlat16_34 = u_xlat16_34 / _CameraNearColorMaxDistance;
    u_xlat16_34 = clamp(u_xlat16_34, 0.0, 1.0);
    u_xlat16_7.xyz = vec3(u_xlat16_34) * _CameraNearColor.xyz;
    u_xlat22.xy = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_3.xyz = texture2D(_CameraNearFogMap, u_xlat22.xy).xyz;
    u_xlat16_3.xyz = (-u_xlat16_7.xyz) * u_xlat10_3.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat16_4.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_8.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat10_8.xyz;
    u_xlat16_7.xyz = u_xlat16_4.xyz * u_xlat16_3.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat16_4.xyz;
    u_xlat16_7.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_34 = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_38 = (-u_xlat16_34) + _Smoothness;
    u_xlat16_9.xyz = vec3(u_xlat16_34) * u_xlat16_3.xyz;
    u_xlat16_34 = u_xlat16_38 + 1.0;
    u_xlat16_34 = clamp(u_xlat16_34, 0.0, 1.0);
    u_xlat16_10.xyz = (-u_xlat16_7.xyz) + vec3(u_xlat16_34);
    ...
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_9.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat0.x = max(u_xlat0.x, 0.0);
    u_xlat0.x = min(u_xlat0.x, 100.0);
    u_xlat16_38 = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_38 = max(u_xlat16_38, 0.0);
    u_xlat16_38 = u_xlat16_38 / _CameraNearColorMaxDistance;
    u_xlat16_38 = clamp(u_xlat16_38, 0.0, 1.0);
    u_xlat16_6.xyz = vec3(u_xlat16_38) * _CameraNearColor.xyz;
    u_xlat11.xy = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_11.xyz = texture2D(_CameraNearFogMap, u_xlat11.xy).xyz;
    u_xlat16_11.xyz = (-u_xlat16_6.xyz) * u_xlat10_11.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat16_4.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_7.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat10_7.xyz;
    u_xlat16_7.xyz = u_xlat16_11.xyz * u_xlat16_4.xyz;
    u_xlat16_6.xyz = u_xlat16_4.xyz * u_xlat16_11.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat0.xyz = u_xlat0.xxx * u_xlat16_6.xyz + u_xlat16_8.xyz;
    ...
    u_xlat16_38 = u_xlat16_38 * u_xlat16_38;
    u_xlat16_6.xyz = vec3(u_xlat16_38) * u_xlat16_9.xyz + u_xlat16_6.xyz;
...
void main()
{
    ...
    u_xlat16_31 = clamp(u_xlat16_31, 0.0, 1.0);
    u_xlat16_6.xyz = vec3(u_xlat16_31) * _CameraNearColor.xyz;
    u_xlat3.xy = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_3.xyz = texture2D(_CameraNearFogMap, u_xlat3.xy).xyz;
    u_xlat16_3.xyz = (-u_xlat16_6.xyz) * u_xlat10_3.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat16_4.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_7.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat10_7.xyz;
    u_xlat16_6.xyz = u_xlat16_4.xyz * u_xlat16_3.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat16_4.xyz;
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_31 = (-_Metallic) * 0.779083729 + 0.779083729;
    ...
    u_xlat16_9.xyz = vec3(u_xlat16_10) * u_xlat16_9.xyz + u_xlat16_6.xyz;
...
void main()
{
    ...
    u_xlat16_10 = u_xlat16_34 * u_xlat16_34;
    u_xlat16_10 = u_xlat16_34 * u_xlat16_10;
    u_xlat16_10 = u_xlat16_34 * u_xlat16_10;
    u_xlat16_34 = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_34 = max(u_xlat16_34, 0.0);
    u_xlat16_34 = u_xlat16_34 / _CameraNearColorMaxDistance;
    u_xlat16_34 = clamp(u_xlat16_34, 0.0, 1.0);
    u_xlat16_6.xyz = vec3(u_xlat16_34) * _CameraNearColor.xyz;
    u_xlat20.xy = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_2.xyz = texture2D(_CameraNearFogMap, u_xlat20.xy).xyz;
    u_xlat16_2.xyz = (-u_xlat16_6.xyz) * u_xlat10_2.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat16_3.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_7.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat10_7.xyz;
    ...
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_34 = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_35 = (-u_xlat16_34) + _Smoothness;
...
void main()
{
    ...
    u_xlat16_33 = dot((-u_xlat3.xyz), vs_TEXCOORD1.xyz);
    u_xlat16_33 = u_xlat16_33 + u_xlat16_33;
    u_xlat16_2.xyz = vs_TEXCOORD1.xyz * (-vec3(u_xlat16_33)) + (-u_xlat3.xyz);
    ...
    u_xlat16_33 = (u_xlatb36) ? 0.0 : u_xlat37;
    u_xlat10_1 = textureCube(unity_SpecCube0, u_xlat4.xyz, u_xlat16_33);
    ...
    u_xlat16_2.xyz = u_xlat10_1.xyz * vec3(u_xlat16_33);
    ...
    u_xlat16_14 = u_xlat16_33 * u_xlat16_14;
    u_xlat16_33 = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_33 = max(u_xlat16_33, 0.0);
    u_xlat16_33 = u_xlat16_33 / _CameraNearColorMaxDistance;
    u_xlat16_33 = clamp(u_xlat16_33, 0.0, 1.0);
    u_xlat16_7.xyz = vec3(u_xlat16_33) * _CameraNearColor.xyz;
    u_xlat25.xy = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_4.xyz = texture2D(_CameraNearFogMap, u_xlat25.xy).xyz;
    u_xlat16_4.xyz = (-u_xlat16_7.xyz) * u_xlat10_4.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat16_5.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_8.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat10_8.xyz;
    u_xlat16_7.xyz = u_xlat16_5.xyz * u_xlat16_4.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat16_5.xyz;
    u_xlat16_7.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_33 = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_35 = (-u_xlat16_33) + _Smoothness;
    u_xlat16_9.xyz = vec3(u_xlat16_33) * u_xlat16_4.xyz;
    u_xlat16_33 = u_xlat16_35 + 1.0;
    u_xlat16_33 = clamp(u_xlat16_33, 0.0, 1.0);
    u_xlat16_10.xyz = (-u_xlat16_7.xyz) + vec3(u_xlat16_33);
    u_xlat16_10.xyz = vec3(u_xlat16_14) * u_xlat16_10.xyz + u_xlat16_7.xyz;
    u_xlat16_7.xyz = u_xlat3.xxx * u_xlat16_7.xyz + u_xlat16_9.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = vec3(u_xlat16_24) * _CameraNearColor.xyz;
    u_xlat3.xy = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_3.xyz = texture2D(_CameraNearFogMap, u_xlat3.xy).xyz;
    u_xlat16_3.xyz = (-u_xlat16_2.xyz) * u_xlat10_3.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat16_4.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_5.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat10_5.xyz;
    u_xlat16_5.xyz = u_xlat16_3.xyz * u_xlat16_4.xyz;
    u_xlat16_2.xyz = u_xlat16_4.xyz * u_xlat16_3.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat16_31 = u_xlat16_31 / _CameraNearColorMaxDistance;
    u_xlat16_31 = clamp(u_xlat16_31, 0.0, 1.0);
    u_xlat16_5.xyz = vec3(u_xlat16_31) * _CameraNearColor.xyz;
    u_xlat2.xy = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_2.xyz = texture2D(_CameraNearFogMap, u_xlat2.xy).xyz;
    u_xlat16_2.xyz = (-u_xlat16_5.xyz) * u_xlat10_2.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat16_3.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_6.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat10_6.xyz;
    u_xlat16_5.xyz = u_xlat16_3.xyz * u_xlat16_2.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_3.xyz;
    u_xlat16_5.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_5.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_31 = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_32 = (-u_xlat16_31) + _Smoothness;
    u_xlat16_7.xyz = u_xlat16_2.xyz * vec3(u_xlat16_31);
    u_xlat16_31 = u_xlat16_32 + 1.0;
    u_xlat16_31 = clamp(u_xlat16_31, 0.0, 1.0);
    u_xlat16_8.xyz = (-u_xlat16_5.xyz) + vec3(u_xlat16_31);
    u_xlat16_8.xyz = vec3(u_xlat16_9) * u_xlat16_8.xyz + u_xlat16_5.xyz;
    ...
    u_xlat16_31 = dot(u_xlat10_1, unity_OcclusionMaskSelector);
    u_xlat16_31 = clamp(u_xlat16_31, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_13 = u_xlat16_30 * u_xlat16_13;
    u_xlat16_30 = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_30 = max(u_xlat16_30, 0.0);
    u_xlat16_30 = u_xlat16_30 / _CameraNearColorMaxDistance;
    u_xlat16_30 = clamp(u_xlat16_30, 0.0, 1.0);
    u_xlat16_6.xyz = vec3(u_xlat16_30) * _CameraNearColor.xyz;
    u_xlat4.xy = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_4.xyz = texture2D(_CameraNearFogMap, u_xlat4.xy).xyz;
    u_xlat16_4.xyz = (-u_xlat16_6.xyz) * u_xlat10_4.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat16_5.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_7.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat10_7.xyz;
    u_xlat16_6.xyz = u_xlat16_5.xyz * u_xlat16_4.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat16_5.xyz;
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat16_30 = clamp(u_xlat16_30, 0.0, 1.0);
    u_xlat16_9.xyz = (-u_xlat16_6.xyz) + vec3(u_xlat16_30);
    u_xlat16_9.xyz = vec3(u_xlat16_13) * u_xlat16_9.xyz + u_xlat16_6.xyz;
    u_xlat16_6.xyz = u_xlat3.xxx * u_xlat16_6.xyz + u_xlat16_8.xyz;
...
void main()
{
    ...
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_17 = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_17 = max(u_xlat16_17, 0.0);
    u_xlat16_17 = u_xlat16_17 / _CameraNearColorMaxDistance;
    u_xlat16_17 = clamp(u_xlat16_17, 0.0, 1.0);
    u_xlat16_3.xyz = vec3(u_xlat16_17) * _CameraNearColor.xyz;
    u_xlat5.xy = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_5.xyz = texture2D(_CameraNearFogMap, u_xlat5.xy).xyz;
    u_xlat16_5.xyz = (-u_xlat16_3.xyz) * u_xlat10_5.xyz + vec3(1.0, 1.0, 1.0);
    ...
    u_xlat16_3.xyz = u_xlat16_1.xyz * u_xlat16_5.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat16_6 = u_xlat16_1.x * u_xlat16_1.x + 1.5;
    u_xlat16_1.x = u_xlat16_1.x * u_xlat16_1.x;
    ...
    u_xlat16_2.xyz = u_xlat16_2.xxx * _CameraNearColor.xyz;
    u_xlat10.xy = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_1.xyz = texture2D(_CameraNearFogMap, u_xlat10.xy).xyz;
    u_xlat16_1.xyz = (-u_xlat16_2.xyz) * u_xlat10_1.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat16_3.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_4.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat10_4.xyz;
    u_xlat16_2.xyz = u_xlat16_3.xyz * u_xlat16_1.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
