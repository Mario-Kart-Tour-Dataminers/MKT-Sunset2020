...
void main()
{
    ...
    u_xlat16_3.xyz = texture(_DetailAlbedo, vs_TEXCOORD0.zw).xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = texture(_DetailAlbedo, vs_TEXCOORD0.zw).xyz;
    u_xlat16_9.xyz = u_xlat16_9.xyz * u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat16_5.xyz = texture(_DetailAlbedo, vs_TEXCOORD0.zw).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = texture(_DetailAlbedo, vs_TEXCOORD0.zw).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat16_1.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = texture(_DetailAlbedo, vs_TEXCOORD0.zw).xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_2.xyz;
