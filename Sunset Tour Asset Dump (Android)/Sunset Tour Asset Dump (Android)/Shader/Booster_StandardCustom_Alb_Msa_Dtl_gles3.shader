...
void main()
{
    ...
    u_xlat16_13.xyz = texture(_DetailAlbedo, vs_TEXCOORD1.xy).xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_13.xyz;
...
void main()
{
    ...
    u_xlat16_12.xyz = texture(_DetailAlbedo, vs_TEXCOORD1.xy).xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat16_12.xyz;
...
void main()
{
    ...
    u_xlat16_14.xyz = texture(_DetailAlbedo, vs_TEXCOORD1.xy).xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_14.xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = texture(_DetailAlbedo, vs_TEXCOORD1.xy).xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat16_3.xyz;
    ...
    u_xlat21 = inversesqrt(u_xlat21);
    u_xlat0.xyz = vec3(u_xlat21) * u_xlat0.xyz;
    u_xlat16_0 = texture(unity_SpecCube0, u_xlat0.xyz, u_xlat16_8.x);
...
void main()
{
    ...
    u_xlat16_28 = u_xlat16_2.y + u_xlat16_28;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat2.x = min(u_xlat2.x, 100.0);
    u_xlat2.xyz = u_xlat2.xxx * u_xlat16_4.xyz + u_xlat16_5.xyz;
    u_xlat16_5 = texture(unity_ShadowMask, vs_TEXCOORD6.xy);
...
void main()
{
    ...
    u_xlat16_7.xyz = texture(_DetailAlbedo, vs_TEXCOORD1.xy).xyz;
    u_xlat16_11.xyz = u_xlat16_11.xyz * u_xlat16_7.xyz;
    ...
    u_xlat16_39 = (-u_xlat16_4.x) * 0.779083729 + 0.779083729;
...
void main()
{
    ...
    u_xlat16_5.xyz = texture(_DetailAlbedo, vs_TEXCOORD1.xy).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat16_5.xyz;
    ...
    u_xlat16_26 = (-u_xlat16_3.x) * 0.779083729 + 0.779083729;
    u_xlat16_6.xyz = vec3(u_xlat16_26) * u_xlat16_5.xyz;
    u_xlat16_26 = (-u_xlat16_26) + 1.0;
    u_xlat16_26 = u_xlat16_26 + u_xlat16_3.y;
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    u_xlat16_39 = dot(u_xlat16_2, unity_OcclusionMaskSelector);
#ifdef UNITY_ADRENO_ES3
    u_xlat16_39 = min(max(u_xlat16_39, 0.0), 1.0);
#else
    u_xlat16_39 = clamp(u_xlat16_39, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_2.xyz = texture(_DetailAlbedo, vs_TEXCOORD1.xy).xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat16_2.xyz;
