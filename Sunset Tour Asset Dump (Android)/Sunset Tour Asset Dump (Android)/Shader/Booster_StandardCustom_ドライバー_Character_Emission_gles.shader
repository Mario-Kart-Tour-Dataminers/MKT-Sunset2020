...
void main()
{
    ...
    u_xlat16_8.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat10_0.xyz = texture2D(_EmissionMap, vs_TEXCOORD1.zw).xyz;
    u_xlat16_0.xyz = u_xlat10_0.xyz * u_xlat16_8.xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat10_3.xyz * u_xlat16_5.xyz;
    ...
    SV_Target0.xyz = u_xlat0.xyz * u_xlat16_2.xyz + u_xlat16_3.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    SV_Target0.xyz = u_xlat0.xyz * u_xlat16_1.xyz + u_xlat16_3.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_7.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat10_1.xyz = texture2D(_EmissionMap, vs_TEXCOORD1.zw).xyz;
    u_xlat16_1.xyz = u_xlat10_1.xyz * u_xlat16_7.xyz;
    u_xlat16_14 = roundEven(u_xlat16_25);
    u_xlat16_25 = u_xlat16_25 * 2.0 + -1.0;
...
void main()
{
    ...
    u_xlat16_5.xyz = u_xlat16_2.xyz * u_xlat10_5.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyw = (-u_xlat16_7.xyz) * u_xlat16_2.xxx + vec3(u_xlat16_13);
    u_xlat16_2.xyz = abs(vec3(u_xlat16_24)) * u_xlat16_2.xyw + u_xlat16_9.xyz;
    u_xlat16_2.xyz = u_xlat16_6.xyz * u_xlat16_2.xyz + u_xlat16_0.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat0.xyz * u_xlat16_2.xyz + u_xlat16_1.xyz;
    u_xlat16_0.xyz = u_xlat16_2.xyz + (-unity_FogColor.xyz);
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat0.xyz * u_xlat16_3.xyz + u_xlat16_1.xyz;
