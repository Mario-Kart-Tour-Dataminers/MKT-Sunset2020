...
void main()
{
    ...
    u_xlat16_3 = _Color * u_xlat16_3 + _AddColor;
...
void main()
{
    ...
    u_xlat16_4.xyz = texture(_EmissionMap, vs_TEXCOORD1.zw).xyz;
...
void main()
{
    ...
    u_xlat16_0.xyz = texture(_EmissionMap, vs_TEXCOORD1.zw).xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_1.xyz = u_xlat16_0.xyz * vec3(_EmissionIntensity) + u_xlat16_1.xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = texture(_EmissionMap, vs_TEXCOORD1.zw).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_1.xyz = u_xlat16_4.xyz * vec3(_EmissionIntensity) + u_xlat0.xyz;
    u_xlat16_0.xyz = u_xlat16_1.xyz + (-unity_FogColor.xyz);
    u_xlat24 = vs_TEXCOORD6;
#ifdef UNITY_ADRENO_ES3
    u_xlat24 = min(max(u_xlat24, 0.0), 1.0);
