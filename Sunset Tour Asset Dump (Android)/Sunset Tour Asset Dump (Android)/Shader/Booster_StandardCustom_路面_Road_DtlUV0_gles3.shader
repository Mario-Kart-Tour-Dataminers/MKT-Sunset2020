...
uniform mediump sampler2D _DetailAlbedo;
uniform mediump sampler2D _CameraNearFogMap;
...
void main()
{
    ...
    u_xlat16_5.xyz = texture(_DetailAlbedo, vs_TEXCOORD0.xy).xyz;
    ...
    u_xlat16_5.xyz = texture(_CameraNearFogMap, u_xlat13.xz).xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = texture(_DetailAlbedo, vs_TEXCOORD0.xy).xyz;
    ...
    u_xlat16_4.xyz = texture(_CameraNearFogMap, u_xlat4.xy).xyz;
    u_xlat16_9.xyz = u_xlat16_6.xyz * u_xlat16_4.xyz + u_xlat16_9.xyz;
...
void main()
{
    ...
    u_xlat16_2 = texture(unity_SpecCube0, u_xlat3.xyz, u_xlat16_37);
    ...
    u_xlat16_6.xyz = texture(_DetailAlbedo, vs_TEXCOORD0.xy).xyz;
    ...
    u_xlat16_6.xyz = texture(_CameraNearFogMap, u_xlat16.xz).xyz;
...
void main()
{
    ...
    u_xlat4.xy = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat16_4.xyz = texture(_CameraNearFogMap, u_xlat4.xy).xyz;
    u_xlat16_10.xyz = u_xlat16_6.xyz * u_xlat16_4.xyz + u_xlat16_10.xyz;
...
void main()
{
    ...
    u_xlat16_2 = texture(unity_SpecCube0, u_xlat3.xyz, u_xlat16_34);
    ...
    u_xlat16_6.xyz = texture(_CameraNearFogMap, u_xlat15.xz).xyz;
    u_xlat16_3.xyz = u_xlat16_7.xyz * u_xlat16_6.xyz + u_xlat16_3.xyz;
    u_xlat16_7.xyz = u_xlat16_3.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_7.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_34 = (-_Metallic) * 0.779083729 + 0.779083729;
...
void main()
{
    ...
    u_xlat16_5.xyz = texture(_CameraNearFogMap, u_xlat14.xz).xyz;
    u_xlat16_2.xyz = u_xlat16_6.xyz * u_xlat16_5.xyz + u_xlat16_2.xyz;
    u_xlat16_6.xyz = u_xlat16_2.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_37 = (-_Metallic) * 0.779083729 + 0.779083729;
...
void main()
{
    ...
    u_xlat16_1 = texture(unity_SpecCube0, u_xlat4.xyz, u_xlat16_36);
    ...
    u_xlat16_6.xyz = texture(_CameraNearFogMap, u_xlat17.xz).xyz;
...
void main()
{
    ...
    u_xlat16_1 = texture(unity_SpecCube0, u_xlat4.xyz, u_xlat16_33);
...
void main()
{
    ...
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_4.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat16_1.xyz = texture(_DetailAlbedo, vs_TEXCOORD0.xy).xyz;
    ...
    u_xlat16_1.xyz = texture(_CameraNearFogMap, u_xlat1.xy).xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = texture(_DetailAlbedo, vs_TEXCOORD0.xy).xyz;
    ...
    u_xlat16_2.xyz = texture(_CameraNearFogMap, u_xlat8.xy).xyz;
