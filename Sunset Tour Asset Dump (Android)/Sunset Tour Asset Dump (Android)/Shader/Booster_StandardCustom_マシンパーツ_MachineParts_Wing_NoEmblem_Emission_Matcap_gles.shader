...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat10_1.xyz * _SphereMapScale.xyz + u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat10_11.xyz * _SphereMapScale.xyz + u_xlat16_2.xyz;
    ...
    SV_Target0.xyz = u_xlat16_1.xyz * vec3(_EmissionIntensity) + u_xlat0.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat10_2 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_2 = _Color * u_xlat10_2 + _AddColor;
    u_xlat16_3.xyz = u_xlat10_0.xyz * _SphereMapScale.xyz + u_xlat16_2.xyz;
    SV_Target0.w = u_xlat16_2.w * _AlphaFactor;
    u_xlat10_0.xyz = texture2D(_MSA, vs_TEXCOORD1.xy).xyz;
    u_xlat16_4.xyz = max(u_xlat10_0.xyz, _MinMSA.xyz);
    u_xlat16_30 = (-u_xlat16_4.x) * 0.779083729 + 0.779083729;
    ...
    u_xlat1.x = inversesqrt(u_xlat1.x);
    u_xlat10.xyz = u_xlat8.xyz * u_xlat1.xxx + _WorldSpaceLightPos0.xyz;
    ...
    u_xlat35 = u_xlat28 * u_xlat28 + -1.0;
    u_xlat10.x = u_xlat10.x * u_xlat35 + 1.00001001;
    u_xlat35 = u_xlat19 * u_xlat19 + 1.5;
    ...
    u_xlat1.xyw = u_xlat1.xxx * u_xlat16_3.xyz + u_xlat16_5.xyz;
    u_xlat1.xyw = u_xlat1.xyw * _LightColor0.xyz;
    u_xlat35 = dot(u_xlat0.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat35 = clamp(u_xlat35, 0.0, 1.0);
    u_xlat1.xyw = u_xlat1.xyw * vec3(u_xlat35) + u_xlat16_7.xyz;
    u_xlat16_4.x = dot((-u_xlat8.xyz), u_xlat0.xyz);
    u_xlat16_4.x = u_xlat16_4.x + u_xlat16_4.x;
    u_xlat16_4.xyw = u_xlat0.xyz * (-u_xlat16_4.xxx) + (-u_xlat8.xyz);
    ...
    u_xlat0.x = (u_xlatb0) ? u_xlat16_4.w : (-u_xlat16_4.w);
    u_xlat8.z = u_xlat0.x * u_xlat16_4.x;
    u_xlat0.x = u_xlat0.x * u_xlat16_4.w;
    u_xlat8.xy = (-u_xlat16_4.xy) * u_xlat16_4.yw;
...
void main()
{
    ...
    u_xlat16_3.xyz = max(u_xlat10_2.xyz, _MinMSA.xyz);
    ...
    u_xlat10_4 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_4 = _Color * u_xlat10_4 + _AddColor;
    u_xlat16_7.xyz = u_xlat10_12.xyz * _SphereMapScale.xyz + u_xlat16_4.xyz;
    SV_Target0.w = u_xlat16_4.w * _AlphaFactor;
    u_xlat16_8.xyz = u_xlat16_7.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_8.xyz = u_xlat16_3.xxx * u_xlat16_8.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_3.x = (-u_xlat16_3.x) * 0.779083729 + 0.779083729;
    ...
    u_xlat1.xyz = u_xlat1.xxx * u_xlat16_8.xyz + u_xlat16_7.xyz;
    ...
    u_xlat34 = clamp(u_xlat34, 0.0, 1.0);
    u_xlat1.xyz = u_xlat1.xyz * vec3(u_xlat34) + u_xlat16_7.xyz;
    u_xlat16_3.x = dot((-u_xlat11.xyz), u_xlat13.xyz);
    u_xlat16_3.x = u_xlat16_3.x + u_xlat16_3.x;
    u_xlat16_7.xyz = u_xlat13.xyz * (-u_xlat16_3.xxx) + (-u_xlat11.xyz);
    ...
    u_xlat11.x = (u_xlatb11) ? u_xlat16_7.z : (-u_xlat16_7.z);
    u_xlat5.z = u_xlat11.x * u_xlat16_7.x;
    u_xlat6.x = u_xlat11.x * u_xlat16_7.z;
    u_xlat5.xy = (-u_xlat16_7.xy) * u_xlat16_7.yz;
    u_xlat6.yz = (-u_xlat16_7.xy) * u_xlat16_7.xy;
...
void main()
{
    ...
    u_xlat10_4 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_4 = _Color * u_xlat10_4 + _AddColor;
    u_xlat16_7.xyz = u_xlat10_0.xyz * _SphereMapScale.xyz + u_xlat16_4.xyz;
    SV_Target0.w = u_xlat16_4.w * _AlphaFactor;
    ...
    u_xlat6.z = u_xlat11.x * u_xlat16_2.x;
    ...
    u_xlat16_2.x = (u_xlatb33) ? 0.0 : u_xlat27;
...
void main()
{
    ...
    u_xlat3.xyz = u_xlat2.xyz * u_xlat10.xxx + _WorldSpaceLightPos0.xyz;
    ...
    u_xlat13.x = u_xlat3.x * u_xlat3.x + 1.5;
    u_xlat32 = u_xlat32 * u_xlat13.x;
    u_xlat10_13.xyz = texture2D(_BumpMap, vs_TEXCOORD0.zw).xyz;
    u_xlat16_5.xyz = u_xlat10_13.xyz * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    ...
    u_xlat16_31 = u_xlat3.x * u_xlat12;
    ...
    u_xlat10_12.xyz = texture2D(_SphereMap, u_xlat16_5.xy).xyz;
    u_xlat10_5 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_5 = _Color * u_xlat10_5 + _AddColor;
    u_xlat16_8.xyz = u_xlat10_12.xyz * _SphereMapScale.xyz + u_xlat16_5.xyz;
    ...
    u_xlat2.xyz = u_xlat2.xxx * u_xlat16_9.xyz + u_xlat16_8.xyz;
    ...
    u_xlat32 = dot(u_xlat13.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat32 = clamp(u_xlat32, 0.0, 1.0);
    u_xlat2.xyz = u_xlat2.xyz * vec3(u_xlat32) + u_xlat16_1.xyz;
    u_xlat16_1.x = dot((-u_xlat10.xyz), u_xlat13.xyz);
    u_xlat16_1.x = u_xlat16_1.x + u_xlat16_1.x;
    u_xlat16_1.xyz = u_xlat13.xyz * (-u_xlat16_1.xxx) + (-u_xlat10.xyz);
    u_xlat10.x = dot(u_xlat13.xyz, u_xlat10.xyz);
    u_xlat10.x = clamp(u_xlat10.x, 0.0, 1.0);
    u_xlat16_8.x = (-u_xlat10.x) + 1.0;
    u_xlat16_8.x = u_xlat16_8.x * u_xlat16_8.x;
    u_xlat16_8.x = u_xlat16_8.x * u_xlat16_8.x;
    u_xlat16_4.xyw = u_xlat16_8.xxx * u_xlat16_4.xyw + u_xlat16_9.xyz;
    u_xlat10.x = dot(u_xlat16_1.zxy, (-u_xlat16_1.xyz));
    u_xlatb10 = u_xlat10.x<9.99999975e-06;
    u_xlat10.x = (u_xlatb10) ? u_xlat16_1.z : (-u_xlat16_1.z);
    u_xlat6.z = u_xlat10.x * u_xlat16_1.x;
    u_xlat7.x = u_xlat10.x * u_xlat16_1.z;
    u_xlat6.xy = (-u_xlat16_1.xy) * u_xlat16_1.yz;
    u_xlat7.yz = (-u_xlat16_1.xy) * u_xlat16_1.xy;
    u_xlat10.xyz = u_xlat6.xyz + (-u_xlat7.xyz);
    u_xlat32 = dot(u_xlat10.xyz, u_xlat10.xyz);
    u_xlat32 = inversesqrt(u_xlat32);
    u_xlat10.xyz = u_xlat10.xyz * vec3(u_xlat32);
    u_xlat10.xyz = u_xlat10.xyz * vec3(_NormalDiff);
    u_xlat0.xyz = u_xlat10.xyz * u_xlat0.xxx + u_xlat16_1.xyz;
    ...
    u_xlat0.xyz = u_xlat16_1.xyz * u_xlat16_4.xyw + u_xlat2.xyz;
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat10_1.xyz * _SphereMapScale.xyz + u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat10_0.xyz * _SphereMapScale.xyz + u_xlat16_1.xyz;
    SV_Target0.w = u_xlat16_1.w * _AlphaFactor;
    u_xlat10_0.xyz = texture2D(_MSA, vs_TEXCOORD1.xy).xyz;
    u_xlat16_5.xyz = max(u_xlat10_0.xyz, _MinMSA.xyz);
    u_xlat16_30 = (-u_xlat16_5.x) * 0.779083729 + 0.779083729;
    u_xlat16_6.xyz = vec3(u_xlat16_30) * u_xlat16_3.xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_3.xyz = u_xlat16_5.xxx * u_xlat16_3.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat16_2.xyz = max(u_xlat16_2.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_8.xyz = u_xlat16_5.zzz * u_xlat16_2.xyz;
    ...
    u_xlat20 = (-u_xlat16_5.y) + 1.0;
    u_xlat29 = u_xlat20 * u_xlat20;
    u_xlat31 = u_xlat29 * u_xlat29 + -1.0;
    u_xlat11.x = u_xlat11.x * u_xlat31 + 1.00001001;
    ...
    u_xlat31 = clamp(u_xlat31, 0.0, 1.0);
    u_xlat2.xyw = u_xlat2.xyw * vec3(u_xlat31) + u_xlat16_8.xyz;
    u_xlat16_5.x = dot((-u_xlat4.xyz), u_xlat0.xyz);
    u_xlat16_5.x = u_xlat16_5.x + u_xlat16_5.x;
    u_xlat16_5.xyw = u_xlat0.xyz * (-u_xlat16_5.xxx) + (-u_xlat4.xyz);
    ...
    u_xlat0.x = dot(u_xlat16_5.wxy, (-u_xlat16_5.xyw));
    u_xlatb0 = u_xlat0.x<9.99999975e-06;
    u_xlat0.x = (u_xlatb0) ? u_xlat16_5.w : (-u_xlat16_5.w);
    u_xlat4.z = u_xlat0.x * u_xlat16_5.x;
    u_xlat0.x = u_xlat0.x * u_xlat16_5.w;
    u_xlat4.xy = (-u_xlat16_5.xy) * u_xlat16_5.yw;
    ...
    u_xlat0.xyz = u_xlat0.xyz * vec3(_NormalDiff);
    u_xlat0.xyz = u_xlat0.xyz * vec3(u_xlat27) + u_xlat16_5.xyw;
    u_xlat27 = dot(u_xlat0.xyz, u_xlat0.xyz);
    u_xlat27 = inversesqrt(u_xlat27);
    u_xlat0.xyz = vec3(u_xlat27) * u_xlat0.xyz;
    u_xlatb27 = u_xlat20<0.00499999989;
    u_xlat20 = u_xlat20 * 8.29800034;
    u_xlat16_5.x = (u_xlatb27) ? 0.0 : u_xlat20;
    ...
    u_xlat0.xyz = u_xlat16_5.xyz * u_xlat16_3.xyz + u_xlat2.xyw;
    u_xlat10_2.xyz = texture2D(_EmissionMap, vs_TEXCOORD1.zw).xyz;
    u_xlat16_2.xyz = u_xlat10_2.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_3.xyz = u_xlat16_2.xyz * vec3(_EmissionIntensity) + u_xlat0.xyz;
...
void main()
{
    ...
    u_xlat2.xyw = u_xlat2.xyw * u_xlat16_5.xyw;
    u_xlat31 = dot(u_xlat0.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat31 = clamp(u_xlat31, 0.0, 1.0);
    u_xlat2.xyw = u_xlat2.xyw * vec3(u_xlat31) + u_xlat16_8.xyz;
    u_xlat16_5.x = dot((-u_xlat4.xyz), u_xlat0.xyz);
...
void main()
{
    ...
    u_xlat16_30 = (-u_xlat16_30) + u_xlat16_6.y;
    u_xlat16_30 = u_xlat16_30 + 1.0;
    u_xlat16_30 = clamp(u_xlat16_30, 0.0, 1.0);
    ...
    u_xlat2.x = max(u_xlat2.x, 0.0);
    u_xlat2.x = min(u_xlat2.x, 100.0);
    u_xlat2.xyw = u_xlat2.xxx * u_xlat16_5.xyz + u_xlat16_3.xyz;
    u_xlat2.xyw = u_xlat2.xyw * _LightColor0.xyz;
    u_xlat16_8.xyz = texture2D(unity_Lightmap, vs_TEXCOORD5.xy).xyz;
    u_xlat16_6.xyw = u_xlat16_8.xyz * unity_Lightmap_HDR.xxx;
    u_xlat16_6.xyw = u_xlat16_6.zzz * u_xlat16_6.xyw;
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat16_6.xyw;
    u_xlat31 = dot(u_xlat0.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat31 = clamp(u_xlat31, 0.0, 1.0);
    u_xlat2.xyw = u_xlat2.xyw * vec3(u_xlat31) + u_xlat16_3.xyz;
    ...
    u_xlat4.z = u_xlat0.x * u_xlat16_3.x;
    ...
    u_xlatb27 = u_xlat20<0.00499999989;
    u_xlat20 = u_xlat20 * 8.29800034;
    u_xlat16_3.x = (u_xlatb27) ? 0.0 : u_xlat20;
    u_xlat10_0 = textureCube(unity_SpecCube0, u_xlat0.xyz, u_xlat16_3.x);
    u_xlat16_3.x = u_xlat10_0.w + -1.0;
    u_xlat16_3.x = unity_SpecCube0_HDR.w * u_xlat16_3.x + 1.0;
    u_xlat16_3.x = u_xlat16_3.x * unity_SpecCube0_HDR.x;
    u_xlat16_3.xyz = u_xlat10_0.xyz * u_xlat16_3.xxx;
    u_xlat16_3.xyz = u_xlat16_6.zzz * u_xlat16_3.xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * vec3(u_xlat16_30);
    u_xlat0.xyz = u_xlat16_3.xyz * u_xlat16_5.xyz + u_xlat2.xyw;
    u_xlat10_2.xyz = texture2D(_EmissionMap, vs_TEXCOORD1.zw).xyz;
    u_xlat16_2.xyz = u_xlat10_2.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_3.xyz = u_xlat16_2.xyz * vec3(_EmissionIntensity) + u_xlat0.xyz;
    u_xlat16_0.xyz = u_xlat16_3.xyz + (-unity_FogColor.xyz);
...
void main()
{
    ...
    u_xlat1.x = inversesqrt(u_xlat1.x);
    u_xlat11.xyz = u_xlat5.xyz * u_xlat1.xxx + _WorldSpaceLightPos0.xyz;
    ...
    u_xlat35 = u_xlat31 * u_xlat31 + -1.0;
    u_xlat11.x = u_xlat11.x * u_xlat35 + 1.00001001;
    u_xlat35 = u_xlat21 * u_xlat21 + 1.5;
    u_xlat1.x = u_xlat1.x * u_xlat35;
    ...
    u_xlat35 = dot(u_xlat0.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat35 = clamp(u_xlat35, 0.0, 1.0);
    u_xlat1.xyw = u_xlat1.xyw * vec3(u_xlat35) + u_xlat16_2.xyz;
    u_xlat16_2.x = dot((-u_xlat5.xyz), u_xlat0.xyz);
    u_xlat16_2.x = u_xlat16_2.x + u_xlat16_2.x;
    u_xlat16_2.xyz = u_xlat0.xyz * (-u_xlat16_2.xxx) + (-u_xlat5.xyz);
    ...
    u_xlat5.z = u_xlat0.x * u_xlat16_2.x;
...
void main()
{
    ...
    u_xlat10_2 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_2 = _Color * u_xlat10_2 + _AddColor;
    u_xlat16_4.xyz = u_xlat10_0.xyz * _SphereMapScale.xyz + u_xlat16_2.xyz;
    SV_Target0.w = u_xlat16_2.w * _AlphaFactor;
    ...
    u_xlat16_31 = (-u_xlat16_7.x) * 0.779083729 + 0.779083729;
    u_xlat16_4.xyz = vec3(u_xlat16_31) * u_xlat16_4.xyz;
    u_xlat16_31 = (-u_xlat16_31) + u_xlat16_7.y;
    ...
    u_xlat3.x = inversesqrt(u_xlat3.x);
    u_xlat13.xyz = u_xlat5.xyz * u_xlat3.xxx + _WorldSpaceLightPos0.xyz;
    ...
    u_xlat35 = dot(u_xlat0.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat35 = clamp(u_xlat35, 0.0, 1.0);
    u_xlat3.xyw = u_xlat3.xyw * vec3(u_xlat35) + u_xlat16_1.xyz;
    ...
    u_xlat16_1.x = (u_xlatb30) ? 0.0 : u_xlat23;
    u_xlat10_0 = textureCube(unity_SpecCube0, u_xlat0.xyz, u_xlat16_1.x);
    u_xlat16_1.x = u_xlat10_0.w + -1.0;
    u_xlat16_1.x = unity_SpecCube0_HDR.w * u_xlat16_1.x + 1.0;
    u_xlat16_1.x = u_xlat16_1.x * unity_SpecCube0_HDR.x;
    ...
    u_xlat16_1.xyz = u_xlat16_7.zzz * u_xlat16_1.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(u_xlat16_31);
    u_xlat0.xyz = u_xlat16_1.xyz * u_xlat16_4.xyz + u_xlat3.xyw;
    ...
    u_xlat16_1.xyz = u_xlat16_3.xyz * vec3(_EmissionIntensity) + u_xlat0.xyz;
