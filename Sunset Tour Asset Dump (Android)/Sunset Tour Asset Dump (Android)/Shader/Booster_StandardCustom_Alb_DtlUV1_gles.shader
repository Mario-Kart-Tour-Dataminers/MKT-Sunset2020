...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/Alb_DtlUV1" {
Properties {
...
void main()
{
    ...
    vs_TEXCOORD0.zw = in_TEXCOORD1.xy * _DetailAlbedo_ST.xy + _DetailAlbedo_ST.zw;
...
void main()
{
    ...
    u_xlat10_3.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD0.zw).xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat10_3.xyz;
    u_xlat16_6.xyz = u_xlat16_2.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat10_4.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD0.zw).xyz;
    u_xlat16_9.xyz = u_xlat16_9.xyz * u_xlat10_4.xyz;
    u_xlat16_6.xyz = u_xlat16_9.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat10_4.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD0.zw).xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat10_4.xyz;
    u_xlat16_7.xyz = u_xlat16_3.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat10_4.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD0.zw).xyz;
    u_xlat16_10.xyz = u_xlat16_10.xyz * u_xlat10_4.xyz;
    u_xlat16_4.xyz = u_xlat16_10.xyz + u_xlat16_10.xyz;
    u_xlat16_6.xyz = u_xlat16_10.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
...
void main()
{
    ...
    u_xlat10_4.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD0.zw).xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat10_4.xyz;
    u_xlat16_6.xyz = u_xlat16_3.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_3.xyz = u_xlat16_3.xyz + u_xlat16_3.xyz;
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_28 = (-_Metallic) * 0.779083729 + 0.779083729;
...
void main()
{
    ...
    u_xlat10_5.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD0.zw).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat10_5.xyz;
    u_xlat16_7.xyz = u_xlat16_4.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat10_4.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_12.xyz = u_xlat16_12.xyz * u_xlat10_4.xyz;
    u_xlat10_4.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD0.zw).xyz;
    u_xlat16_12.xyz = u_xlat16_12.xyz * u_xlat10_4.xyz;
    u_xlat16_4.xyz = u_xlat16_12.xyz + u_xlat16_12.xyz;
    u_xlat16_6.xyz = u_xlat16_12.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_41 = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_7.xyz = u_xlat16_4.xyz * vec3(u_xlat16_41);
    ...
    u_xlat16_4.xyz = u_xlat16_4.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
    u_xlat16_4.xyz = max(u_xlat16_4.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_11.xyz = texture2D(unity_Lightmap, vs_TEXCOORD3.xy).xyz;
...
void main()
{
    ...
    u_xlat10_3.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD0.zw).xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat10_3.xyz;
    u_xlat16_5.xyz = u_xlat16_2.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_2.xyz = u_xlat16_2.xyz + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat10_5.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD0.zw).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat10_5.xyz;
    u_xlat16_6.xyz = u_xlat16_4.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_4.xyz = u_xlat16_4.xyz + u_xlat16_4.xyz;
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_3.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
...
void main()
{
    ...
    u_xlat10_1.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD0.zw).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat10_1.xyz;
    u_xlat16_3.xyz = u_xlat16_4.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_4.xyz = u_xlat16_4.xyz + u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat10_2.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD0.zw).xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat10_2.xyz;
    u_xlat16_3.xyz = u_xlat16_1.xyz * vec3(2.0, 2.0, 2.0) + vec3(-0.220916301, -0.220916301, -0.220916301);
