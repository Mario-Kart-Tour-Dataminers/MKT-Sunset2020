...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/路面/RoadUV1Multiply_Alb" {
Properties {
...
_CameraNearFogMap ("Camera Near Colormap(UV1)", 2D) = "white" { }
...
void main()
{
    ...
    vs_TEXCOORD0.zw = in_TEXCOORD1.xy * _CameraNearFogMap_ST.xy + _CameraNearFogMap_ST.zw;
