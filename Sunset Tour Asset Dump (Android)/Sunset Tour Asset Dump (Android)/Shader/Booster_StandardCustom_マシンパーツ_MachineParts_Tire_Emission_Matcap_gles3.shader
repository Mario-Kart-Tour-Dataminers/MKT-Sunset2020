...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/マシンパーツ/MachineParts_Tire_Emission_Matcap" {
Properties {
...
void main()
{
    ...
    u_xlat2.xyz = vec3(u_xlat13) * hlslcc_mtx4x4unity_ObjectToWorld[1].yzx;
    u_xlat0.xyz = hlslcc_mtx4x4unity_ObjectToWorld[0].yzx * u_xlat0.xxx + u_xlat2.xyz;
    u_xlat4.z = dot(u_xlat3.xyz, in_NORMAL0.xyz);
    u_xlat1.x = dot(u_xlat3.xyz, in_TANGENT0.xyz);
    u_xlat0.xyz = hlslcc_mtx4x4unity_ObjectToWorld[2].yzx * u_xlat1.xxx + u_xlat0.xyz;
    u_xlat2.y = dot(u_xlat4.xyz, hlslcc_mtx4x4unity_WorldToObject[0].xyz);
    u_xlat2.z = dot(u_xlat4.xyz, hlslcc_mtx4x4unity_WorldToObject[1].xyz);
    u_xlat2.x = dot(u_xlat4.xyz, hlslcc_mtx4x4unity_WorldToObject[2].xyz);
    u_xlat1.x = dot(u_xlat2.xyz, u_xlat2.xyz);
...
void main()
{
    ...
    u_xlat2.y = dot(u_xlat2.xyz, in_NORMAL0.xyz);
    u_xlat4.xyz = u_xlat1.xxx * hlslcc_mtx4x4unity_ObjectToWorld[1].yzx;
    u_xlat1.x = dot(u_xlat0.xyz, in_TANGENT0.xyz);
    u_xlat2.x = dot(u_xlat0.xyz, in_NORMAL0.xyz);
    u_xlat0.xyz = hlslcc_mtx4x4unity_ObjectToWorld[0].yzx * u_xlat1.xxx + u_xlat4.xyz;
    u_xlat1.x = dot(u_xlat3.xyz, in_TANGENT0.xyz);
    u_xlat2.z = dot(u_xlat3.xyz, in_NORMAL0.xyz);
    u_xlat0.xyz = hlslcc_mtx4x4unity_ObjectToWorld[2].yzx * u_xlat1.xxx + u_xlat0.xyz;
    u_xlat1.x = dot(u_xlat0.xyz, u_xlat0.xyz);
