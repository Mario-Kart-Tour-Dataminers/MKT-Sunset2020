...
void main()
{
    ...
    u_xlat16_6.xyz = u_xlat16_3.xyz * u_xlat10_1.xyz + u_xlat10_2.xyz;
    ...
    u_xlat0.x = u_xlat16_9 * u_xlat10_1.w + u_xlat0.x;
...
void main()
{
    ...
    u_xlat10_2 = texture2D(_MainTex, u_xlat21.xy);
    u_xlat16_6.xyz = vs_COLOR0.xyz + _Color.xyz;
    u_xlat16_7.xyz = u_xlat16_6.xyz * u_xlat10_2.xyz + u_xlat10_4.xyz;
    ...
    u_xlat1 = u_xlat16_11 * u_xlat10_2.w + u_xlat1;
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat16_4.xyz * u_xlat10_2.xyz + u_xlat10_3.xyz;
    u_xlat16_8.xyz = u_xlat16_7.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_8.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_8.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_31 = (-_Metallic) * 0.779083729 + 0.779083729;
    ...
    u_xlat0.x = u_xlat16_10 * u_xlat10_2.w + u_xlat0.x;
    u_xlat0.x = min(u_xlat0.x, 1.0);
    SV_Target0.w = u_xlat0.x;
    return;
}
...
void main()
{
    ...
    u_xlat10_2 = texture2D(_MainTex, u_xlat22.xy);
    u_xlat16_6.xyz = vs_COLOR0.xyz + _Color.xyz;
    u_xlat16_7.xyz = u_xlat16_6.xyz * u_xlat10_2.xyz + u_xlat10_4.xyz;
    u_xlat16_8.xyz = u_xlat16_7.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_8.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_8.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat16_11 = vs_COLOR0.w + _WhitecapsBaseAlpha;
    u_xlat0.x = u_xlat16_11 * u_xlat10_2.w + u_xlat0.x;
...
void main()
{
    ...
    u_xlat16_3.xyz = vs_COLOR0.xyz + _Color.xyz;
    u_xlat16_6.xyz = u_xlat16_3.xyz * u_xlat10_2.xyz + u_xlat10_4.xyz;
    u_xlat16_7.xyz = u_xlat16_6.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_7.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat16_28 = dot(u_xlat10_3, unity_OcclusionMaskSelector);
    u_xlat16_28 = clamp(u_xlat16_28, 0.0, 1.0);
    ...
    u_xlat16_9 = vs_COLOR0.w + _WhitecapsBaseAlpha;
    u_xlat0.x = u_xlat16_9 * u_xlat10_2.w + u_xlat0.x;
    u_xlat0.x = min(u_xlat0.x, 1.0);
    SV_Target0.w = u_xlat0.x;
    return;
}
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat16_5.xyz * u_xlat10_1.xyz + u_xlat10_4.xyz;
    u_xlat16_8.xyz = u_xlat16_7.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_8.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_8.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat3.x = u_xlat16_13 * u_xlat10_1.w + u_xlat3.x;
...
void main()
{
    ...
    u_xlat10_4.xyz = texture2D(_Whitecaps, u_xlat13.xy).xyz;
    u_xlat10_13 = texture2D(_WhitecapsAlpha, u_xlat13.xy).x;
    ...
    u_xlat10_2 = texture2D(_MainTex, u_xlat26.xy);
    u_xlat16_6.xyz = vs_COLOR0.xyz + _Color.xyz;
    u_xlat16_7.xyz = u_xlat16_6.xyz * u_xlat10_2.xyz + u_xlat10_4.xyz;
    u_xlat16_8.xyz = u_xlat16_7.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_8.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_8.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat16_13 = vs_COLOR0.w + _WhitecapsBaseAlpha;
    u_xlat0.x = u_xlat16_13 * u_xlat10_2.w + u_xlat0.x;
    u_xlat1.w = min(u_xlat0.x, 1.0);
    SV_Target0 = u_xlat1;
    return;
}
...
void main()
{
    ...
    u_xlat16_5.xyz = u_xlat16_2.xyz * u_xlat10_1.xyz + u_xlat10_3.xyz;
    ...
    u_xlat0.x = u_xlat16_8 * u_xlat10_1.w + u_xlat0.x;
    u_xlat0.x = min(u_xlat0.x, 1.0);
    SV_Target0.w = u_xlat0.x;
    return;
}
...
void main()
{
    ...
    u_xlat16_4.xyz = vs_COLOR0.xyz + _Color.xyz;
    u_xlat16_6.xyz = u_xlat16_4.xyz * u_xlat10_1.xyz + u_xlat10_5.xyz;
    u_xlat16_7.xyz = u_xlat16_6.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_7.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat3.x = u_xlat16_12 * u_xlat10_1.w + u_xlat3.x;
    u_xlat3.x = min(u_xlat3.x, 1.0);
    SV_Target0.w = u_xlat3.x;
    return;
}
...
void main()
{
    ...
    vs_TEXCOORD2.w = max(u_xlat0.x, u_xlat16_6);
    vs_COLOR0 = in_COLOR0;
    vs_TEXCOORD6 = vec4(0.0, 0.0, 0.0, 0.0);
    return;
}
...
void main()
{
    ...
    u_xlat10_6.xyz = texture2D(_Whitecaps, u_xlat6.xy).xyz;
    ...
    u_xlat16_3.xyz = vs_COLOR0.xyz + _Color.xyz;
    u_xlat16_4.xyz = u_xlat16_3.xyz * u_xlat10_1.xyz + u_xlat10_6.xyz;
...
void main()
{
    ...
    u_xlat10_1.xyz = texture2D(_Whitecaps, u_xlat12.xy).xyz;
    ...
    u_xlat16_3.xyz = vs_COLOR0.xyz + _Color.xyz;
    u_xlat16_4.xyz = u_xlat16_3.xyz * u_xlat10_2.xyz + u_xlat10_1.xyz;
    u_xlat16_5.xyz = u_xlat16_4.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_5.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_5.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
