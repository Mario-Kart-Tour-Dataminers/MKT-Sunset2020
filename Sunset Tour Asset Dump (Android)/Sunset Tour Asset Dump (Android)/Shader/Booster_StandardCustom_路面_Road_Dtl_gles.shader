...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/路面/Road_Dtl" {
Properties {
_Color ("Main Color", Color) = (1,1,1,1)
_Metallic ("Metallic", Range(0, 1)) = 0
_Smoothness ("Smoothness", Range(0, 1)) = 0
_Occlusion ("Occlusion", Range(0, 1)) = 1
_DetailAlbedo ("Detail Albedo(UV1)", 2D) = "gray" { }
...
void main()
{
    ...
    gl_Position = u_xlat0;
    vs_TEXCOORD0.xy = in_TEXCOORD1.xy * _DetailAlbedo_ST.xy + _DetailAlbedo_ST.zw;
