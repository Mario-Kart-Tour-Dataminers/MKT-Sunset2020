...
void main()
{
    ...
    u_xlat16_9.xyz = u_xlat16_6.xyz * u_xlat16_9.xyz + u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = vs_COLOR0.xyz + _Color.xyz;
    u_xlat16_10.xyz = u_xlat16_6.xyz * u_xlat16_10.xyz + u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = texture(_CameraNearFogMap, u_xlat3.xy).xyz;
    u_xlat16_4.xyz = vs_COLOR0.xyz + _Color.xyz;
    u_xlat16_3.xyz = u_xlat16_2.xyz * u_xlat16_3.xyz + u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat16_3.xyz * u_xlat16_4.xyz + u_xlat16_1.xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = texture(_CameraNearFogMap, u_xlat8.xy).xyz;
    u_xlat16_3.xyz = vs_COLOR0.xyz + _Color.xyz;
