...
void main()
{
    ...
    u_xlat16_5.xyz = u_xlat16_5.xyz * vec3(u_xlat16_34) + u_xlat16_9.xyz;
...
void main()
{
    ...
    u_xlat4.y = hlslcc_mtx4x4unity_MatrixV[1].x;
    u_xlat4.z = hlslcc_mtx4x4unity_MatrixV[2].x;
    u_xlat16_5.x = dot(u_xlat4.xyz, vs_TEXCOORD0.xyz);
    u_xlat4.x = hlslcc_mtx4x4unity_MatrixV[0].y;
    u_xlat4.y = hlslcc_mtx4x4unity_MatrixV[1].y;
    u_xlat4.z = hlslcc_mtx4x4unity_MatrixV[2].y;
    u_xlat16_5.y = dot(u_xlat4.xyz, vs_TEXCOORD0.xyz);
    u_xlat16_5.xy = u_xlat16_5.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
    u_xlat10_4.xyz = texture2D(_SphereMap, u_xlat16_5.xy).xyz;
    u_xlat16_5.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat10_4.xyz;
    u_xlat16_6.xyz = u_xlat16_5.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_3.xyz = u_xlat0.xxx * u_xlat16_6.xyz + u_xlat16_5.xyz;
    SV_Target0.xyz = u_xlat16_3.xyz * u_xlat16_8.xyz + u_xlat16_1.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_2.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat10_0.xyz;
    ...
    u_xlat5.x = u_xlat5.x * u_xlat16_19 + 1.00001001;
    u_xlat21 = u_xlat21 * u_xlat5.x;
    u_xlat21 = u_xlat16_12 / u_xlat21;
    u_xlat21 = u_xlat21 + -9.99999975e-05;
    u_xlat21 = max(u_xlat21, 0.0);
    u_xlat21 = min(u_xlat21, 100.0);
    u_xlat5.xyz = vec3(u_xlat21) * u_xlat16_2.xyz + u_xlat16_3.xyz;
    ...
    u_xlat0.xyz = u_xlat16_1.xyz * u_xlat16_2.xyz + u_xlat5.xyz;
    SV_Target0.xyz = u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_34 = dot((-u_xlat0.xyz), vs_TEXCOORD0.xyz);
    u_xlat16_34 = u_xlat16_34 + u_xlat16_34;
    u_xlat16_2.xyz = vs_TEXCOORD0.xyz * (-vec3(u_xlat16_34)) + (-u_xlat0.xyz);
    ...
    u_xlat33 = inversesqrt(u_xlat33);
    u_xlat3.xyz = vec3(u_xlat33) * vs_TEXCOORD0.xyz;
    ...
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_10.xyz = u_xlat0.xxx * u_xlat16_7.xyz + u_xlat16_6.xyz;
...
void main()
{
    ...
    u_xlat16_7.xyz = (-u_xlat16_6.xyz) + vec3(u_xlat16_25);
...
void main()
{
    ...
    u_xlat24 = dot(u_xlat0.xyz, u_xlat0.xyz);
    u_xlat24 = inversesqrt(u_xlat24);
    u_xlat5.xyz = u_xlat0.xyz * vec3(u_xlat24) + _WorldSpaceLightPos0.xyz;
    u_xlat0.xyz = vec3(u_xlat24) * u_xlat0.xyz;
    ...
    u_xlat16_6 = u_xlat16_29 * u_xlat16_29 + 1.5;
    u_xlat24 = u_xlat24 * u_xlat16_6;
    u_xlat6.x = dot(vs_TEXCOORD0.xyz, vs_TEXCOORD0.xyz);
    u_xlat6.x = inversesqrt(u_xlat6.x);
    u_xlat6.xyz = u_xlat6.xxx * vs_TEXCOORD0.xyz;
    u_xlat5.x = dot(u_xlat6.xyz, u_xlat5.xyz);
    ...
    u_xlat5.xyz = vec3(u_xlat24) * u_xlat16_2.xyz + u_xlat16_3.xyz;
    u_xlat10_3 = texture2D(unity_ShadowMask, vs_TEXCOORD4.xy);
    u_xlat16_26 = dot(u_xlat10_3, unity_OcclusionMaskSelector);
    ...
    u_xlat16_26 = (-u_xlat29) + 1.0;
    u_xlat16_26 = u_xlat16_26 * u_xlat16_26;
    u_xlat16_26 = u_xlat16_26 * u_xlat16_26;
    u_xlat16_2.xyz = vec3(u_xlat16_26) * u_xlat16_4.xyz + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat0.x = texture2D(unity_NHxRoughness, u_xlat4.xz).x;
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_9.xyz = u_xlat0.xxx * u_xlat16_7.xyz + u_xlat16_6.xyz;
    ...
    SV_Target0.xyz = u_xlat16_9.xyz * u_xlat16_5.xyz + u_xlat16_1.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat3.y = hlslcc_mtx4x4unity_MatrixV[1].y;
    u_xlat3.z = hlslcc_mtx4x4unity_MatrixV[2].y;
    u_xlat16_4.y = dot(u_xlat3.xyz, vs_TEXCOORD0.xyz);
    u_xlat16_4.xy = u_xlat16_4.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
    u_xlat10_3.xyz = texture2D(_SphereMap, u_xlat16_4.xy).xyz;
    u_xlat16_4.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat10_3.xyz;
...
void main()
{
    ...
    u_xlat0.x = texture2D(unity_NHxRoughness, u_xlat3.xz).x;
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_9.xyz = u_xlat0.xxx * u_xlat16_6.xyz + u_xlat16_5.xyz;
    u_xlat16_34 = (-u_xlat32) + 1.0;
    u_xlat16_0.x = u_xlat16_34 * u_xlat16_34;
    u_xlat16_0.x = u_xlat16_34 * u_xlat16_0.x;
    u_xlat16_0.x = u_xlat16_34 * u_xlat16_0.x;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat3.xxx * u_xlat16_6.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat3.y = hlslcc_mtx4x4unity_MatrixV[1].x;
    u_xlat3.z = hlslcc_mtx4x4unity_MatrixV[2].x;
    u_xlat16_2.x = dot(u_xlat3.xyz, vs_TEXCOORD0.xyz);
    u_xlat3.x = hlslcc_mtx4x4unity_MatrixV[0].y;
    u_xlat3.y = hlslcc_mtx4x4unity_MatrixV[1].y;
    u_xlat3.z = hlslcc_mtx4x4unity_MatrixV[2].y;
    u_xlat16_2.y = dot(u_xlat3.xyz, vs_TEXCOORD0.xyz);
    u_xlat16_2.xy = u_xlat16_2.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
    u_xlat10_3.xyz = texture2D(_SphereMap, u_xlat16_2.xy).xyz;
    u_xlat16_2.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat10_3.xyz;
...
void main()
{
    ...
    u_xlat16_33 = dot((-u_xlat3.xyz), vs_TEXCOORD0.xyz);
    u_xlat16_33 = u_xlat16_33 + u_xlat16_33;
    u_xlat16_2.xyz = vs_TEXCOORD0.xyz * (-vec3(u_xlat16_33)) + (-u_xlat3.xyz);
    ...
    u_xlat36 = dot(vs_TEXCOORD1.xyz, _NormalRand.xyz);
    ...
    u_xlat16_6.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat10_4.xyz;
    u_xlat16_7.xyz = u_xlat16_6.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_7.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_33 = (-_Metallic) * 0.779083729 + 0.779083729;
    ...
    u_xlat36 = inversesqrt(u_xlat36);
    u_xlat4.xyz = vec3(u_xlat36) * vs_TEXCOORD0.xyz;
...
void main()
{
    ...
    u_xlat16_8 = dot((-u_xlat3.xyz), vs_TEXCOORD0.xyz);
    u_xlat16_8 = u_xlat16_8 + u_xlat16_8;
    u_xlat16_5.xyz = vs_TEXCOORD0.xyz * (-vec3(u_xlat16_8)) + (-u_xlat3.xyz);
...
void main()
{
    ...
    u_xlat16_23 = clamp(u_xlat16_23, 0.0, 1.0);
    u_xlat16_5.xyz = vec3(u_xlat16_23) * _LightColor0.xyz;
...
void main()
{
    ...
    u_xlat0.x = texture2D(unity_NHxRoughness, u_xlat3.xz).x;
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_8.xyz = u_xlat0.xxx * u_xlat16_6.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat16_8.xyz = (-u_xlat16_7.xyz) + vec3(u_xlat16_30);
    u_xlat33 = dot(vs_TEXCOORD0.xyz, vs_TEXCOORD0.xyz);
    u_xlat33 = inversesqrt(u_xlat33);
    ...
    u_xlat3.x = texture2D(unity_NHxRoughness, u_xlat5.xz).x;
    u_xlat3.x = u_xlat3.x * 16.0;
    u_xlat16_9.xyz = u_xlat3.xxx * u_xlat16_7.xyz + u_xlat16_6.xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat16_4.xyz * vec3(u_xlat16_26) + u_xlat16_5.xyz;
    SV_Target0.xyz = u_xlat16_4.xyz * u_xlat16_7.xyz + u_xlat16_2.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_1.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat10_0.xyz;
    ...
    u_xlat3.xyz = u_xlat16_2.xyz * vec3(u_xlat18);
    u_xlat16_20 = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat3.xyz = u_xlat16_1.xyz * vec3(u_xlat16_20) + u_xlat3.xyz;
    u_xlat16_1.x = (-u_xlat16_20) + _Smoothness;
    ...
    u_xlat16_5.xyz = vs_TEXCOORD0.xyz * (-vec3(u_xlat16_20)) + (-u_xlat0.xyz);
    ...
    u_xlat16_20 = u_xlat16_20 * u_xlat16_20;
    u_xlat16_20 = u_xlat16_20 * u_xlat16_20;
    u_xlat16_1.xyz = vec3(u_xlat16_20) * u_xlat16_1.xyz + u_xlat16_2.xyz;
    u_xlat10_2 = textureCube(_HeuristicReflection, u_xlat16_5.xyz);
    u_xlat16_5.x = u_xlat10_2.w + -1.0;
    u_xlat16_5.x = unity_SpecCube0_HDR.w * u_xlat16_5.x + 1.0;
    u_xlat16_5.x = u_xlat16_5.x * unity_SpecCube0_HDR.x;
    u_xlat16_5.xyz = u_xlat10_2.xyz * u_xlat16_5.xxx;
    ...
    u_xlat0.xyz = u_xlat3.xyz * vec3(u_xlat6) + u_xlat16_1.xyz;
    SV_Target0.xyz = u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_5.xyz = vec3(u_xlat16_31) * _LightColor0.xyz;
    u_xlat16_5.xyz = vec3(u_xlat30) * u_xlat16_5.xyz;
    u_xlat16_1.xyz = u_xlat16_9.xyz * u_xlat16_5.xyz + u_xlat16_1.xyz;
    u_xlat16_0.xyz = u_xlat16_1.xyz + (-unity_FogColor.xyz);
    u_xlat30 = vs_TEXCOORD1.w;
    u_xlat30 = clamp(u_xlat30, 0.0, 1.0);
    u_xlat0.xyz = vec3(u_xlat30) * u_xlat16_0.xyz + unity_FogColor.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_7.xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat16_6.xyz + u_xlat16_2.xyz;
    u_xlat16_0.xyz = u_xlat16_10.xyz * u_xlat16_9.xyz + u_xlat16_0.xyz;
    u_xlat16_3.xyz = u_xlat16_0.xyz + (-unity_FogColor.xyz);
...
void main()
{
    ...
    u_xlat16_3.y = dot(u_xlat1.xyz, vs_TEXCOORD0.xyz);
    u_xlat16_3.xy = u_xlat16_3.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
    u_xlat10_5.xyz = texture2D(_SphereMap, u_xlat16_3.xy).xyz;
    u_xlat16_3.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat10_5.xyz;
...
void main()
{
    ...
    u_xlat16_5 = u_xlat16_1 * u_xlat16_1 + 1.5;
    ...
    u_xlat1.y = hlslcc_mtx4x4unity_MatrixV[1].y;
    u_xlat1.z = hlslcc_mtx4x4unity_MatrixV[2].y;
    u_xlat16_2.y = dot(u_xlat1.xyz, vs_TEXCOORD0.xyz);
    u_xlat16_2.xy = u_xlat16_2.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
    u_xlat10_1.xyz = texture2D(_SphereMap, u_xlat16_2.xy).xyz;
    u_xlat16_2.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat10_1.xyz;
    ...
    u_xlat0.xzw = u_xlat16_2.xyz * vec3(u_xlat16_14) + u_xlat0.xzw;
