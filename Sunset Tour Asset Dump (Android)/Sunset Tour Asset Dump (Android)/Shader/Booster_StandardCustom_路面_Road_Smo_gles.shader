...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/路面/Road_Smo" {
Properties {
_Color ("Main Color", Color) = (1,1,1,1)
_MSA ("MSA Map", 2D) = "black" { }
_Metallic ("Metallic", Range(0, 1)) = 0
_Occlusion ("Occlusion", Range(0, 1)) = 1
[Space(20)] _CameraNearColorMaxDistance ("Camera Near Fog Max Distance", Range(0.001, 100)) = 0.1
_CameraNearColor ("Camera Near Color", Color) = (1,1,1,1)
_CameraNearColorUVScale ("Camera near Color Fog UV Scale", Vector) = (1,1,1,1)
_CameraNearFogMap ("Camera Near Colormap(UV0)", 2D) = "white" { }
...
uniform 	mediump float _CameraNearColorMaxDistance;
uniform 	mediump vec4 _CameraNearColor;
uniform 	mediump vec2 _CameraNearColorUVScale;
...
void main()
{
    ...
    u_xlat24 = inversesqrt(u_xlat24);
    u_xlat2.xyz = vec3(u_xlat24) * u_xlat2.xyz;
    u_xlat16_1.x = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_1.x = max(u_xlat16_1.x, 0.0);
    u_xlat16_1.x = u_xlat16_1.x / _CameraNearColorMaxDistance;
    u_xlat16_1.x = clamp(u_xlat16_1.x, 0.0, 1.0);
    u_xlat16_1.x = u_xlat16_1.x * _CameraNearColor.y;
    u_xlat3.xy = vs_TEXCOORD0.xy * _CameraNearColorUVScale.xy;
    u_xlat10_24 = texture2D(_MSA, u_xlat3.xy).y;
    u_xlat3.z = (-u_xlat16_1.x) * u_xlat10_24 + 1.0;
    u_xlatb26 = u_xlat3.z<0.00499999989;
    u_xlat11 = u_xlat3.z * 8.29800034;
    u_xlat16_9.x = (u_xlatb26) ? 0.0 : u_xlat11;
    ...
    u_xlat16_1.x = u_xlat16_1.x * u_xlat10_24 + u_xlat16_12.x;
    u_xlat16_1.x = clamp(u_xlat16_1.x, 0.0, 1.0);
    u_xlat16_12.xyz = _Color.xyz * vs_COLOR0.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    ...
    u_xlat16_0.x = u_xlat16_1.x * u_xlat16_0.x;
    u_xlat16_12.xyz = u_xlat16_0.xxx * u_xlat16_5.xyz + u_xlat16_12.xyz;
    u_xlat16_1.xyz = u_xlat16_9.xyz * u_xlat16_12.xyz;
    u_xlat16_0.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat16_4.xyz = u_xlat16_0.xyz * u_xlat16_4.xxx + u_xlat16_7.xyz;
...
void main()
{
    ...
    u_xlat7.xyz = u_xlat7.xyz * vec3(u_xlat1) + _WorldSpaceLightPos0.xyz;
    ...
    u_xlat16_2.x = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_2.x = max(u_xlat16_2.x, 0.0);
    u_xlat16_2.x = u_xlat16_2.x / _CameraNearColorMaxDistance;
    u_xlat16_2.x = clamp(u_xlat16_2.x, 0.0, 1.0);
    u_xlat16_2.x = u_xlat16_2.x * _CameraNearColor.y;
    u_xlat4.xy = vs_TEXCOORD0.xy * _CameraNearColorUVScale.xy;
    u_xlat10_0 = texture2D(_MSA, u_xlat4.xy).y;
    u_xlat1 = (-u_xlat16_2.x) * u_xlat10_0 + 1.0;
    u_xlatb24 = u_xlat1<0.00499999989;
    u_xlat4.x = u_xlat1 * 8.29800034;
    u_xlat16_9.x = (u_xlatb24) ? 0.0 : u_xlat4.x;
    u_xlat10_3 = textureCube(unity_SpecCube0, u_xlat3.xyz, u_xlat16_9.x);
    ...
    u_xlat16_5 = u_xlat1 * u_xlat3.x;
    u_xlat1 = u_xlat1 * u_xlat1 + 1.5;
    u_xlat16_5 = (-u_xlat16_5) * 0.280000001 + 1.0;
    u_xlat16_9.xyz = u_xlat16_9.xyz * vec3(u_xlat16_5);
    u_xlat16_5 = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_12.x = (-u_xlat16_5) + 1.0;
    u_xlat16_2.x = u_xlat16_2.x * u_xlat10_0 + u_xlat16_12.x;
    u_xlat16_2.x = clamp(u_xlat16_2.x, 0.0, 1.0);
    u_xlat16_12.xyz = _Color.xyz * vs_COLOR0.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_12.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_12.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_6.xyz = u_xlat16_2.xxx + (-u_xlat16_12.xyz);
    u_xlat0.x = dot(vs_TEXCOORD1.xyz, vs_TEXCOORD1.xyz);
    u_xlat0.x = inversesqrt(u_xlat0.x);
    u_xlat10.xyz = u_xlat0.xxx * vs_TEXCOORD1.xyz;
    u_xlat0.x = dot(u_xlat10.xyz, u_xlat8.xyz);
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat16_2.x = (-u_xlat0.x) + 1.0;
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_2.x;
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_2.x;
    u_xlat16_6.xyz = u_xlat16_2.xxx * u_xlat16_6.xyz + u_xlat16_12.xyz;
...
void main()
{
    ...
    u_xlat27 = inversesqrt(u_xlat27);
    u_xlat3.xyz = vec3(u_xlat27) * u_xlat3.xyz;
    u_xlat16_28 = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_28 = max(u_xlat16_28, 0.0);
    u_xlat16_28 = u_xlat16_28 / _CameraNearColorMaxDistance;
    u_xlat16_28 = clamp(u_xlat16_28, 0.0, 1.0);
    u_xlat16_28 = u_xlat16_28 * _CameraNearColor.y;
    u_xlat4.xy = vs_TEXCOORD0.xy * _CameraNearColorUVScale.xy;
    u_xlat10_27 = texture2D(_MSA, u_xlat4.xy).y;
    u_xlat4.z = (-u_xlat16_28) * u_xlat10_27 + 1.0;
    u_xlatb30 = u_xlat4.z<0.00499999989;
    u_xlat13 = u_xlat4.z * 8.29800034;
    u_xlat16_2.x = (u_xlatb30) ? 0.0 : u_xlat13;
    ...
    u_xlat16_28 = u_xlat16_28 * u_xlat10_27 + u_xlat16_6.x;
    u_xlat16_28 = clamp(u_xlat16_28, 0.0, 1.0);
    ...
    u_xlat16_7.xyz = vec3(u_xlat16_32) * u_xlat16_9.xyz;
...
void main()
{
    ...
    u_xlat4.x = u_xlat1 * 8.29800034;
    u_xlat16_10.x = (u_xlatb27) ? 0.0 : u_xlat4.x;
    u_xlat10_3 = textureCube(unity_SpecCube0, u_xlat3.xyz, u_xlat16_10.x);
    u_xlat16_10.x = u_xlat10_3.w + -1.0;
    u_xlat16_10.x = unity_SpecCube0_HDR.w * u_xlat16_10.x + 1.0;
    u_xlat16_10.x = u_xlat16_10.x * unity_SpecCube0_HDR.x;
    u_xlat16_10.xyz = u_xlat10_3.xyz * u_xlat16_10.xxx;
    u_xlat16_10.xyz = u_xlat16_10.xyz * vec3(_Occlusion);
    u_xlat3.x = u_xlat1 * u_xlat1;
    u_xlat16_5.x = u_xlat1 * u_xlat3.x;
    u_xlat1 = u_xlat1 * u_xlat1 + 1.5;
    ...
    u_xlat11.x = dot(_WorldSpaceLightPos0.xyz, u_xlat8.xyz);
    ...
    u_xlat8.x = dot(u_xlat11.xyz, u_xlat8.xyz);
    u_xlat8.x = clamp(u_xlat8.x, 0.0, 1.0);
    u_xlat8.x = u_xlat8.x * u_xlat8.x;
    u_xlat16 = u_xlat3.x * u_xlat3.x + -1.0;
    u_xlat8.x = u_xlat8.x * u_xlat16 + 1.00001001;
    u_xlat8.x = u_xlat8.x * u_xlat1;
    ...
    u_xlat16_2.x = u_xlat16_2.x * u_xlat10_0 + u_xlat16_5.x;
    u_xlat16_2.x = clamp(u_xlat16_2.x, 0.0, 1.0);
    u_xlat16_6.xyz = _Color.xyz * vs_COLOR0.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat0.xyz = u_xlat8.xxx * u_xlat16_6.xyz + u_xlat16_13.xyz;
    ...
    u_xlat16_7.xyz = u_xlat16_4.xyz * vec3(_Occlusion);
    u_xlat16_5.xyz = u_xlat16_13.xyz * u_xlat16_7.xyz;
    u_xlat24 = dot(u_xlat11.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat24 = clamp(u_xlat24, 0.0, 1.0);
    u_xlat1 = dot(u_xlat11.xyz, u_xlat9.xyz);
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    u_xlat16_29 = (-u_xlat1) + 1.0;
    u_xlat16_29 = u_xlat16_29 * u_xlat16_29;
    u_xlat16_29 = u_xlat16_29 * u_xlat16_29;
    u_xlat0.xyz = u_xlat0.xyz * vec3(u_xlat24) + u_xlat16_5.xyz;
    u_xlat16_5.xyz = u_xlat16_2.xxx + (-u_xlat16_6.xyz);
    u_xlat16_5.xyz = vec3(u_xlat16_29) * u_xlat16_5.xyz + u_xlat16_6.xyz;
    u_xlat0.xyz = u_xlat16_10.xyz * u_xlat16_5.xyz + u_xlat0.xyz;
    SV_Target0.xyz = u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_2.xyz = vs_TEXCOORD1.xyz * (-vec3(u_xlat16_25)) + (-u_xlat0.xyz);
    ...
    u_xlat24 = inversesqrt(u_xlat24);
    u_xlat3.xyz = vec3(u_xlat24) * u_xlat3.xyz;
    u_xlat16_25 = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_25 = max(u_xlat16_25, 0.0);
    u_xlat16_25 = u_xlat16_25 / _CameraNearColorMaxDistance;
    u_xlat16_25 = clamp(u_xlat16_25, 0.0, 1.0);
    u_xlat16_25 = u_xlat16_25 * _CameraNearColor.y;
    u_xlat4.xy = vs_TEXCOORD0.xy * _CameraNearColorUVScale.xy;
    u_xlat10_24 = texture2D(_MSA, u_xlat4.xy).y;
    u_xlat4.z = (-u_xlat16_25) * u_xlat10_24 + 1.0;
    u_xlatb27 = u_xlat4.z<0.00499999989;
    u_xlat12 = u_xlat4.z * 8.29800034;
    u_xlat16_2.x = (u_xlatb27) ? 0.0 : u_xlat12;
    u_xlat10_2 = textureCube(unity_SpecCube0, u_xlat3.xyz, u_xlat16_2.x);
    u_xlat16_5.x = u_xlat10_2.w + -1.0;
    u_xlat16_5.x = unity_SpecCube0_HDR.w * u_xlat16_5.x + 1.0;
    u_xlat16_5.x = u_xlat16_5.x * unity_SpecCube0_HDR.x;
    ...
    u_xlat16_25 = u_xlat16_25 * u_xlat10_24 + u_xlat16_6.x;
    u_xlat16_25 = clamp(u_xlat16_25, 0.0, 1.0);
    u_xlat16_6.xyz = _Color.xyz * vs_COLOR0.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat16_7.xyz = vec3(u_xlat16_29) * u_xlat16_3.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_7.xyz + u_xlat16_5.xyz;
    u_xlat16_5.xyz = u_xlat0.xxx * u_xlat16_6.xyz + u_xlat16_7.xyz;
...
void main()
{
    ...
    u_xlat16_8.x = u_xlat16_1.x * u_xlat16_8.x;
    u_xlat16_5.xyz = u_xlat16_8.xxx * u_xlat16_5.xyz + u_xlat16_12.xyz;
    ...
    u_xlat16_4.xyz = u_xlat0.xxx * u_xlat16_12.xyz + u_xlat16_7.xyz;
    SV_Target0.xyz = u_xlat16_4.xyz * u_xlat16_6.xyz + u_xlat16_1.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat30 = inversesqrt(u_xlat30);
    u_xlat4.xyz = vec3(u_xlat30) * u_xlat4.xyz;
    u_xlat16_27 = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_27 = max(u_xlat16_27, 0.0);
    u_xlat16_27 = u_xlat16_27 / _CameraNearColorMaxDistance;
    u_xlat16_27 = clamp(u_xlat16_27, 0.0, 1.0);
    u_xlat16_27 = u_xlat16_27 * _CameraNearColor.y;
    u_xlat5.xy = vs_TEXCOORD0.xy * _CameraNearColorUVScale.xy;
    u_xlat10_30 = texture2D(_MSA, u_xlat5.xy).y;
    u_xlat5.z = (-u_xlat16_27) * u_xlat10_30 + 1.0;
    u_xlatb31 = u_xlat5.z<0.00499999989;
    u_xlat14 = u_xlat5.z * 8.29800034;
    u_xlat16_2.x = (u_xlatb31) ? 0.0 : u_xlat14;
    ...
    u_xlat16_29 = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_6.x = (-u_xlat16_29) + 1.0;
    u_xlat16_27 = u_xlat16_27 * u_xlat10_30 + u_xlat16_6.x;
    u_xlat16_27 = clamp(u_xlat16_27, 0.0, 1.0);
    u_xlat16_6.xyz = _Color.xyz * vs_COLOR0.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat16_12.x = u_xlat16_27 * u_xlat16_27;
    u_xlat16_12.x = u_xlat16_27 * u_xlat16_12.x;
    u_xlat16_12.x = u_xlat16_27 * u_xlat16_12.x;
    u_xlat16_7.xyz = u_xlat16_12.xxx * u_xlat16_7.xyz + u_xlat16_6.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_7.xyz;
    u_xlat16_12.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat16_7.xyz = vec3(u_xlat16_29) * u_xlat16_12.xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat16_7.xyz + u_xlat16_2.xyz;
    u_xlat16_2.xyz = u_xlat3.xxx * u_xlat16_6.xyz + u_xlat16_7.xyz;
    SV_Target0.xyz = u_xlat16_2.xyz * u_xlat16_8.xyz + u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat10_0 = texture2D(_MSA, u_xlat4.xy).y;
    u_xlat1 = (-u_xlat16_2.x) * u_xlat10_0 + 1.0;
    u_xlatb36 = u_xlat1<0.00499999989;
    u_xlat4.x = u_xlat1 * 8.29800034;
    u_xlat16_13.x = (u_xlatb36) ? 0.0 : u_xlat4.x;
    u_xlat10_3 = textureCube(unity_SpecCube0, u_xlat3.xyz, u_xlat16_13.x);
    ...
    u_xlat16_13.xyz = u_xlat16_13.xyz * vec3(_Occlusion);
    u_xlat3.x = u_xlat1 * u_xlat1;
    u_xlat16_5.x = u_xlat1 * u_xlat3.x;
    u_xlat1 = u_xlat1 * u_xlat1 + 1.5;
    u_xlat16_5.x = (-u_xlat16_5.x) * 0.280000001 + 1.0;
    u_xlat16_13.xyz = u_xlat16_13.xyz * u_xlat16_5.xxx;
    u_xlat14.x = dot(u_xlat11.xyz, u_xlat11.xyz);
    u_xlat14.x = max(u_xlat14.x, 0.00100000005);
    u_xlat14.x = inversesqrt(u_xlat14.x);
    u_xlat11.xyz = u_xlat11.xyz * u_xlat14.xxx;
    u_xlat14.x = dot(_WorldSpaceLightPos0.xyz, u_xlat11.xyz);
    ...
    u_xlat16_4.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat16_5.x = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_16.xyz = u_xlat16_4.xyz * u_xlat16_5.xxx;
    u_xlat16_5.x = (-u_xlat16_5.x) + 1.0;
    u_xlat16_2.x = u_xlat16_2.x * u_xlat10_0 + u_xlat16_5.x;
    u_xlat16_2.x = clamp(u_xlat16_2.x, 0.0, 1.0);
    u_xlat16_6.xyz = _Color.xyz * vs_COLOR0.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat0.xyz = u_xlat11.xxx * u_xlat16_6.xyz + u_xlat16_16.xyz;
    u_xlat0.xyz = u_xlat0.xyz * _LightColor0.xyz;
    u_xlat16_5.x = vs_TEXCOORD1.y * vs_TEXCOORD1.y;
    u_xlat16_5.x = vs_TEXCOORD1.x * vs_TEXCOORD1.x + (-u_xlat16_5.x);
    ...
    u_xlat16_7.xyz = unity_SHC.xyz * u_xlat16_5.xxx + u_xlat16_7.xyz;
    u_xlat4.xyz = vs_TEXCOORD1.xyz;
    u_xlat4.w = 1.0;
    ...
    u_xlat16_7.xyz = unity_Lightmap_HDR.xxx * u_xlat16_10.xyz + u_xlat16_9.xyz;
    u_xlat16_7.xyz = u_xlat16_7.xyz * vec3(_Occlusion);
    u_xlat16_5.xyz = u_xlat16_16.xyz * u_xlat16_7.xyz;
    u_xlat33 = dot(u_xlat14.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat33 = clamp(u_xlat33, 0.0, 1.0);
    u_xlat1 = dot(u_xlat14.xyz, u_xlat12.xyz);
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    ...
    u_xlat16_5.xyz = u_xlat16_2.xxx + (-u_xlat16_6.xyz);
    u_xlat16_5.xyz = vec3(u_xlat16_38) * u_xlat16_5.xyz + u_xlat16_6.xyz;
...
void main()
{
    ...
    u_xlat16_1.x = u_xlat16_1.x + u_xlat16_1.x;
    u_xlat16_1.xyz = vs_TEXCOORD1.xyz * (-u_xlat16_1.xxx) + (-u_xlat0.xyz);
    u_xlat21 = dot(u_xlat16_1.zxy, (-u_xlat16_1.xyz));
    u_xlatb21 = u_xlat21<9.99999975e-06;
    u_xlat21 = (u_xlatb21) ? u_xlat16_1.z : (-u_xlat16_1.z);
    u_xlat2.z = u_xlat21 * u_xlat16_1.x;
    u_xlat3.x = u_xlat21 * u_xlat16_1.z;
    u_xlat2.xy = (-u_xlat16_1.xy) * u_xlat16_1.yz;
    u_xlat3.yz = (-u_xlat16_1.xy) * u_xlat16_1.xy;
    u_xlat2.xyz = u_xlat2.xyz + (-u_xlat3.xyz);
    ...
    u_xlat16_1.x = u_xlat16_1.x * _CameraNearColor.y;
    u_xlat3.xy = vs_TEXCOORD0.xy * _CameraNearColorUVScale.xy;
    u_xlat10_21 = texture2D(_MSA, u_xlat3.xy).y;
    u_xlat3.z = (-u_xlat16_1.x) * u_xlat10_21 + 1.0;
    u_xlatb23 = u_xlat3.z<0.00499999989;
    u_xlat10 = u_xlat3.z * 8.29800034;
    u_xlat16_8.x = (u_xlatb23) ? 0.0 : u_xlat10;
    u_xlat10_2 = textureCube(unity_SpecCube0, u_xlat2.xyz, u_xlat16_8.x);
    ...
    u_xlat16_1.x = u_xlat16_1.x * u_xlat10_21 + u_xlat16_11.x;
    u_xlat16_1.x = clamp(u_xlat16_1.x, 0.0, 1.0);
    u_xlat16_11.xyz = _Color.xyz * vs_COLOR0.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_11.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_11.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_5.xyz = u_xlat16_1.xxx + (-u_xlat16_11.xyz);
    ...
    u_xlat0.x = texture2D(unity_NHxRoughness, u_xlat3.xz).x;
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_1.x = (-u_xlat23) + 1.0;
    u_xlat16_7 = u_xlat16_1.x * u_xlat16_1.x;
    u_xlat16_7 = u_xlat16_1.x * u_xlat16_7;
    u_xlat16_7 = u_xlat16_1.x * u_xlat16_7;
    u_xlat16_5.xyz = vec3(u_xlat16_7) * u_xlat16_5.xyz + u_xlat16_11.xyz;
    ...
    u_xlat16_6.xyz = u_xlat16_4.xxx * u_xlat16_2.xyz;
    u_xlat16_1.xyz = u_xlat16_5.xyz * u_xlat16_6.xyz + u_xlat16_1.xyz;
    u_xlat16_4.xyz = u_xlat0.xxx * u_xlat16_11.xyz + u_xlat16_6.xyz;
    u_xlat10_2 = texture2D(unity_ShadowMask, vs_TEXCOORD6.xy);
    u_xlat16_22 = dot(u_xlat10_2, unity_OcclusionMaskSelector);
...
void main()
{
    ...
    u_xlat27 = inversesqrt(u_xlat27);
    u_xlat4.xyz = vec3(u_xlat27) * u_xlat4.xyz;
    u_xlat16_24 = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_24 = max(u_xlat16_24, 0.0);
    u_xlat16_24 = u_xlat16_24 / _CameraNearColorMaxDistance;
    u_xlat16_24 = clamp(u_xlat16_24, 0.0, 1.0);
    u_xlat16_24 = u_xlat16_24 * _CameraNearColor.y;
    u_xlat5.xy = vs_TEXCOORD0.xy * _CameraNearColorUVScale.xy;
    u_xlat10_27 = texture2D(_MSA, u_xlat5.xy).y;
    u_xlat5.z = (-u_xlat16_24) * u_xlat10_27 + 1.0;
    u_xlatb28 = u_xlat5.z<0.00499999989;
    u_xlat13 = u_xlat5.z * 8.29800034;
    u_xlat16_2.x = (u_xlatb28) ? 0.0 : u_xlat13;
    u_xlat10_1 = textureCube(unity_SpecCube0, u_xlat4.xyz, u_xlat16_2.x);
    u_xlat16_2.x = u_xlat10_1.w + -1.0;
    u_xlat16_2.x = unity_SpecCube0_HDR.w * u_xlat16_2.x + 1.0;
    u_xlat16_2.x = u_xlat16_2.x * unity_SpecCube0_HDR.x;
    ...
    u_xlat16_24 = u_xlat16_24 * u_xlat10_27 + u_xlat16_6.x;
    u_xlat16_24 = clamp(u_xlat16_24, 0.0, 1.0);
    u_xlat16_6.xyz = _Color.xyz * vs_COLOR0.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_7.xyz;
    u_xlat16_4.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat16_7.xyz = vec3(u_xlat16_26) * u_xlat16_4.xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat16_7.xyz + u_xlat16_2.xyz;
    u_xlat16_2.xyz = u_xlat3.xxx * u_xlat16_6.xyz + u_xlat16_7.xyz;
...
void main()
{
    ...
    vs_TEXCOORD2.w = max(u_xlat1.x, u_xlat16_2);
    u_xlat0.y = u_xlat0.y * _ProjectionParams.x;
    u_xlat1.xzw = u_xlat0.xwy * vec3(0.5, 0.5, 0.5);
    vs_TEXCOORD3.zw = u_xlat0.zw;
    vs_TEXCOORD3.xy = u_xlat1.zz + u_xlat1.xw;
...
void main()
{
    ...
    u_xlat1.xyz = vec3(u_xlat16) * u_xlat1.xyz;
    vs_TEXCOORD1.xyz = u_xlat1.xyz;
    u_xlat16 = u_xlat0.z * unity_FogParams.z + unity_FogParams.w;
    u_xlat16_2 = (-unity_FogColor.w) + 1.0;
    vs_TEXCOORD2.w = max(u_xlat16, u_xlat16_2);
    u_xlat0.y = u_xlat0.y * _ProjectionParams.x;
    ...
    u_xlat16_4.y = dot(unity_SHBg, u_xlat16_0);
    u_xlat16_4.z = dot(unity_SHBb, u_xlat16_0);
    vs_TEXCOORD4.xyz = unity_SHC.xyz * vec3(u_xlat16_2) + u_xlat16_4.xyz;
    vs_TEXCOORD6 = vec4(0.0, 0.0, 0.0, 0.0);
    return;
}
...
void main()
{
    u_xlat16_0.x = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_0.x = max(u_xlat16_0.x, 0.0);
    u_xlat16_0.x = u_xlat16_0.x / _CameraNearColorMaxDistance;
    u_xlat16_0.x = clamp(u_xlat16_0.x, 0.0, 1.0);
    u_xlat16_0.x = u_xlat16_0.x * _CameraNearColor.y;
    u_xlat1.xy = vs_TEXCOORD0.xy * _CameraNearColorUVScale.xy;
    u_xlat10_1 = texture2D(_MSA, u_xlat1.xy).y;
    u_xlat1.y = (-u_xlat16_0.x) * u_xlat10_1 + 1.0;
    ...
    u_xlat11 = inversesqrt(u_xlat11);
    u_xlat3.xyz = vec3(u_xlat11) * vs_TEXCOORD1.xyz;
    u_xlat11 = dot(u_xlat2.xyz, u_xlat3.xyz);
    u_xlat11 = u_xlat11 + u_xlat11;
    u_xlat2.xyz = u_xlat3.xyz * (-vec3(u_xlat11)) + u_xlat2.xyz;
    u_xlat11 = dot(u_xlat3.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat11 = clamp(u_xlat11, 0.0, 1.0);
    u_xlat16_0.xyz = vec3(u_xlat11) * _LightColor0.xyz;
    ...
    u_xlat16_4.xyz = u_xlat16_1.xyz * vec3(u_xlat16_15) + u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat16_1.x = clamp(u_xlat16_1.x, 0.0, 1.0);
    u_xlat16_1.x = u_xlat16_1.x * _CameraNearColor.y;
    u_xlat2.xy = vs_TEXCOORD0.xy * _CameraNearColorUVScale.xy;
    u_xlat10_2 = texture2D(_MSA, u_xlat2.xy).y;
    u_xlat16_2.x = (-u_xlat16_1.x) * u_xlat10_2 + 1.0;
    u_xlat16_5 = u_xlat16_2.x * u_xlat16_2.x + 1.5;
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_2.x;
    u_xlat9 = u_xlat9 * u_xlat16_5;
...
void main()
{
    ...
    u_xlat1.x = u_xlat0.z * unity_FogParams.z + unity_FogParams.w;
    u_xlat16_2 = (-unity_FogColor.w) + 1.0;
    vs_TEXCOORD6 = max(u_xlat1.x, u_xlat16_2);
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * _MSA_ST.xy + _MSA_ST.zw;
    u_xlat1.x = dot(in_NORMAL0.xyz, hlslcc_mtx4x4unity_WorldToObject[0].xyz);
    u_xlat1.y = dot(in_NORMAL0.xyz, hlslcc_mtx4x4unity_WorldToObject[1].xyz);
    u_xlat1.z = dot(in_NORMAL0.xyz, hlslcc_mtx4x4unity_WorldToObject[2].xyz);
