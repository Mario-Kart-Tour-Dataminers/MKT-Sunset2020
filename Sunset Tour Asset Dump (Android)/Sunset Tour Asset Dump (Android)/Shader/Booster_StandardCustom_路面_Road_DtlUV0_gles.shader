...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/路面/Road_DtlUV0" {
Properties {
_Color ("Main Color", Color) = (1,1,1,1)
_Metallic ("Metallic", Range(0, 1)) = 0
_Smoothness ("Smoothness", Range(0, 1)) = 0
_Occlusion ("Occlusion", Range(0, 1)) = 1
_DetailAlbedo ("Detail Albedo(UV0)", 2D) = "gray" { }
...
void main()
{
    ...
    gl_Position = u_xlat0;
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * _DetailAlbedo_ST.xy + _DetailAlbedo_ST.zw;
...
void main()
{
    ...
    u_xlat10_5.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD0.xy).xyz;
    ...
    u_xlat13.xz = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_5.xyz = texture2D(_CameraNearFogMap, u_xlat13.xz).xyz;
    u_xlat16_2.xyz = u_xlat16_6.xyz * u_xlat10_5.xyz + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat10_4.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD0.xy).xyz;
    ...
    u_xlat16_9.xyz = u_xlat16_6.xyz * u_xlat10_4.xyz + u_xlat16_9.xyz;
    u_xlat16_6.xyz = u_xlat16_9.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat0.xyw = u_xlat16_9.xyz * vec3(u_xlat16_30) + u_xlat0.xyw;
...
void main()
{
    ...
    u_xlat10_6.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD0.xy).xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat10_6.xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz + u_xlat16_3.xyz;
    u_xlat16_37 = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_37 = max(u_xlat16_37, 0.0);
    u_xlat16_37 = u_xlat16_37 / _CameraNearColorMaxDistance;
    u_xlat16_37 = clamp(u_xlat16_37, 0.0, 1.0);
    u_xlat16_7.xyz = vec3(u_xlat16_37) * _CameraNearColor.xyz;
    u_xlat16.xz = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_6.xyz = texture2D(_CameraNearFogMap, u_xlat16.xz).xyz;
    u_xlat16_3.xyz = u_xlat16_7.xyz * u_xlat10_6.xyz + u_xlat16_3.xyz;
    ...
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_11.xyz = u_xlat0.xxx * u_xlat16_7.xyz + u_xlat16_8.xyz;
...
void main()
{
    ...
    u_xlat10_4.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD0.xy).xyz;
    u_xlat16_10.xyz = u_xlat16_10.xyz * u_xlat10_4.xyz;
    u_xlat16_10.xyz = u_xlat16_10.xyz + u_xlat16_10.xyz;
    u_xlat16_35 = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_35 = max(u_xlat16_35, 0.0);
    u_xlat16_35 = u_xlat16_35 / _CameraNearColorMaxDistance;
    u_xlat16_35 = clamp(u_xlat16_35, 0.0, 1.0);
    u_xlat16_6.xyz = vec3(u_xlat16_35) * _CameraNearColor.xyz;
    u_xlat4.xy = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_4.xyz = texture2D(_CameraNearFogMap, u_xlat4.xy).xyz;
    u_xlat16_10.xyz = u_xlat16_6.xyz * u_xlat10_4.xyz + u_xlat16_10.xyz;
...
void main()
{
    ...
    u_xlat15.xz = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_6.xyz = texture2D(_CameraNearFogMap, u_xlat15.xz).xyz;
    u_xlat16_3.xyz = u_xlat16_7.xyz * u_xlat10_6.xyz + u_xlat16_3.xyz;
    u_xlat16_7.xyz = u_xlat16_3.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_7.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_7.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_34 = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_38 = (-u_xlat16_34) + _Smoothness;
    u_xlat16_8.xyz = vec3(u_xlat16_34) * u_xlat16_3.xyz;
    ...
    u_xlat0.x = texture2D(unity_NHxRoughness, u_xlat4.xz).x;
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_10.xyz = u_xlat0.xxx * u_xlat16_7.xyz + u_xlat16_8.xyz;
    ...
    u_xlat16_34 = clamp(u_xlat16_34, 0.0, 1.0);
    u_xlat16_5.xyz = vec3(u_xlat16_34) * _LightColor0.xyz;
    u_xlat16_5.xyz = vec3(u_xlat33) * u_xlat16_5.xyz;
    SV_Target0.xyz = u_xlat16_10.xyz * u_xlat16_5.xyz + u_xlat16_1.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_37 = u_xlat16_37 / _CameraNearColorMaxDistance;
    u_xlat16_37 = clamp(u_xlat16_37, 0.0, 1.0);
    u_xlat16_6.xyz = vec3(u_xlat16_37) * _CameraNearColor.xyz;
    u_xlat14.xz = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_5.xyz = texture2D(_CameraNearFogMap, u_xlat14.xz).xyz;
    u_xlat16_2.xyz = u_xlat16_6.xyz * u_xlat10_5.xyz + u_xlat16_2.xyz;
    u_xlat16_6.xyz = u_xlat16_2.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_6.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_37 = (-_Metallic) * 0.779083729 + 0.779083729;
...
void main()
{
    ...
    u_xlat16_36 = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_36 = max(u_xlat16_36, 0.0);
    u_xlat16_36 = u_xlat16_36 / _CameraNearColorMaxDistance;
    u_xlat16_36 = clamp(u_xlat16_36, 0.0, 1.0);
    u_xlat16_7.xyz = vec3(u_xlat16_36) * _CameraNearColor.xyz;
    u_xlat17.xz = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_6.xyz = texture2D(_CameraNearFogMap, u_xlat17.xz).xyz;
    u_xlat16_4.xyz = u_xlat16_7.xyz * u_xlat10_6.xyz + u_xlat16_4.xyz;
    ...
    u_xlat16_8.xyz = vec3(u_xlat16_36) * u_xlat16_4.xyz;
    ...
    u_xlat39 = clamp(u_xlat39, 0.0, 1.0);
    u_xlat16_10.xyz = vec3(u_xlat39) * _LightColor0.xyz;
    ...
    u_xlat16_11.xyz = u_xlat3.xxx * u_xlat16_7.xyz + u_xlat16_8.xyz;
    u_xlat16_36 = (-u_xlat40) + 1.0;
    u_xlat16_3.x = u_xlat16_36 * u_xlat16_36;
    u_xlat16_3.x = u_xlat16_36 * u_xlat16_3.x;
    u_xlat16_3.x = u_xlat16_36 * u_xlat16_3.x;
    u_xlat16_7.xyz = u_xlat16_3.xxx * u_xlat16_9.xyz + u_xlat16_7.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_7.xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat16_8.xyz + u_xlat16_2.xyz;
    SV_Target0.xyz = u_xlat16_11.xyz * u_xlat16_10.xyz + u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat4.xy = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_4.xyz = texture2D(_CameraNearFogMap, u_xlat4.xy).xyz;
    u_xlat16_3.xyz = u_xlat16_2.xyz * u_xlat10_4.xyz + u_xlat16_3.xyz;
    ...
    u_xlat7.x = u_xlat28 * u_xlat28 + 1.5;
    ...
    u_xlat4.xyz = vec3(u_xlat27) * u_xlat16_5.xyz + u_xlat16_2.xyz;
    ...
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_2.x;
    u_xlat16_2.x = u_xlat16_2.x * u_xlat16_2.x;
    u_xlat16_2.xyz = u_xlat16_2.xxx * u_xlat16_6.xyz + u_xlat16_5.xyz;
    ...
    u_xlat3.x = (u_xlatb3) ? u_xlat16_5.z : (-u_xlat16_5.z);
    u_xlat7.z = u_xlat3.x * u_xlat16_5.x;
    u_xlat3.x = u_xlat3.x * u_xlat16_5.z;
    u_xlat7.xy = (-u_xlat16_5.xy) * u_xlat16_5.yz;
    u_xlat3.yz = (-u_xlat16_5.xy) * u_xlat16_5.xy;
...
void main()
{
    ...
    u_xlat16_34 = dot(u_xlat10_1, unity_OcclusionMaskSelector);
    u_xlat16_34 = clamp(u_xlat16_34, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat3.x = texture2D(unity_NHxRoughness, u_xlat5.xz).x;
    u_xlat3.x = u_xlat3.x * 16.0;
    u_xlat16_10.xyz = u_xlat3.xxx * u_xlat16_7.xyz + u_xlat16_8.xyz;
    ...
    SV_Target0.xyz = u_xlat16_10.xyz * u_xlat16_2.xyz + u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_5.xyz = vec3(u_xlat16_34) * _LightColor0.xyz;
    u_xlat16_5.xyz = vec3(u_xlat33) * u_xlat16_5.xyz;
    u_xlat16_1.xyz = u_xlat16_10.xyz * u_xlat16_5.xyz + u_xlat16_1.xyz;
    u_xlat16_0.xyz = u_xlat16_1.xyz + (-unity_FogColor.xyz);
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_7.xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat16_8.xyz + u_xlat16_2.xyz;
    u_xlat16_0.xyz = u_xlat16_11.xyz * u_xlat16_10.xyz + u_xlat16_0.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = vec3(u_xlat16_33) * _LightColor0.xyz;
    u_xlat16_2.xyz = vec3(u_xlat36) * u_xlat16_2.xyz;
    u_xlat16_0.xyz = u_xlat16_10.xyz * u_xlat16_2.xyz + u_xlat16_0.xyz;
    u_xlat16_3.xyz = u_xlat16_0.xyz + (-unity_FogColor.xyz);
    u_xlat36 = vs_TEXCOORD2.w;
    u_xlat36 = clamp(u_xlat36, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_4.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat10_1.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD0.xy).xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz * u_xlat10_1.xyz;
    u_xlat16_4.xyz = u_xlat16_4.xyz + u_xlat16_4.xyz;
    u_xlat16_14 = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_14 = max(u_xlat16_14, 0.0);
    u_xlat16_14 = u_xlat16_14 / _CameraNearColorMaxDistance;
    u_xlat16_14 = clamp(u_xlat16_14, 0.0, 1.0);
    u_xlat16_3.xyz = vec3(u_xlat16_14) * _CameraNearColor.xyz;
    u_xlat1.xy = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_1.xyz = texture2D(_CameraNearFogMap, u_xlat1.xy).xyz;
    u_xlat16_4.xyz = u_xlat16_3.xyz * u_xlat10_1.xyz + u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat10_2.xyz = texture2D(_DetailAlbedo, vs_TEXCOORD0.xy).xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat10_2.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz + u_xlat16_1.xyz;
    u_xlat16_3.x = (-vs_TEXCOORD3.w) + _CameraNearColorMaxDistance;
    u_xlat16_3.x = max(u_xlat16_3.x, 0.0);
    u_xlat16_3.x = u_xlat16_3.x / _CameraNearColorMaxDistance;
    u_xlat16_3.x = clamp(u_xlat16_3.x, 0.0, 1.0);
    u_xlat16_3.xyz = u_xlat16_3.xxx * _CameraNearColor.xyz;
    u_xlat8.xy = vs_TEXCOORD0.zw * _CameraNearColorUVScale.xy;
    u_xlat10_2.xyz = texture2D(_CameraNearFogMap, u_xlat8.xy).xyz;
    u_xlat16_1.xyz = u_xlat16_3.xyz * u_xlat10_2.xyz + u_xlat16_1.xyz;
