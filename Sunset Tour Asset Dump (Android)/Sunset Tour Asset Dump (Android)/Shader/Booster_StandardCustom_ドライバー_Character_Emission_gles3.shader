...
void main()
{
    ...
    u_xlat16_3.xy = max(u_xlat16_2.xy, _MinMSA.xy);
    u_xlat16_25 = u_xlat16_2.z + -1.0;
    u_xlat16_25 = _Occlusion * u_xlat16_25 + 1.0;
    u_xlat16_25 = max(u_xlat16_25, _MinMSA.z);
    ...
    u_xlat16_4.xyz = u_xlat16_12.xyz * _SphereMapScale.xyz + u_xlat16_4.xyz;
    ...
    u_xlat33 = inversesqrt(u_xlat33);
    u_xlat0.xyz = vec3(u_xlat33) * u_xlat0.xyz;
    u_xlat16_0 = texture(unity_SpecCube0, u_xlat0.xyz, u_xlat16_14);
    ...
    u_xlat16_8.xyz = u_xlat16_0.xyz * vec3(u_xlat16_14);
...
void main()
{
    ...
    u_xlat16_15.xyz = texture(_BumpMap, vs_TEXCOORD0.zw).xyz;
...
void main()
{
    ...
    u_xlat16_3.xyw = (-u_xlat16_7.xyz) * u_xlat16_3.xxx + vec3(u_xlat16_15);
    u_xlat16_3.xyz = abs(vec3(u_xlat16_27)) * u_xlat16_3.xyw + u_xlat16_11.xyz;
    u_xlat16_3.xyz = u_xlat16_6.xyz * u_xlat16_3.xyz + u_xlat16_0.xyz;
    u_xlat16_0.xyz = u_xlat16_3.xyz + (-unity_FogColor.xyz);
...
void main()
{
    ...
    u_xlat16_1.xzw = (-u_xlat16_2.xyz) * vec3(u_xlat16_34) + u_xlat16_1.xxx;
    u_xlat16_1.xyz = abs(vec3(u_xlat16_11)) * u_xlat16_1.xzw + u_xlat16_8.xyz;
    u_xlat16_1.xyz = u_xlat0.xyz * u_xlat16_1.xyz + u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat16_11.xyz = _Color.xyz * u_xlat16_1.xyz + _AddColor.xyz;
