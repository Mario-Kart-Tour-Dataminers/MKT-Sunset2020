...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/透過/Fade_Msk_Emm" {
Properties {
...
void main()
{
    ...
    u_xlat10_0.xyz = texture2D(_EmissionMap, vs_TEXCOORD0.zw).xyz;
    SV_Target0.xyz = u_xlat16_5.xyz * u_xlat10_0.xyz + u_xlat16_4.xyz;
    u_xlat10_0.x = texture2D(_TransparencyLM, vs_TEXCOORD0.xy).x;
...
void main()
{
    ...
    u_xlat16_5.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat10_1.xyz = texture2D(_EmissionMap, vs_TEXCOORD0.zw).xyz;
    SV_Target0.xyz = u_xlat16_5.xyz * u_xlat10_1.xyz + u_xlat0.xyz;
...
void main()
{
    ...
    u_xlat10_3.xyz = texture2D(_EmissionMap, vs_TEXCOORD0.zw).xyz;
    SV_Target0.xyz = u_xlat16_2.xyz * u_xlat10_3.xyz + u_xlat16_0.xyz;
    u_xlat10_3.x = texture2D(_TransparencyLM, vs_TEXCOORD0.xy).x;
    u_xlat16_3.x = (-u_xlat10_3.x) + 1.0;
...
void main()
{
    ...
    u_xlat16_5.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat10_0.xyz = texture2D(_EmissionMap, vs_TEXCOORD0.zw).xyz;
    u_xlat16_4.xyz = u_xlat16_5.xyz * u_xlat10_0.xyz + u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat16_5.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat10_1.xyz = texture2D(_EmissionMap, vs_TEXCOORD0.zw).xyz;
    u_xlat16_5.xyz = u_xlat16_5.xyz * u_xlat10_1.xyz + u_xlat0.xyz;
    u_xlat16_0.xyz = u_xlat16_5.xyz + (-unity_FogColor.xyz);
    u_xlat24 = vs_TEXCOORD2.w;
    u_xlat24 = clamp(u_xlat24, 0.0, 1.0);
    u_xlat0.xyz = vec3(u_xlat24) * u_xlat16_0.xyz + unity_FogColor.xyz;
    u_xlat10_1.x = texture2D(_TransparencyLM, vs_TEXCOORD0.xy).x;
...
void main()
{
    ...
    u_xlat16_5.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat10_0.xyz = texture2D(_EmissionMap, vs_TEXCOORD0.zw).xyz;
    u_xlat16_1.xyz = u_xlat16_5.xyz * u_xlat10_0.xyz + u_xlat16_1.xyz;
...
void main()
{
    ...
    SV_Target0.xyz = u_xlat16_1.xyz * vec3(u_xlat16_10) + u_xlat16_0.xyz;
    u_xlat10_0.x = texture2D(_TransparencyLM, vs_TEXCOORD0.xy).x;
    u_xlat16_0.x = (-u_xlat10_0.x) + 1.0;
    SV_Target0.w = u_xlat16_0.x;
    return;
...
void main()
{
    ...
    u_xlat10_0.xyz = texture2D(_EmissionMap, vs_TEXCOORD0.zw).xyz;
    SV_Target0.xyz = u_xlat16_3.xyz * u_xlat10_0.xyz + u_xlat16_1.xyz;
    u_xlat10_0.x = texture2D(_TransparencyLM, vs_TEXCOORD0.xy).x;
    u_xlat16_0.x = (-u_xlat10_0.x) + 1.0;
    SV_Target0.w = u_xlat16_0.x;
    return;
...
void main()
{
    ...
    u_xlat16_2.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat10_0.xyz = texture2D(_EmissionMap, vs_TEXCOORD0.zw).xyz;
    SV_Target0.xyz = u_xlat16_2.xyz * u_xlat10_0.xyz + u_xlat16_1.xyz;
    u_xlat10_0.x = texture2D(_TransparencyLM, vs_TEXCOORD0.xy).x;
    u_xlat16_0.x = (-u_xlat10_0.x) + 1.0;
    SV_Target0.w = u_xlat16_0.x;
    return;
...
void main()
{
    ...
    u_xlat16_13 = dot(vs_TEXCOORD1.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat16_13 = max(u_xlat16_13, 0.0);
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(u_xlat16_13) + u_xlat16_0.xyz;
    u_xlat16_0.xyz = u_xlat16_1.xyz + (-unity_FogColor.xyz);
...
void main()
{
    ...
    u_xlat16_2.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat10_0.xyz = texture2D(_EmissionMap, vs_TEXCOORD0.zw).xyz;
    u_xlat16_1.xyz = u_xlat16_2.xyz * u_xlat10_0.xyz + u_xlat16_1.xyz;
    u_xlat16_0.xyz = u_xlat16_1.xyz + (-unity_FogColor.xyz);
    u_xlat12 = vs_TEXCOORD2.w;
    u_xlat12 = clamp(u_xlat12, 0.0, 1.0);
    u_xlat0.xyz = vec3(u_xlat12) * u_xlat16_0.xyz + unity_FogColor.xyz;
...
void main()
{
    ...
    u_xlat0.xyz = vec3(u_xlat18) * u_xlat16_3.xyz + unity_FogColor.xyz;
    u_xlat10_3.x = texture2D(_TransparencyLM, vs_TEXCOORD0.xy).x;
    u_xlat0.w = (-u_xlat10_3.x) + 1.0;
    SV_Target0 = u_xlat0;
    return;
...
void main()
{
    ...
    u_xlat0.xyz = vec3(u_xlat21) * u_xlat16_3.xyz + unity_FogColor.xyz;
    u_xlat10_3.x = texture2D(_TransparencyLM, vs_TEXCOORD0.xy).x;
    u_xlat0.w = (-u_xlat10_3.x) + 1.0;
    SV_Target0 = u_xlat0;
    return;
...
void main()
{
    ...
    u_xlat10_2.xyz = texture2D(_EmissionMap, vs_TEXCOORD0.zw).xyz;
...
void main()
{
    ...
    u_xlat12 = clamp(u_xlat12, 0.0, 1.0);
    u_xlat0.xyz = vec3(u_xlat12) * u_xlat16_0.xyz + unity_FogColor.xyz;
    u_xlat10_2.x = texture2D(_TransparencyLM, vs_TEXCOORD0.xy).x;
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat16_2.xyz * u_xlat10_4.xyz + u_xlat16_1.xyz;
    SV_Target3.xyz = exp2((-u_xlat16_1.xyz));
    SV_Target3.w = 1.0;
    return;
}
