...
void main()
{
    ...
    u_xlat10_1 = texture2D(_TransparencyLM, vs_TEXCOORD0.zw).x;
...
void main()
{
    ...
    u_xlat10_3 = texture2D(_TransparencyLM, vs_TEXCOORD0.zw).x;
...
void main()
{
    ...
    u_xlat10_2 = texture2D(_TransparencyLM, vs_TEXCOORD0.zw).x;
