...
void main()
{
    ...
    u_xlat30 = inversesqrt(u_xlat30);
    u_xlat2.xyz = vec3(u_xlat30) * u_xlat2.xyz;
    u_xlat10_3.xyz = texture2D(_MSA, vs_TEXCOORD0.xy).xyz;
    ...
    SV_Target0.xyz = u_xlat16_6.xyz * u_xlat10_0.xyz + u_xlat16_5.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat10_4.xyz = texture2D(_MSA, vs_TEXCOORD0.xy).xyz;
...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat16_0.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
    u_xlat16_0.xyz = max(u_xlat16_0.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat10_2.xyz = texture2D(_MSA, vs_TEXCOORD0.xy).xyz;
    ...
    u_xlat16_3.x = u_xlat10_2.y + u_xlat16_3.x;
    ...
    u_xlat16_11.x = dot(u_xlat10_4, unity_OcclusionMaskSelector);
...
void main()
{
    ...
    u_xlat16_6.xyz = vs_COLOR0.xyz * vec3(vec3(_EmissionIntensity, _EmissionIntensity, _EmissionIntensity));
    u_xlat10_2.xyz = texture2D(_EmissionMap, vs_TEXCOORD0.zw).xyz;
    SV_Target0.xyz = u_xlat16_6.xyz * u_xlat10_2.xyz + u_xlat16_5.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_2.x = (-u_xlat10_3.x) * 0.779083729 + 0.779083729;
    ...
    u_xlat10_4.xyz = texture2D(_EmissionMap, vs_TEXCOORD0.zw).xyz;
    SV_Target0.xyz = u_xlat16_0.xyz * u_xlat10_4.xyz + u_xlat3.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat3.xzw = vec3(u_xlat21) * u_xlat16_16.xyz + u_xlat16_11.xyz;
    u_xlat10_1 = texture2D(unity_ShadowMask, vs_TEXCOORD5.xy);
    u_xlat16_11.x = dot(u_xlat10_1, unity_OcclusionMaskSelector);
    u_xlat16_11.x = clamp(u_xlat16_11.x, 0.0, 1.0);
    u_xlat16_11.xyz = u_xlat16_11.xxx * _LightColor0.xyz;
...
void main()
{
    ...
    u_xlat16_6.xyz = vs_COLOR0.xyz * vec3(vec3(_EmissionIntensity, _EmissionIntensity, _EmissionIntensity));
    u_xlat10_0.xyz = texture2D(_EmissionMap, vs_TEXCOORD0.zw).xyz;
    u_xlat16_5.xyz = u_xlat16_6.xyz * u_xlat10_0.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = vs_COLOR0.xyz * vec3(vec3(_EmissionIntensity, _EmissionIntensity, _EmissionIntensity));
    u_xlat10_2.xyz = texture2D(_EmissionMap, vs_TEXCOORD0.zw).xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat10_2.xyz + u_xlat0.xyz;
...
void main()
{
    ...
    u_xlat16_6.xyz = vs_COLOR0.xyz * vec3(vec3(_EmissionIntensity, _EmissionIntensity, _EmissionIntensity));
    u_xlat10_2.xyz = texture2D(_EmissionMap, vs_TEXCOORD0.zw).xyz;
    u_xlat16_5.xyz = u_xlat16_6.xyz * u_xlat10_2.xyz + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat16_0.xyz = vs_COLOR0.xyz * vec3(vec3(_EmissionIntensity, _EmissionIntensity, _EmissionIntensity));
    u_xlat10_4.xyz = texture2D(_EmissionMap, vs_TEXCOORD0.zw).xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat10_4.xyz + u_xlat3.xyz;
...
void main()
{
    ...
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat10_8.xy = texture2D(_MSA, vs_TEXCOORD0.xy).xy;
    ...
    u_xlat16_14 = (-u_xlat10_8.x) * 0.779083729 + 0.779083729;
...
void main()
{
    ...
    u_xlat16_2.xyz = vs_COLOR0.xyz * vec3(vec3(_EmissionIntensity, _EmissionIntensity, _EmissionIntensity));
    u_xlat10_1.xyz = texture2D(_EmissionMap, vs_TEXCOORD0.xy).xyz;
    SV_Target0.xyz = u_xlat16_2.xyz * u_xlat10_1.xyz + u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_2.xyz = vs_COLOR0.xyz * vec3(vec3(_EmissionIntensity, _EmissionIntensity, _EmissionIntensity));
    u_xlat10_1.xyz = texture2D(_EmissionMap, vs_TEXCOORD0.xy).xyz;
    u_xlat16_0.xyz = u_xlat16_2.xyz * u_xlat10_1.xyz + u_xlat16_0.xyz;
    u_xlat16_1.xyz = u_xlat16_0.xyz + (-unity_FogColor.xyz);
...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat16_2.xyz * u_xlat10_4.xyz + u_xlat16_0.xyz;
    SV_Target3.xyz = exp2((-u_xlat16_0.xyz));
    SV_Target3.w = 1.0;
    return;
}
