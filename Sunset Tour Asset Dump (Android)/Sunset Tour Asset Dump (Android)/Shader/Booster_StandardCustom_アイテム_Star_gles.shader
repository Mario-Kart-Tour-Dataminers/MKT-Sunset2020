...
void main()
{
    ...
    u_xlat10_0.xyz = texture2D(_EmissionMap, vs_TEXCOORD1.xy).xyz;
    SV_Target0.xyz = u_xlat16_7.xyz * u_xlat10_0.xyz + u_xlat16_6.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat10_1.xyz = texture2D(_EmissionMap, vs_TEXCOORD1.xy).xyz;
    SV_Target0.xyz = u_xlat16_2.xyz * u_xlat10_1.xyz + u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat10_2.xyz = texture2D(_EmissionMap, vs_TEXCOORD1.xy).xyz;
...
void main()
{
    ...
    u_xlat16_7.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat10_1.xyz = texture2D(_EmissionMap, vs_TEXCOORD1.xy).xyz;
    SV_Target0.xyz = u_xlat16_7.xyz * u_xlat10_1.xyz + u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat10_2.xyz = texture2D(_EmissionMap, vs_TEXCOORD1.xy).xyz;
    SV_Target0.xyz = u_xlat16_0.xyz * u_xlat10_2.xyz + u_xlat1.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_0.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat10_2.xyz = texture2D(_EmissionMap, vs_TEXCOORD1.xy).xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat10_2.xyz + u_xlat1.xyz;
    u_xlat16_1.xyz = u_xlat16_0.xyz + (-unity_FogColor.xyz);
    u_xlat25 = vs_TEXCOORD4.y;
    u_xlat25 = clamp(u_xlat25, 0.0, 1.0);
