...
uniform mediump sampler2D _NumberTex;
...
void main()
{
    ...
    u_xlat16_2.xyz = texture(_NumberTex, u_xlat1.zw).xyz;
#ifdef UNITY_ADRENO_ES3
    ...
    for(int u_xlati_loop_1 = 1 ; u_xlati_loop_1<u_xlati21 ; u_xlati_loop_1++)
    {
        ...
        u_xlat16_4.xyz = texture(_NumberTex, u_xlat4.xy).xyz;
    ...
    u_xlat16_2 = texture(_Decal, vs_TEXCOORD0.zw);
