...
void main()
{
    ...
    u_xlat16_1.xyz = texture(_SphereMap, u_xlat16_26.xy).xyz;
    u_xlat16_4 = texture(_Decal, vs_TEXCOORD1.zw);
    u_xlat16_4 = u_xlat16_4 * _Color + _AddColor;
    u_xlat16_7 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_7 = _Color * u_xlat16_7 + _AddColor;
    ...
    u_xlat16_8.xyz = u_xlat16_1.xyz * _SphereMapScale.xyz + u_xlat16_8.xyz;
...
void main()
{
    ...
    u_xlat16_6.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat16_0.xyz = texture(_EmissionMap, vs_TEXCOORD2.xy).xyz;
    SV_Target0.xyz = u_xlat16_6.xyz * u_xlat16_0.xyz + u_xlat16_3.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat16_1 = _Color * u_xlat16_1 + _AddColor;
    ...
    u_xlat16_2.xyz = u_xlat16_3.xyz * _SphereMapScale.xyz + u_xlat16_2.xyz;
    ...
    u_xlat16_0 = texture(unity_SpecCube0, u_xlat3.xyz, u_xlat16_5.x);
    u_xlat16_5.x = u_xlat16_0.w + -1.0;
    u_xlat16_5.x = unity_SpecCube0_HDR.w * u_xlat16_5.x + 1.0;
    u_xlat16_5.x = u_xlat16_5.x * unity_SpecCube0_HDR.x;
    u_xlat16_5.xyw = u_xlat16_0.xyz * u_xlat16_5.xxx;
    ...
    SV_Target0.xyz = u_xlat16_2.xyz * u_xlat16_4.xyz + u_xlat3.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat16_3.xyz = texture(_MSA, vs_TEXCOORD1.xy).xyz;
    u_xlat16_6.xyz = max(u_xlat16_3.xyz, _MinMSA.xyz);
...
void main()
{
    ...
    SV_Target0.w = u_xlat16_5.w * _AlphaFactor;
    u_xlat16_7.xyz = u_xlat16_0.xyz * _SphereMapScale.xyz + u_xlat16_7.xyz;
    ...
    SV_Target0.xyz = u_xlat16_2.xyz * u_xlat16_6.xyz + u_xlat0.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat16_7.xyz = max(u_xlat16_4.xyz, _MinMSA.xyz);
    ...
    u_xlat16_10.xyz = texture(unity_Lightmap, vs_TEXCOORD6.xy).xyz;
    ...
    SV_Target0.xyz = u_xlat16_1.xyz * u_xlat16_5.xyz + u_xlat4.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat16_2.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat16_4.xyz = texture(_EmissionMap, vs_TEXCOORD2.xy).xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_4.xyz + u_xlat3.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat16_6.xyz = texture(_EmissionMap, vs_TEXCOORD2.xy).xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_6.xyz + u_xlat0.xyz;
    u_xlat16_0.xyz = u_xlat16_2.xyz + (-unity_FogColor.xyz);
    u_xlat36 = vs_TEXCOORD7;
#ifdef UNITY_ADRENO_ES3
    u_xlat36 = min(max(u_xlat36, 0.0), 1.0);
...
void main()
{
    ...
    u_xlat16_1.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat16_5.xyz = texture(_EmissionMap, vs_TEXCOORD2.xy).xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_5.xyz + u_xlat4.xyz;
