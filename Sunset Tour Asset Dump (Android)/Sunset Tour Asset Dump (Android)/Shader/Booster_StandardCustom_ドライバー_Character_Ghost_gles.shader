...
void main()
{
    ...
    u_xlat16_1 = _Color * vs_COLOR0 + _AddColor;
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat10_2.xyz * _SphereMapScale.xyz + u_xlat16_1.xyz;
    SV_Target0.w = u_xlat16_1.w * _AlphaFactor;
...
void main()
{
    ...
    u_xlat10_2 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_1 = u_xlat16_1 * u_xlat10_2;
    u_xlat16_5.xyz = u_xlat10_3.xyz * _SphereMapScale.xyz + u_xlat16_1.xyz;
    SV_Target0.w = u_xlat16_1.w * _AlphaFactor;
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat16_4.xyz;
    u_xlat10_0 = texture2D(unity_ShadowMask, vs_TEXCOORD5.xy);
    u_xlat16_21 = dot(u_xlat10_0, unity_OcclusionMaskSelector);
    ...
    u_xlat16_21 = dot(vs_TEXCOORD1.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat16_21 = max(u_xlat16_21, 0.0);
    SV_Target0.xyz = u_xlat16_4.xyz * vec3(u_xlat16_21) + u_xlat16_3.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat16_18 = dot(vs_TEXCOORD1.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat16_18 = max(u_xlat16_18, 0.0);
    u_xlat16_0.xyz = u_xlat16_3.xyz * vec3(u_xlat16_18) + (-unity_FogColor.xyz);
...
void main()
{
    ...
    u_xlat16_2.xyz = _Color.xyz * vs_COLOR0.xyz + _AddColor.xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat10_2.xyz * _SphereMapScale.xyz + u_xlat16_1.xyz;
    SV_Target0.w = u_xlat16_1.w * _AlphaFactor;
    u_xlat16_4.xyz = (-booster_PowerSavingAdjustColor.xyz) + vec3(1.0, 1.0, 1.0);
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat16_0 = _Color * vs_COLOR0 + _AddColor;
    u_xlat10_2 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_0 = u_xlat16_0 * u_xlat10_2;
    u_xlat10_2.xyz = texture2D(_SphereMap, vec2(0.5, 0.5)).xyz;
    u_xlat16_3.xyz = u_xlat10_2.xyz * _SphereMapScale.xyz + u_xlat16_0.xyz;
