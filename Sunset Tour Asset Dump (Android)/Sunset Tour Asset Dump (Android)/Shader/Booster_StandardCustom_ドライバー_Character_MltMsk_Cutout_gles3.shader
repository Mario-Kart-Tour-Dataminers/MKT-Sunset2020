...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat16_2.xyz * _SphereMapScale.xyz;
    u_xlat16_2.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat16_4.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_8.xyz = u_xlat16_2.xyz * u_xlat16_4.xyz + _AddColor.xyz;
    u_xlat16_2.xyz = texture(_SphereMapMask, vs_TEXCOORD2.xy).xyz;
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat16_12.xyz * _SphereMapScale.xyz;
    u_xlat16_12.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat16_3.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_8.xyz = u_xlat16_12.xyz * u_xlat16_3.xyz + _AddColor.xyz;
    u_xlat16_12.xyz = texture(_SphereMapMask, vs_TEXCOORD2.xy).xyz;
    u_xlat16_7.xyz = u_xlat16_7.xyz * u_xlat16_12.xyz + u_xlat16_8.xyz;
    u_xlat16_8.xyz = u_xlat16_7.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_8.xyz = u_xlat16_1.xxx * u_xlat16_8.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_1.x = (-u_xlat16_1.x) * 0.779083729 + 0.779083729;
...
void main()
{
    ...
    u_xlat16_0.xyz = texture(_SphereMapMask, vs_TEXCOORD2.xy).xyz;
...
void main()
{
    ...
    u_xlat16_0.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat16_2.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_1.xyz = u_xlat16_0.xyz * u_xlat16_2.xyz + _AddColor.xyz;
    u_xlat0.x = hlslcc_mtx4x4unity_MatrixV[0].x;
    u_xlat0.y = hlslcc_mtx4x4unity_MatrixV[1].x;
    u_xlat0.z = hlslcc_mtx4x4unity_MatrixV[2].x;
    u_xlat16_2.xyz = texture(_BumpMap, vs_TEXCOORD1.xy).xyz;
    ...
    u_xlat16_7.xyz = texture(unity_Lightmap, vs_TEXCOORD6.xy).xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_5.xyz = u_xlat16_7.xyz * u_xlat16_2.xyz + _AddColor.xyz;
    u_xlat16_7.xyz = texture(_SphereMapMask, vs_TEXCOORD2.xy).xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat16_2.xyz * _SphereMapScale.xyz;
    u_xlat16_2.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat16_4.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_5.xyz = u_xlat16_2.xyz * u_xlat16_4.xyz + _AddColor.xyz;
    u_xlat16_2.xyz = texture(_SphereMapMask, vs_TEXCOORD2.xy).xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat16_2.xyz + u_xlat16_5.xyz;
