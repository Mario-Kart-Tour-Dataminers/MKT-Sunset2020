...
void main()
{
    ...
    u_xlat16_18.xyz = u_xlat16_4.xxx * u_xlat16_18.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
...
void main()
{
    ...
    u_xlat16_39 = _Occlusion * u_xlat16_39 + 1.0;
    u_xlat16_6.xyz = vec3(u_xlat16_39) * u_xlat16_6.xyz;
    u_xlat16_7 = (-u_xlat16_4.x) * 0.779083729 + 0.779083729;
    u_xlat16_18.x = (-u_xlat16_7) + 1.0;
    u_xlat16_18.x = u_xlat16_4.y + u_xlat16_18.x;
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    u_xlat16_14 = (-u_xlat16_4.x) * 0.779083729 + 0.779083729;
    u_xlat16_6.xyz = u_xlat16_11.xyz * vec3(u_xlat16_14);
    u_xlat16_14 = (-u_xlat16_14) + 1.0;
    u_xlat16_14 = u_xlat16_4.y + u_xlat16_14;
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    u_xlat16_17.x = u_xlat16_4.y + u_xlat16_17.x;
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    u_xlat16_10.xyz = u_xlat16_4.xxx * u_xlat16_10.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
...
void main()
{
    ...
    u_xlat10 = texture(unity_NHxRoughness, u_xlat5.xz).x;
...
void main()
{
    ...
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat16_8.xy = texture(_MSA, vs_TEXCOORD0.zw).xy;
    ...
    u_xlat16_13 = (-u_xlat16_8.x) * 0.779083729 + 0.779083729;
...
void main()
{
    ...
    u_xlat16_2.xy = texture(_MSA, vs_TEXCOORD0.zw).xy;
    u_xlat16_9 = (-u_xlat16_2.y) + 1.0;
    ...
    u_xlat16_10 = (-u_xlat16_2.x) * 0.779083729 + 0.779083729;
