...
void main()
{
    ...
    vs_TEXCOORD1.xy = in_TEXCOORD0.xy * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat16_1.xyz * u_xlat16_4.xyz + u_xlat16_7.xyz;
    ...
    u_xlat16_0.xyz = texture(_EmissionMap, vs_TEXCOORD1.xy).xyz;
...
void main()
{
    ...
    u_xlat16_6.xyz = u_xlat16_10.xyz * u_xlat16_2.xyz + u_xlat16_6.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = texture(_EmissionMap, vs_TEXCOORD1.xy).xyz;
...
void main()
{
    ...
    u_xlat16_8.xyz = u_xlat16_2.xyz * u_xlat16_5.xyz + u_xlat16_8.xyz;
    ...
    u_xlat16_7.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat16_1.xyz = texture(_EmissionMap, vs_TEXCOORD1.xy).xyz;
    SV_Target0.xyz = u_xlat16_7.xyz * u_xlat16_1.xyz + u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_1.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat16_4.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_3.xyz = u_xlat16_1.xyz * u_xlat16_4.xyz + u_xlat16_3.xyz;
    u_xlat16_5.xyz = u_xlat16_3.xyz + vec3(-1.0, -1.0, -1.0);
    u_xlat16_3.xyz = u_xlat16_3.xyz + vec3(-1.22091627, -1.22091627, -1.22091627);
    u_xlat16_3.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_3.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    ...
    u_xlat16_0.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat16_2.xyz = texture(_EmissionMap, vs_TEXCOORD1.xy).xyz;
...
void main()
{
    ...
    u_xlat16_27 = dot(u_xlat16_5, unity_OcclusionMaskSelector);
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    u_xlat16_2.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat16_1.xyz = texture(_EmissionMap, vs_TEXCOORD1.xy).xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_1.xyz + u_xlat0.xyz;
...
void main()
{
    ...
    u_xlat16_7.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat16_1.xyz = texture(_EmissionMap, vs_TEXCOORD1.xy).xyz;
    u_xlat16_0.xyz = u_xlat16_7.xyz * u_xlat16_1.xyz + u_xlat16_0.xyz;
    u_xlat16_1.xyz = u_xlat16_0.xyz + (-unity_FogColor.xyz);
    u_xlat40 = vs_TEXCOORD6;
#ifdef UNITY_ADRENO_ES3
    u_xlat40 = min(max(u_xlat40, 0.0), 1.0);
#else
    u_xlat40 = clamp(u_xlat40, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat16_0.xyz = vec3(_Emission.x, _Emission.y, _Emission.z) * vec3(_EmissionIntensity);
    u_xlat16_2.xyz = texture(_EmissionMap, vs_TEXCOORD1.xy).xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat16_2.xyz + u_xlat1.xyz;
    u_xlat16_1.xyz = u_xlat16_0.xyz + (-unity_FogColor.xyz);
