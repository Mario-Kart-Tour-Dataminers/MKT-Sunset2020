...
void main()
{
    ...
    u_xlat16_30 = texture(_MSA, vs_TEXCOORD0.xy).z;
    u_xlat16_34 = u_xlat16_30 + -1.0;
...
void main()
{
    ...
    u_xlat16_1 = texture(_MSA, vs_TEXCOORD0.xy).z;
    u_xlat16_32 = u_xlat16_1 + -1.0;
...
void main()
{
    ...
    u_xlat16_33 = texture(_MSA, vs_TEXCOORD0.xy).z;
...
void main()
{
    ...
    u_xlat16_3.x = texture(_MSA, vs_TEXCOORD0.xy).z;
...
void main()
{
    ...
    u_xlat16_4.x = u_xlat16_4.x * unity_SpecCube0_HDR.x;
    u_xlat16_4.xyz = u_xlat16_1.xyz * u_xlat16_4.xxx;
    u_xlat16_27 = texture(_MSA, vs_TEXCOORD0.xy).z;
    u_xlat16_31 = u_xlat16_27 + -1.0;
...
void main()
{
    ...
    u_xlat16_1.xy = u_xlat16_1.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
    u_xlat16_2.xyz = texture(_SphereMap, u_xlat16_1.xy).xyz;
    u_xlat16_1.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = texture(_SphereMap, vec2(0.5, 0.5)).xyz;
    u_xlat16_1.xyz = _Color.xyz * vs_COLOR0.xyz + u_xlat16_2.xyz;
    u_xlat16_3.xyz = (-booster_PowerSavingAdjustColor.xyz) + vec3(1.0, 1.0, 1.0);
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat16_0.xyz = texture(_SphereMap, vec2(0.5, 0.5)).xyz;
