...
//
///////////////////////////////////////////
Shader "Booster/StandardCustom/ドライバー/Character_Emission_Cutout" {
Properties {
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat10_2.xyz * _SphereMapScale.xyz + u_xlat16_7.xyz;
    ...
    SV_Target0.xyz = u_xlat16_6.xyz * u_xlat16_1.xyz + u_xlat16_8.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat10_12.xyz * _SphereMapScale.xyz + u_xlat16_7.xyz;
    u_xlat16_8.xyz = u_xlat16_7.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat16_8.xyz = u_xlat16_1.xxx * u_xlat16_8.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_1.x = (-u_xlat16_1.x) * 0.779083729 + 0.779083729;
    ...
    u_xlat16_6.xyz = u_xlat16_2.xyz * vec3(_EmissionIntensity);
    ...
    SV_Target0.xyz = u_xlat0.xyz * u_xlat16_1.xyz + u_xlat16_6.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat35 = dot(_WorldSpaceLightPos0.xyz, u_xlat2.xyz);
    u_xlat35 = clamp(u_xlat35, 0.0, 1.0);
    u_xlat35 = max(u_xlat35, 0.319999993);
    u_xlat10_3.xyz = texture2D(_MSA, vs_TEXCOORD1.zw).xyz;
    u_xlat16_1.xy = max(u_xlat10_3.xy, _MinMSA.xy);
    u_xlat16_23 = u_xlat10_3.z + -1.0;
    u_xlat16_23 = _Occlusion * u_xlat16_23 + 1.0;
    u_xlat16_23 = max(u_xlat16_23, _MinMSA.z);
    u_xlat3.x = (-u_xlat16_1.y) + 1.0;
    u_xlat14.x = u_xlat3.x * u_xlat3.x + 1.5;
    u_xlat35 = u_xlat35 * u_xlat14.x;
    u_xlat10_14.xyz = texture2D(_BumpMap, vs_TEXCOORD1.xy).xyz;
    u_xlat16_4.xyz = u_xlat10_14.xyz * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    u_xlat5.x = dot(vs_TEXCOORD3.xyz, u_xlat16_4.xyz);
    u_xlat5.y = dot(vs_TEXCOORD4.xyz, u_xlat16_4.xyz);
    u_xlat5.z = dot(vs_TEXCOORD5.xyz, u_xlat16_4.xyz);
    ...
    u_xlat16_34 = u_xlat3.x * u_xlat13;
    ...
    u_xlat16_4.xy = u_xlat16_4.xy * vec2(0.5, 0.5) + vec2(0.5, 0.5);
    u_xlat10_13.xyz = texture2D(_SphereMap, u_xlat16_4.xy).xyz;
    u_xlat10_5.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_4.xyz = _Color.xyz * u_xlat10_5.xyz + _AddColor.xyz;
    u_xlat16_4.xyz = u_xlat10_13.xyz * _SphereMapScale.xyz + u_xlat16_4.xyz;
    ...
    u_xlat16_12 = u_xlat16_12 + 1.0;
    u_xlat16_12 = clamp(u_xlat16_12, 0.0, 1.0);
    u_xlat16_8.xyz = (-u_xlat16_7.xyz) + vec3(u_xlat16_12);
    u_xlat16_9.xyz = u_xlat16_1.xxx * u_xlat16_4.xyz;
    u_xlat2.xyz = u_xlat2.xxx * u_xlat16_7.xyz + u_xlat16_9.xyz;
    ...
    u_xlat35 = dot(u_xlat14.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat35 = clamp(u_xlat35, 0.0, 1.0);
    u_xlat2.xyz = u_xlat2.xyz * vec3(u_xlat35) + u_xlat16_10.xyz;
    u_xlatb35 = u_xlat3.x<0.00499999989;
    u_xlat3.x = u_xlat3.x * 8.29800034;
    u_xlat16_12 = (u_xlatb35) ? 0.0 : u_xlat3.x;
    u_xlat16_37 = dot((-u_xlat11.xyz), u_xlat14.xyz);
    u_xlat16_37 = u_xlat16_37 + u_xlat16_37;
    u_xlat16_10.xyz = u_xlat14.xyz * (-vec3(u_xlat16_37)) + (-u_xlat11.xyz);
    ...
    u_xlat33 = inversesqrt(u_xlat33);
    u_xlat0.xyz = vec3(u_xlat33) * u_xlat0.xyz;
    u_xlat10_0 = textureCube(unity_SpecCube0, u_xlat0.xyz, u_xlat16_12);
    ...
    u_xlat16_8.xyz = u_xlat10_0.xyz * vec3(u_xlat16_12);
    u_xlat16_8.xyz = vec3(u_xlat16_23) * u_xlat16_8.xyz;
    u_xlat16_8.xyz = vec3(u_xlat16_34) * u_xlat16_8.xyz;
    u_xlat0.xyz = u_xlat16_8.xyz * u_xlat16_7.xyz + u_xlat2.xyz;
    u_xlat10_2.xyz = texture2D(_EmissionMap, vs_TEXCOORD2.xy).xyz;
    u_xlat16_2.xyz = u_xlat10_2.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_7.xyz = u_xlat16_2.xyz * vec3(_EmissionIntensity);
    u_xlat16_12 = roundEven(u_xlat16_23);
    u_xlat16_23 = u_xlat16_23 * 2.0 + -1.0;
    u_xlat16_1.xyw = (-u_xlat16_4.xyz) * u_xlat16_1.xxx + vec3(u_xlat16_12);
    u_xlat16_1.xyz = abs(vec3(u_xlat16_23)) * u_xlat16_1.xyw + u_xlat16_9.xyz;
    SV_Target0.xyz = u_xlat0.xyz * u_xlat16_1.xyz + u_xlat16_7.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat10_15.xyz = texture2D(_BumpMap, vs_TEXCOORD1.xy).xyz;
    u_xlat16_5.xyz = u_xlat10_15.xyz * vec3(2.0, 2.0, 2.0) + vec3(-1.0, -1.0, -1.0);
    u_xlat6.x = dot(vs_TEXCOORD3.xyz, u_xlat16_5.xyz);
    u_xlat6.y = dot(vs_TEXCOORD4.xyz, u_xlat16_5.xyz);
    u_xlat6.z = dot(vs_TEXCOORD5.xyz, u_xlat16_5.xyz);
...
void main()
{
    ...
    u_xlat16_1.xyw = (-u_xlat16_7.xyz) * u_xlat16_1.xxx + vec3(u_xlat16_12);
    u_xlat16_1.xyz = abs(vec3(u_xlat16_23)) * u_xlat16_1.xyw + u_xlat16_9.xyz;
    u_xlat16_1.xyz = u_xlat16_6.xyz * u_xlat16_1.xyz + u_xlat16_8.xyz;
...
void main()
{
    ...
    u_xlat10_2.xyz = texture2D(_EmissionMap, vs_TEXCOORD2.xy).xyz;
    u_xlat16_2.xyz = u_xlat10_2.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_5.xyz = u_xlat16_2.xyz * vec3(_EmissionIntensity);
...
void main()
{
    ...
    u_xlat16_1.xyz = _Color.xyz * u_xlat10_2.xyz + _AddColor.xyz;
    ...
    u_xlat16_1.xyz = (-u_xlat16_1.xyz) * vec3(u_xlat16_32) + vec3(u_xlat16_15);
...
void main()
{
    ...
    u_xlat10_5.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_7.xyz = _Color.xyz * u_xlat10_5.xyz + _AddColor.xyz;
    u_xlat16_7.xyz = u_xlat10_2.xyz * _SphereMapScale.xyz + u_xlat16_7.xyz;
    ...
    u_xlat16_2.xyz = u_xlat10_2.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_1.xyz = u_xlat16_2.xyz * vec3(_EmissionIntensity);
    u_xlat16_4.x = roundEven(u_xlat16_34);
    u_xlat16_34 = u_xlat16_34 * 2.0 + -1.0;
    u_xlat16_4.xyz = (-u_xlat16_7.xyz) * u_xlat16_26.xxx + u_xlat16_4.xxx;
    u_xlat16_4.xyz = abs(vec3(u_xlat16_34)) * u_xlat16_4.xyz + u_xlat16_8.xyz;
...
void main()
{
    ...
    u_xlat10_0.xyz = texture2D(_SphereMap, u_xlat16_4.xy).xyz;
    u_xlat10_2.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_4.xyz = _Color.xyz * u_xlat10_2.xyz + _AddColor.xyz;
    u_xlat16_4.xyz = u_xlat10_0.xyz * _SphereMapScale.xyz + u_xlat16_4.xyz;
    ...
    u_xlat16_2.xyz = u_xlat10_2.xyz * vec3(_Emission.x, _Emission.y, _Emission.z);
    u_xlat16_1.xyz = u_xlat16_2.xyz * vec3(_EmissionIntensity);
    u_xlat16_6.x = roundEven(u_xlat16_31);
    u_xlat16_31 = u_xlat16_31 * 2.0 + -1.0;
    u_xlat16_4.xyz = (-u_xlat16_4.xyz) * vec3(u_xlat16_34) + u_xlat16_6.xxx;
    u_xlat16_4.xyz = abs(vec3(u_xlat16_31)) * u_xlat16_4.xyz + u_xlat16_7.xzw;
    u_xlat16_1.xyz = u_xlat0.xyz * u_xlat16_4.xyz + u_xlat16_1.xyz;
    u_xlat16_0.xyz = u_xlat16_1.xyz + (-unity_FogColor.xyz);
    u_xlat30 = vs_TEXCOORD5.y;
    u_xlat30 = clamp(u_xlat30, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat10_2.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_11.xyz = _Color.xyz * u_xlat10_2.xyz + _AddColor.xyz;
...
void main()
{
    ...
    u_xlat16_9 = u_xlat16_2 * u_xlat16_2 + 1.5;
    ...
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat16_14 = u_xlat16_2 * u_xlat16_2 + -1.0;
